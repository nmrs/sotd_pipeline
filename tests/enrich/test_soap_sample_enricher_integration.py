...
class TestSoapSampleEnricherIntegration:
    ...
    def test_enricher_registered(self):
        ...
        assert "SoapSampleEnricher" in soap_enricher_names, (
    ...
    def test_enricher_applies_to_soap_records(self):
        ...
        assert soap_sample_enricher.applies_to(record_with_soap), (
        ...
        assert not soap_sample_enricher.applies_to(record_without_soap), (
    ...
    def test_enricher_enriches_soap_data(self):
        ...
        assert enriched_data["extraction_remainder"] == "(sample)", (
