    ...
    def test_a77_format_blades_validation(self, tmp_path):
        ...
        catalog_data = {
            "A77": {
                "Cloud": {
                    "A77": {
                        "patterns": ["cloud.*a77.*blade", "cloud.*a77"],
                        "format": "A77"
                    }
                },
                "RhinoceRos": {
    ...
    def test_mixed_format_blades_validation(self, tmp_path):
        ...
        correct_matches_data = {
            "blade": {
                "A77": {
                    "Cloud": {
                        "A77": ["cloud a77 full blade"]
                    }
                },
                "AC": {
                    "Feather": {
                        "Pro": ["feather artist club", "feather pro"]
                    }
                },
                "DE": {
                    "Astra": {
                ...
                "GEM": {
                    "Personna": {
                        "GEM PTFE": ["gem ptfe", "personna gem ptfe"]
                    }
                }
            }
        }
        ...
        catalog_data = {
            ...
            "AC": {
                "Feather": {
                    "Pro": {
                        "patterns": ["feather.*artist.*club", "feather.*pro"],
                        "format": "AC"
                    }
                }
            },
            ...
            "GEM": {
                "Personna": {
                    "GEM PTFE": {
                        "patterns": ["gem.*ptfe", "personna.*gem.*ptfe"],
                        "format": "GEM"
                    }
                }
            }
    ...
    def test_format_mismatch_detection(self, tmp_path):
        ...
        catalog_data = {
            "DE": {
                "Cloud": {
                    "Super Stainless": {
                        "patterns": ["cloud.*super.*stainless"],
                        "format": "DE"
                    }
                }
            }
    ...
    def test_edge_case_formats(self, tmp_path):
        ...
        correct_matches_data = {
            "blade": {
                "Half DE": {
                    "Leaf": {
                        "SE": ["leaf super platinum"]
                    }
                },
                "Hair Shaper": {
                    "Personna": {
                        "Hair Shaper": ["personna hair shaper"]
                    }
                },
                "Injector": {
                    "Schick": {
                        "Injector": ["schick injector"]
                    }
                }
            }
        }
