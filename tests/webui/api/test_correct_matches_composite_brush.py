...
class TestCorrectMatchesCompositeBrush:
    ...
    def test_get_correct_matches_brush_combines_all_sections(
        ...
        mock_yaml_data = {
            "brush": {
                "AP Shave Co": {
                    "G5C": ["ap shave co g5c 24mm"]
                }
            },
            "handle": {
                "AP Shave Co": {
                    "Unspecified": ["ap shave co. - lemon drop 26mm tgn boar"]
                }
            },
            "knot": {
                "The Golden Nib": {
                    "Boar": ["ap shave co. - lemon drop 26mm tgn boar"]
                }
            }
        }
    ...
    @patch('builtins.open')
    @patch('yaml.safe_load')
    def test_get_correct_matches_brush_preserves_existing_brush_logic(self, mock_yaml_load, mock_open, mock_project_root):
        ...
        mock_yaml_data = {
            "brush": {
                "AP Shave Co": {
                    "G5C": ["ap shave co g5c 24mm", "ap shave co g5c 26mm"]
                }
            }
        }
    ...
    @patch('builtins.open')
    @patch('yaml.safe_load')
    def test_get_correct_matches_brush_handles_empty_sections(self, mock_yaml_load, mock_open, mock_project_root):
    ...
    @patch('builtins.open')
    @patch('yaml.safe_load')
    def test_get_correct_matches_brush_handles_missing_sections(self, mock_yaml_load, mock_open, mock_project_root):
    ...
    @patch('builtins.open')
    @patch('yaml.safe_load')
    def test_get_correct_matches_non_brush_fields_unaffected(self, mock_yaml_load, mock_open, mock_project_root):
    ...
    @patch('builtins.open')
    @patch('yaml.safe_load')
    def test_get_correct_matches_brush_composite_brush_confirmation_logic(self, mock_yaml_load, mock_open, mock_project_root):
