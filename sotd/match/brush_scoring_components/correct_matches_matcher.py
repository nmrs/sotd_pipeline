...
class CorrectMatchesMatcher:
                    ...
                    for pattern in patterns:
                        if isinstance(pattern, str) and pattern.lower() == normalized_value:
                            ...
                            if pattern_text.lower() == normalized_value:
                                return self._create_match_result(value, brand, model, "exact", pattern_text)
    ...
    def _create_match_result(self, original: str, brand: str, model: str, match_type: str, pattern: str) -> MatchResult:
        """
