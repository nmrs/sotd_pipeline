...
_ConvertibleToBool: TypeAlias = (
    bool | str | int | None
)  # True | False | "true" | "t" | "false" | "f" | 1 | 0 | None
...
class Typed(Descriptor[_T], Generic[_T, _N]):
    ...
    @overload
    def __get__(
        self: Typed[_T, Literal[True]], instance: Serialisable | Strict, cls: type | None = None
    ) -> _T | None: ...
    @overload
    def __get__(
        self: Typed[_T, Literal[False]], instance: Serialisable | Strict, cls: type | None = None
    ) -> _T: ...
    @overload
    def __set__(
        self: Typed[_T, Literal[True]], instance: Serialisable | Strict, value: _T | None
    ) -> None: ...
    @overload
    def __set__(
        self: Typed[_T, Literal[False]], instance: Serialisable | Strict, value: _T
    ) -> None: ...
...
class Convertible(Typed[_T, _N]):
    ...
    @overload
    def __set__(
        self: Convertible[MultiCellRange, Literal[False]],
        instance: Serialisable | Strict,
        value: _ConvertibleToMultiCellRange,
    ) -> None: ...
    # str | Blip
    @overload
    def __set__(
    ...
    @overload
    def __set__(
        self: Convertible[bool, _N], instance: Serialisable | Strict, value: _ConvertibleToBool
    ) -> None: ...
    # int
    @overload
    def __set__(
        self: Convertible[int, Literal[True]],
        instance: Serialisable | Strict,
        value: ConvertibleToInt | None,
    ) -> None: ...
    @overload
    def __set__(
        self: Convertible[int, Literal[False]],
        instance: Serialisable | Strict,
    ...
    @overload
    def __set__(
        self: Convertible[float, Literal[True]],
        instance: Serialisable | Strict,
        value: ConvertibleToFloat | None,
    ) -> None: ...
    @overload
    def __set__(
        self: Convertible[float, Literal[False]],
        instance: Serialisable | Strict,
...
class Max(Convertible[_M, _N]):
    ...
    @overload
    def __set__(
        self: Max[int, Literal[False]], instance: Serialisable | Strict, value: ConvertibleToInt
    ) -> None: ...
    @overload
    def __set__(
        self: Max[float, Literal[True]],
    ...
    @overload
    def __set__(
        self: Max[float, Literal[False]], instance: Serialisable | Strict, value: ConvertibleToFloat
    ) -> None: ...
...
class Min(Convertible[_M, _N]):
    ...
    @overload
    def __set__(
        self: Min[int, Literal[False]], instance: Serialisable | Strict, value: ConvertibleToInt
    ) -> None: ...
    @overload
    def __set__(
        self: Min[float, Literal[True]],
    ...
    @overload
    def __set__(
        self: Min[float, Literal[False]], instance: Serialisable | Strict, value: ConvertibleToFloat
    ) -> None: ...
...
class NoneSet(Set[_T | None]):
    ...
    def __set__(
        self, instance: Serialisable | Strict, value: _T | Literal["none"] | None
    ) -> None: ...
...
class Integer(Convertible[int, _N]):
    ...
    @overload
    def __init__(
        self: Integer[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: Integer[Literal[False]],
        name: str | None = None,
        *,
        allow_none: Literal[False] = False,
    ) -> None: ...
...
class Float(Convertible[float, _N]):
    ...
    @overload
    def __init__(
        self: Float[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: Float[Literal[False]], name: str | None = None, *, allow_none: Literal[False] = False
    ) -> None: ...
...
class Bool(Convertible[bool, _N]):
    ...
    @overload
    def __init__(
        self: Bool[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: Bool[Literal[False]], name: str | None = None, *, allow_none: Literal[False] = False
    ) -> None: ...
...
class String(Typed[str, _N]):
    ...
    @overload
    def __init__(
        self: String[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: String[Literal[False]], name: str | None = None, *, allow_none: Literal[False] = False
    ) -> None: ...
...
class MatchPattern(Descriptor[_P], Generic[_P, _N]):
    ...
    @overload  # str
    def __init__(
        self: MatchPattern[str, Literal[True]],
        name: str | None = None,
        *,
    ...
    @overload
    def __get__(
        self: MatchPattern[_P, Literal[True]],
        instance: Serialisable | Strict,
        cls: type | None = None,
    ) -> _P | None: ...
    @overload
    def __get__(
        self: MatchPattern[_P, Literal[False]],
        instance: Serialisable | Strict,
        cls: type | None = None,
    ) -> _P: ...
    @overload
    def __set__(
        self: MatchPattern[_P, Literal[True]], instance: Serialisable | Strict, value: _P | None
    ) -> None: ...
    @overload
    def __set__(
        self: MatchPattern[_P, Literal[False]], instance: Serialisable | Strict, value: _P
    ) -> None: ...
...
class DateTime(Typed[datetime, _N]):
    ...
    @overload
    def __init__(
        self: DateTime[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: DateTime[Literal[False]],
        name: str | None = None,
        *,
        allow_none: Literal[False] = False,
    ) -> None: ...
    @overload
    def __set__(
        self: DateTime[Literal[True]], instance: Serialisable | Strict, value: datetime | str | None
    ) -> None: ...
    @overload
    def __set__(
        self: DateTime[Literal[False]], instance: Serialisable | Strict, value: datetime | str
    ) -> None: ...
