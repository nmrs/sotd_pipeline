...
class RawField(rq.ValueField):
    ...
    def parse_binary_value(
        self, data: _T, display: Unused, length: Unused, format: Unused
    ) -> tuple[_T, Literal[""]]: ...  # type: ignore[override]  # See: https://github.com/python-xlib/python-xlib/pull/249
...
def unregister_clients(
    self: Display | resource.Resource, context: int, clients: Sequence[int]
) -> None: ...
