...
class croniter(Generic[_R_co]):
    ...
    def set_current(
        self, start_time: float | datetime.datetime | None, force: bool = True
    ) -> float: ...
    @staticmethod
    def datetime_to_timestamp(d: datetime.datetime) -> float: ...
    def timestamp_to_datetime(
        self, timestamp: float, tzinfo: datetime.tzinfo | None = ...
    ) -> datetime.datetime: ...
    @staticmethod
    def timedelta_to_seconds(td: datetime.timedelta) -> float: ...
    @overload
...
class HashExpander:
    ...
    def match(
        self, efl: Unused, idx: Unused, expr: str, hash_id: bytes | None = None, **kw: Unused
    ) -> Match[str] | None: ...
    def expand(
        self,
        efl: object,
