...
class RGB(Typed[str, _N]):
    ...
    @overload
    def __init__(
        self: RGB[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: RGB[Literal[False]], name: str | None = None, *, allow_none: Literal[False] = False
    ) -> None: ...
    @overload
    def __set__(
        self: RGB[Literal[True]], instance: Serialisable | Strict, value: str | None
    ) -> None: ...
    @overload
...
class ColorDescriptor(Typed[Color, _N]):
    ...
    @overload
    def __init__(
        self: ColorDescriptor[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: ColorDescriptor[Literal[False]],
        name: str | None = None,
        *,
    ...
    @overload
    def __set__(
        self: ColorDescriptor[Literal[True]], instance: Serialisable | Strict, value: Color | None
    ) -> None: ...
    @overload
    def __set__(
        self: ColorDescriptor[Literal[False]], instance: Serialisable | Strict, value: Color
    ) -> None: ...
...
class ColorList(Serialisable):
    ...
    def __init__(
        self,
        indexedColors: list[RgbColor] | tuple[RgbColor, ...] = (),
        mruColors: list[Color] | tuple[Color, ...] = (),
    ) -> None: ...
