...
class Transport(Thread, ClosingContextManager):
    ...
    def set_gss_host(
        self, gss_host: str | None, trust_dns: bool = True, gssapi_requested: bool = True
    ) -> None: ...
    def start_client(self, event: Event | None = None, timeout: float | None = None) -> None: ...
    def start_server(
        self, event: Event | None = None, server: ServerInterface | None = None
    ) -> None: ...
    ...
    def auth_password(
        self, username: str, password: str, event: Event | None = None, fallback: bool = True
    ) -> list[str]: ...
