...
class Branding:
    ...
    def update_template_universal_login(
        self, body: dict[str, Incomplete]
    ) -> dict[str, Incomplete]: ...
    async def update_template_universal_login_async(
        self, body: dict[str, Incomplete]
    ) -> dict[str, Incomplete]: ...
    ...
    def update_branding_theme(
        self, theme_id: str, body: dict[str, Incomplete]
    ) -> dict[str, Incomplete]: ...
    async def update_branding_theme_async(
        self, theme_id: str, body: dict[str, Incomplete]
    ) -> dict[str, Incomplete]: ...
    def create_branding_theme(self, body: dict[str, Incomplete]) -> dict[str, Incomplete]: ...
    async def create_branding_theme_async(
        self, body: dict[str, Incomplete]
    ) -> dict[str, Incomplete]: ...
