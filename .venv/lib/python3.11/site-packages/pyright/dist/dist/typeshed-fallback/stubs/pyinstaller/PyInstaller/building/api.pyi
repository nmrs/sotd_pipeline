...
_HideConsole: TypeAlias = (
    Literal["hide-early", "minimize-early", "hide-late", "minimize-late"] | None
)
...
class PYZ(Target):
    ...
    def __init__(
        self, *tocs: Iterable[_TOCTuple], name: str | None = None, cipher: _PyiBlockCipher = None
    ) -> None: ...
