...
class Blob(Object):
    ...
    size: int
    def diff(
        self, blob: Blob = ..., flag: int = ..., old_as_path: str = ..., new_as_path: str = ...
    ) -> Patch: ...
    def diff_to_buffer(
        self,
...
class Repository:
    ...
    def applies(
        self, diff: Diff, location: ApplyLocation = ..., raise_error: bool = False
    ) -> bool: ...
    ...
    def references_iterator_next(
        self, iter: Iterator[Reference], references_return_type: ReferenceFilter = ...
    ) -> Reference: ...
...
class Signature:
    ...
    time: int
    def __init__(
        self, name: str, email: str, time: int = -1, offset: int = 0, encoding: str | None = None
    ) -> None: ...
    def __eq__(self, other: object) -> bool: ...
    def __ge__(self, other: object) -> bool: ...
    def __gt__(self, other: object) -> bool: ...
...
class Tree(Object):
    ...
    def diff_to_workdir(
        self, flags: DiffOption = ..., context_lines: int = 3, interhunk_lines: int = 0
    ) -> Diff: ...
