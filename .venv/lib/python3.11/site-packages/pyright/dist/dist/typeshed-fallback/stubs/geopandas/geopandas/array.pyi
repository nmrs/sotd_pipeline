...
class GeometryArray(ExtensionArray):
    def __init__(
        self, data: GeometryArray | NDArray[np.object_], crs: _ConvertibleToCRS | None = None
    ) -> None: ...
    @property
    ...
    @overload
    def __getitem__(
        self, idx: int | np.integer[Any]
    ) -> BaseGeometry: ...  # Always 1-D, doesn't accept tuple
    @overload
    def __getitem__(
    ...
    def __setitem__(
        self,
        key,
        value: _ArrayOrGeom | pd.DataFrame | pd.Series[Any],  # Cannot use pd.Series[BaseGeometry]
    ) -> None: ...
    @property
    ...
    def set_precision(
        self,
        grid_size: float,
        mode: Literal["valid_output", "pointwise", "keep_collapsed", 0, 1, 2] = "valid_output",
    ) -> GeometryArray: ...
    ...
    def geom_equals_exact(
        self, other: _ArrayOrGeom, tolerance: float | ArrayLike
    ) -> _Array1D[np.bool_]: ...
    ...
    def buffer(
        self, distance: float | ArrayLike, resolution: int = 16, **kwargs
    ) -> GeometryArray: ...
    def interpolate(
        self, distance: float | ArrayLike, normalized: bool = False
    ) -> GeometryArray: ...
    def simplify(
    ...
    def to_crs(
        self, crs: _ConvertibleToCRS | None = None, epsg: int | None = None
    ) -> GeometryArray: ...
    ...
    def take(
        ...
        | NDArray[np.integer[Any]],  # np.integer[Any] because precision is not important
    ...
    @overload
    def astype(
        self, dtype: ExtensionDtype | Literal["string"], copy: bool = True
    ) -> ExtensionArray: ...  # type: ignore[overload-overlap]
    @overload
