...
def rbreak(
    regex: str, minsyms: bool = ..., throttle: int = ..., symtabs: Iterator[Symtab] = ...
) -> list[Breakpoint]: ...
...
def decode_line(
    expression: str = ..., /
) -> tuple[str | None, tuple[Symtab_and_line, ...] | None]: ...
...
class _FrameFilter(Protocol):
    ...
    def filter(
        self, iterator: Iterator[gdb.FrameDecorator.FrameDecorator]
    ) -> Iterator[gdb.FrameDecorator.FrameDecorator]: ...
...
class Inferior:
    ...
    def write_memory(
        self, address: _ValueOrInt, buffer: _BufferType, length: int = ...
    ) -> memoryview: ...
    def search_memory(
        self, address: _ValueOrInt, length: int, pattern: _BufferType
    ) -> int | None: ...
...
class Command:
    def __init__(
        self, name: str, command_class: int, completer_class: int = ..., prefix: bool = ...
    ) -> None: ...
...
def lookup_symbol(
    name: str, block: Block | None = ..., domain: int = ...
...
class Architecture:
    def name(self) -> str: ...
    def disassemble(
        self, start_pc: int, end_pc: int = ..., count: int = ...
