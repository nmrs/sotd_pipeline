...
from cryptography.hazmat.primitives.asymmetric.ed448 import (
    Ed448PrivateKey as Ed448PrivateKey,
    Ed448PublicKey as Ed448PublicKey,
)
...
from cryptography.hazmat.primitives.asymmetric.x448 import (
    X448PrivateKey as X448PrivateKey,
    X448PublicKey as X448PublicKey,
)
...
class JWK(dict[str, Any]):
    ...
    def import_from_pem(
        self, data: bytes, password: bytes | None = None, kid: str | None = None
    ) -> None: ...
    @overload
    def export_to_pem(
        self, private_key: Literal[False] = False, password: Unused = False
    ) -> bytes: ...
    @overload
