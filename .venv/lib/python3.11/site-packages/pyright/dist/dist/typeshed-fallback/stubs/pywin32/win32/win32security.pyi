...
def DsWriteAccountSpn(
    hDS: _win32typing.PyDS_HANDLE, Operation, Account: str, Spns: tuple[str, ...], /
) -> None: ...
...
def LogonUser(
    Username: str, Domain: str | None, Password: str, LogonType: int, LogonProvider: int
...
def LookupAccountName(
    systemName: str | None, accountName: str, /
) -> tuple[_win32typing.PySID, str, int]: ...
def LookupAccountSid(
    systemName: str, sid: _win32typing.PySID, /
...
def GetSecurityInfo(
    handle: int, ObjectType, SecurityInfo, /
...
def GetNamedSecurityInfo(
    ObjectName: str, ObjectType: int, SecurityInfo: int, /
) -> _win32typing.PySECURITY_DESCRIPTOR: ...
...
def AdjustTokenGroups(
    TokenHandle: int, ResetToDefault, NewState: _win32typing.PyTOKEN_GROUPS
) -> _win32typing.PyTOKEN_GROUPS: ...
...
def SetFileSecurity(
    filename: str, info: int, security: _win32typing.PySECURITY_DESCRIPTOR, /
) -> None: ...
def GetUserObjectSecurity(handle: int, info, /) -> _win32typing.PySECURITY_DESCRIPTOR: ...
def SetUserObjectSecurity(
    handle: int, info, security: _win32typing.PySECURITY_DESCRIPTOR, /
) -> None: ...
def GetKernelObjectSecurity(handle: int, info, /) -> _win32typing.PySECURITY_DESCRIPTOR: ...
def SetKernelObjectSecurity(
    handle: int, info, security: _win32typing.PySECURITY_DESCRIPTOR, /
) -> None: ...
...
def LsaQueryInformationPolicy(
    PolicyHandle: _win32typing.PyLSA_HANDLE, InformationClass, /
) -> None: ...
def LsaSetInformationPolicy(
    PolicyHandle: _win32typing.PyLSA_HANDLE, InformationClass, Information, /
) -> None: ...
def LsaAddAccountRights(
    PolicyHandle: _win32typing.PyLSA_HANDLE,
    AccountSid: _win32typing.PySID,
    UserRights: tuple[Incomplete, ...],
) -> None: ...
...
def LsaEnumerateAccountRights(
    PolicyHandle: _win32typing.PyLSA_HANDLE, AccountSid: _win32typing.PySID, /
) -> list[str]: ...
...
def ConvertSecurityDescriptorToStringSecurityDescriptor(
    SecurityDescriptor: _win32typing.PySECURITY_DESCRIPTOR,
...
def LsaStorePrivateData(
    PolicyHandle: _win32typing.PyLSA_HANDLE, KeyName: str, PrivateData, /
) -> None: ...
def LsaRetrievePrivateData(PolicyHandle: _win32typing.PyLSA_HANDLE, KeyName: str, /) -> str: ...
def LsaRegisterPolicyChangeNotification(
    InformationClass, NotificationEventHandle: int, /
) -> None: ...
def LsaUnregisterPolicyChangeNotification(
    InformationClass, NotificationEventHandle: int, /
) -> None: ...
...
def LsaLookupAuthenticationPackage(
    LsaHandle: _win32typing.PyLsaLogon_HANDLE, PackageName: str, /
): ...
...
def LsaCallAuthenticationPackage(
    LsaHandle: _win32typing.PyLsaLogon_HANDLE,
    AuthenticationPackage,
    MessageType,
    ProtocolSubmitBuffer: tuple[int, int],
    /,
) -> None: ...
@overload
def LsaCallAuthenticationPackage(
...
def TranslateName(
    accountName: str, accountNameFormat, accountNameFormat1, numChars=..., /
) -> str: ...
def CreateWellKnownSid(
    WellKnownSidType, DomainSid: _win32typing.PySID | None = ..., /
) -> _win32typing.PySID: ...
def MapGenericMask(
    AccessMask, GenericMapping: tuple[Incomplete, Incomplete, Incomplete, Incomplete], /
): ...
