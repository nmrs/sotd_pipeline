...
_Value: TypeAlias = (
    _str | bytes | bool | int | Decimal | datetime | _ArgumentMapping | list[_Value] | None
)
...
class Connection(Class):
    ...
    class Tune(Method):
        ...
        heartbeat: int
        def __init__(
            self, channel_max: int = 0, frame_max: int = 0, heartbeat: int = 0
        ) -> None: ...
        @property
        def synchronous(self) -> Literal[True]: ...
        def decode(self, encoded: bytes, offset: int = 0) -> Self: ...
    ...
    class Open(Method):
        ...
        insist: bool
        def __init__(
            self, virtual_host: _str = "/", capabilities: _str = "", insist: bool = False
        ) -> None: ...
        @property
        def synchronous(self) -> Literal[True]: ...
        def decode(self, encoded: bytes, offset: int = 0) -> Self: ...
    ...
    class Close(Method):
        ...
        def __init__(
            self, reply_code=None, reply_text: _str = "", class_id=None, method_id=None
        ) -> None: ...
        @property
        def synchronous(self) -> Literal[True]: ...
        def decode(self, encoded: bytes, offset: int = 0) -> Self: ...
...
class Basic(Class):
    ...
    class Return(Method):
        ...
        routing_key: Incomplete
        def __init__(
            self, reply_code=None, reply_text: _str = "", exchange=None, routing_key=None
        ) -> None: ...
        @property
        def synchronous(self) -> Literal[False]: ...
        def decode(self, encoded: bytes, offset: int = 0) -> Self: ...
