...
_DateGroupItemDateTimeGrouping: TypeAlias = Literal[
...
class ColorFilter(Serialisable):
    ...
    def __init__(
        self, dxfId: ConvertibleToInt | None = None, cellColor: _ConvertibleToBool | None = None
    ) -> None: ...
...
class CustomFilter(Serialisable):
    ...
    def __init__(
        self, operator: _CustomFilterOperator = "equal", val: str | None = None
    ) -> None: ...
...
class NumberFilter(CustomFilter):
    ...
    def __init__(
        self, operator: _CustomFilterOperator = "equal", val: ConvertibleToFloat | None = None
    ) -> None: ...
...
class StringFilter(CustomFilter):
    ...
    def __init__(
        self,
        operator: _StringFilterOperator = "contains",
        val: str | None = None,
        exclude: _ConvertibleToBool = False,
    ) -> None: ...
