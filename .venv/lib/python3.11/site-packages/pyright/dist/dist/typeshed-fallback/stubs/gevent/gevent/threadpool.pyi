...
class ThreadPool(GroupMappingMixin):
    ...
    def __init__(
        self, maxsize: int, hub: Hub | None = None, idle_task_timeout: int = -1
    ) -> None: ...
    @property
    ...
    ) -> AsyncResult[_T]: ...  # type: ignore[override]
...
class ThreadResult(Generic[_T]):
    ...
    def __init__(
        self, receiver: _Receiver[_T], hub: Hub, call_when_ready: Callable[[], object]
    ) -> None: ...
    @property
