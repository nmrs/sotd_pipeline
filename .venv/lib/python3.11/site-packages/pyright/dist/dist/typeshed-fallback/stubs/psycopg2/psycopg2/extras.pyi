...
class ReplicationCursor(_replicationCursor):
    ...
    def consume_stream(
        self,
        consume: Callable[[ReplicationMessage], object],
...
def register_hstore(
    conn_or_curs, globally: bool = False, unicode: bool = False, oid=None, array_oid=None
) -> None: ...
...
def execute_values(
    cur, sql, argslist, template=None, page_size: int = 100, fetch: bool = False
): ...
