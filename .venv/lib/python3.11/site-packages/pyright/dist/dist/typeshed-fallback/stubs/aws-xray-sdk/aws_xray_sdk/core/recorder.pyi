...
class AWSXRayRecorder:
    ...
    def in_subsegment(
        self, name: str | None = None, **subsegment_kwargs
    ...
    ) -> DummySubsegment | Subsegment | None: ...
    ...
    def set_trace_entity(
        self, trace_entity: Segment | Subsegment | DummySegment | DummySubsegment
    ) -> None: ...
