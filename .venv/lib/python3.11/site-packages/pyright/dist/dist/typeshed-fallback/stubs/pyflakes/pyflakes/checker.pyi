...
def parse_format_string(
    ...
    tuple[StrOrLiteralStr, StrOrLiteralStr | None, StrOrLiteralStr | None, StrOrLiteralStr | None]
]: ...
...
def iter_child_nodes(
    node: ast.AST, omit: _OmitType = None, _fields_order: _FieldsOrder = ...
) -> Iterator[ast.AST]: ...
@overload
...
class ImportationFrom(Importation):
    ...
    real_name: str
    def __init__(
        self, name: str, source: ast.AST, module: str, real_name: str | None = None
    ) -> None: ...
...
class Checker:
    ...
    def report(
        self, messageClass: Callable[_P, Message], *args: _P.args, **kwargs: _P.kwargs
    ) -> None: ...
    ...
    def handleStringAnnotation(
        self, s: str, node: ast.AST, ref_lineno: int, ref_col_offset: int, err: type[Message]
    ) -> None: ...
