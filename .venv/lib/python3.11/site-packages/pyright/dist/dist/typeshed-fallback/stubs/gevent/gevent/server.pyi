...
class StreamServer(BaseServer[[_GeventSocket, _Address]]):
    ...
    @classmethod
    def get_listener(
        cls, address: _StrictAddress, backlog: int | None = None, family: int | None = None
    ) -> _GeventSocket: ...
    def do_read(self) -> tuple[_GeventSocket, _Address]: ...
    def do_close(self, sock: _GeventSocket, address: _Address) -> None: ...
    def wrap_socket_and_handle(
        self, client_socket: _GeventSocket, address: _StrictAddress
    ) -> Any: ...
