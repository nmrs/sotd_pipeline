...
class Nanoleaf:
    ...
    def __init__(
        self, ip: str, auth_token: str | None = None, print_errors: bool = False
    ) -> None: ...
    ...
    @staticmethod
    def get_custom_base_effect(
        anim_type: str = "custom", loop: bool = True
    ) -> dict[str, Incomplete]: ...
    ...
    def register_event(
        self, func: Callable[[dict[str, Incomplete]], Any], event_types: list[int]
    ) -> None: ...
