...
class FP3232(rq.ValueField):
    ...
    def parse_value(
        self, value: tuple[ConvertibleToFloat, ConvertibleToFloat], display: Unused
...
def select_events(
    self: drawable.Window, event_masks: Sequence[tuple[int, Sequence[int]]]
) -> XISelectEvents: ...
...
class ClassInfoClass:
    structcode: None
    def parse_binary(
        self, data: SliceableBuffer, display: display.Display | None
    ) -> tuple[rq.DictWrapper, SliceableBuffer]: ...
...
def list_device_properties(
    self: Display | resource.Resource, deviceid: int
) -> XIListProperties: ...
...
def delete_device_property(
    self: Display | resource.Resource, deviceid: int, property: int
) -> XIDeleteProperty: ...
...
def ungrab_device(
    self: Display | resource.Resource, deviceid: int, time: int
) -> XIUngrabDevice: ...
...
def ungrab_keycode(
    self: drawable.Window, deviceid: int, keycode: int, modifiers: Sequence[int]
) -> XIPassiveUngrabDevice: ...
