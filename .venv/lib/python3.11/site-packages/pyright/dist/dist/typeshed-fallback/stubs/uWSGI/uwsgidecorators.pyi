...
@overload
def spoolraw(
    f: None = None, pass_arguments: bool = False
) -> Callable[[Callable[_P, _SR]], _spoolraw[_P, _SR]]: ...
@overload
...
def spool(
    f: None = None, pass_arguments: bool = False
) -> Callable[[Callable[_P, _SR]], _spool[_P, _SR]]: ...
@overload
def spoolforever(f: Callable[_P, _SR], pass_arguments: bool = False) -> _spoolforever[_P, _SR]: ...
@overload
def spoolforever(
    f: None = None, pass_arguments: bool = False
) -> Callable[[Callable[_P, _SR]], _spoolforever[_P, _SR]]: ...
...
class timer:
    ...
    target: str
    def __init__(
        self, secs: int, *, signum: int = ..., target: str = "", **kwargs: Any
    ) -> None: ...
    def __call__(self, f: _SignalCallbackT) -> _SignalCallbackT: ...
...
class filemon:
    ...
    target: str
    def __init__(
        self, fsobj: str, *, signum: int = ..., target: str = "", **kwargs: Any
    ) -> None: ...
    def __call__(self, f: _SignalCallbackT) -> _SignalCallbackT: ...
