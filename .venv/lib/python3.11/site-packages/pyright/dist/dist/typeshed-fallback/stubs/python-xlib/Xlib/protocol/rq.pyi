...
class Resource(Card32):
    ...
    codes: tuple[int, ...]
    def __init__(
        self, name: str, codes: tuple[int, ...] = (), default: int | None = None
    ) -> None: ...
...
class Set(ValueField):
    ...
    def __init__(
        self, name: str, size: int, values: Sequence[object], default: int | None = None
    ) -> None: ...
...
class Binary(ValueField):
    ...
    def parse_binary_value(
        self, data: _T, display: Unused, length: None, format: Unused
    ) -> tuple[_T, Literal[b""]]: ...
    @overload
    def parse_binary_value(
...
class StrClass:
    ...
    def parse_binary(
        self, data: bytes | bytearray, display: Unused
...
class Struct:
    ...
    @overload
    def parse_value(
        self, val: SliceableBuffer, display: display.Display | None, rawdict: Literal[True]
    ) -> dict[str, Any]: ...
    @overload
    def parse_value(
...
class ReplyRequest(GetAttrData):
    def __init__(
        self, display: display.Display, defer: bool = False, *args: object, **keys: object
    ) -> None: ...
    def reply(self) -> None: ...
...
class Event(GetAttrData):
    def __init__(
        self,
        binarydata: SliceableBuffer | None = None,
