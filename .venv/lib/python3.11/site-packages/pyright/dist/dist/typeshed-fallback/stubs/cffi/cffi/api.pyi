...
class FFI:
    ...
    def cdef(
        self, csource: str, override: bool = False, packed: bool = False, pack: int | None = None
    ) -> None: ...
    def embedding_api(
        self, csource: str, packed: bool = False, pack: bool | int | None = None
    ) -> None: ...
    ...
    def typeof(
        self, cdecl: str | CData | types.BuiltinFunctionType | types.FunctionType
    ) -> CType: ...
    ...
    @overload
    def from_buffer(
        self, cdecl: ReadableBuffer, require_writable: Literal[False] = False
    ) -> CData: ...
    @overload
    ...
    def from_buffer(
        ...
        require_writable: Literal[False] = False,
    ) -> CData: ...
    @overload
    def from_buffer(
    ...
    def verify(
        self, source: str = "", tmpdir: str | None = None, **kwargs: Any
    ) -> _cffi_backend.Lib: ...
    ...
    def set_source(
        self, module_name: str, source: str, source_extension: str = ".c", **kwds: Any
    ) -> None: ...
