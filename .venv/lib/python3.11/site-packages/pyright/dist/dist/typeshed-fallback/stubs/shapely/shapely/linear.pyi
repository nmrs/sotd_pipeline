...
def line_interpolate_point(
    line: None, distance: float, normalized: bool = False, **kwargs
) -> None: ...
@overload
def line_interpolate_point(
...
@overload
def line_interpolate_point(
    line: LineString | MultiLineString | GeometryCollection,
    distance: float,
...
def line_locate_point(
    line: LineString | MultiLineString | GeometryCollection | None,
    other: Point | None,
    normalized: bool = False,
    **kwargs,
) -> float: ...
...
@overload
def line_merge(
    line: Geometry, directed: bool = False, **kwargs
...
@overload
def shared_paths(
    a: LineString | MultiLineString | None, b: OptGeoArrayLikeSeq, **kwargs
) -> GeoArray: ...
@overload
