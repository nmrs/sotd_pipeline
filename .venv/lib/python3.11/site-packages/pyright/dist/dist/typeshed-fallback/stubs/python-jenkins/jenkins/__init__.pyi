...
class Jenkins:
    ...
    timeout: int
    def __init__(
        self, url: str, username: str | None = None, password: str | None = None, timeout: int = ...
    ) -> None: ...
    ...
    def jenkins_open(
        self, req: Request, add_crumb: bool = True, resolve_auth: bool = True
    ) -> str: ...
    def jenkins_open_stream(
        self, req: Request, add_crumb: bool = True, resolve_auth: bool = True
    ) -> Response: ...
    def jenkins_request(
        self,
    ...
    def assert_job_exists(
        self, name: str, exception_message: str = "job[%s] does not exist"
    ) -> None: ...
    ...
    def build_job_url(
        self,
        name: str,
        parameters: dict[str, Incomplete] | list[tuple[str, Incomplete]] | None,
        token: str,
    ) -> str: ...
    @overload
    def build_job_url(
        self,
        name: str,
        parameters: dict[str, Incomplete] | list[tuple[str, Incomplete]] | None = None,
        *,
        token: str,
    ) -> str: ...
    @overload
    ...
    def assert_node_exists(
        self, name: str, exception_message: str = "node[%s] does not exist"
    ) -> None: ...
    ...
    def assert_view_exists(
        self, name: str, exception_message: str = "view[%s] does not exist"
    ) -> None: ...
    ...
    def assert_promotion_exists(
        ...
        name: str,
        job_name: str,
        exception_message: str = "promotion[%s] does not exist for job[%s]",
    ) -> None: ...
    ...
    def assert_folder(
        self, name: str, exception_message: str = "job[%s] is not a folder"
    ) -> None: ...
    ...
    def create_credential(
        self, folder_name: str, config_xml: str, domain_name: str = "_"
    ) -> None: ...
    def delete_credential(self, name: str, folder_name: str, domain_name: str = "_") -> None: ...
    def reconfig_credential(
        self, folder_name: str, config_xml: str, domain_name: str = "_"
    ) -> None: ...
