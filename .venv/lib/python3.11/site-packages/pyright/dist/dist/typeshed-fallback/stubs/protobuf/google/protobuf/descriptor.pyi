...
class EnumValueDescriptor(DescriptorBase):
    def __new__(
        cls, name, index, number, type=None, options=None, serialized_options=None, create_key=None
    ): ...
    name: Any
    index: Any
    number: Any
    type: Any
    def __init__(
        self, name, index, number, type=None, options=None, serialized_options=None, create_key=None
    ) -> None: ...
...
def MakeDescriptor(
    desc_proto, package="", build_file_if_cpp=True, syntax=None, edition=None, file_desc=None
): ...
