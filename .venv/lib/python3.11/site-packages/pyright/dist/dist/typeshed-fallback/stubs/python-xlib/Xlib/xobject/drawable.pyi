...
from Xlib.protocol.structs import (
    _Arc6IntSequence,
    _Rectangle4IntSequence,
    _RGB3IntIterable,
    _Segment4IntSequence,
)
...
class _PilImage(Protocol):
    ...
    def tobytes(
        self, encoder_name: Literal["raw"], rawmode: str, stride: int, x: Literal[0], /
    ) -> bytes: ...
...
class Drawable(resource.Resource):
    ...
    def point(
        self, gc: int, x: int, y: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def poly_line(
        self,
        gc: int,
    ...
    def poly_segment(
        self,
        gc: int,
        segments: Sequence[_Segment4IntSequence],
        onerror: ErrorHandler[object] | None = None,
    ) -> None: ...
    def poly_rectangle(
        self,
    ...
    def poly_arc(
        self, gc: int, arcs: Sequence[_Arc6IntSequence], onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def arc(
        self,
        gc: int,
    ...
    def put_pil_image(
        self, gc: int, x: int, y: int, image: _PilImage, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def get_image(
        self, x: int, y: int, width: int, height: int, format: int, plane_mask: int
    ) -> request.GetImage: ...
    def draw_text(
        self,
        gc: int,
    ...
    def poly_text(
        ...
        x: int,
        y: int,
        items: Sequence[dict[str, str | int]],
        onerror: ErrorHandler[object] | None = None,
    ) -> None: ...
    def poly_text_16(
        self,
    ...
    def image_text(
        self, gc: int, x: int, y: int, string: str, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def image_text_16(
        self, gc: int, x: int, y: int, string: str, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def query_best_size(
        self, item_class: int, width: int, height: int
...
class Window(Drawable):
    ...
    def change_attributes(
        self, onerror: ErrorHandler[object] | None = None, **keys: object
    ) -> None: ...
    ...
    def reparent(
        self, parent: int, x: int, y: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    ...
    def delete_property(
        self, property: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def get_property(
        self, property: int, property_type: int, offset: int, length: int, delete: bool = False
    ) -> request.GetProperty | None: ...
    def get_full_property(
        self, property: int, property_type: int, sizehint: int = 10
    ) -> request.GetProperty | None: ...
    def get_full_text_property(
        self, property: int, property_type: int = 0, sizehint: int = 10
    ) -> str | None: ...
    def list_properties(self) -> list[int]: ...
    def set_selection_owner(
        self, selection: int, time: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    ...
    def ungrab_button(
        self, button: int, modifiers: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def grab_keyboard(
        self, owner_events: bool, pointer_mode: int, keyboard_mode: int, time: int
    ) -> int: ...
    def grab_key(
        self,
        key: int,
    ...
    def ungrab_key(
        self, key: int, modifiers: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def query_pointer(self) -> request.QueryPointer: ...
    def get_motion_events(self, start: int, stop: int) -> rq.Struct: ...
    def translate_coords(
        self, src_window: int, src_x: int, src_y: int
    ...
    def set_input_focus(
        self, revert_to: int, time: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def clear_area(
        self,
        x: int = 0,
    ...
    def rotate_properties(
        self, properties: Sequence[int], delta: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def set_wm_name(
        self, name: bytes | str, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def get_wm_name(self) -> str | None: ...
    def set_wm_icon_name(
        self, name: bytes | str, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def get_wm_icon_name(self) -> str | None: ...
    def set_wm_class(
        self, inst: str, cls: str, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def get_wm_class(self) -> tuple[str, str] | None: ...
    def set_wm_transient_for(
        self, window: Window, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def get_wm_transient_for(self) -> Window | None: ...
    def set_wm_protocols(
        self, protocols: Iterable[int], onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def get_wm_protocols(self) -> list[int]: ...
    def set_wm_colormap_windows(
        self, windows: Iterable[Window], onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def get_wm_colormap_windows(self) -> Iterable[Window]: ...
    def set_wm_client_machine(
        self, name: bytes | str, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def get_wm_client_machine(self) -> str | None: ...
    def set_wm_normal_hints(
        self,
        hints: rq.DictWrapper | dict[str, Any] = {},
        onerror: ErrorHandler[object] | None = None,
        **keys: object,
    ) -> None: ...
