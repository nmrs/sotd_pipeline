...
class NamingChecker:
    ...
    def visit_tree(
        self, node: ast.AST, parents: deque[ast.AST]
    ) -> Generator[tuple[int, int, str, Self]]: ...
    def visit_node(
        self, node: ast.AST, parents: Sequence[ast.AST]
    ) -> Generator[tuple[int, int, str, Self]]: ...
...
class ClassNameCheck(BaseASTCheck):
    ...
    def superclass_names(
        cls, name: str, parents: Sequence[ast.AST], _names: set[str] | None = None
    ) -> set[str]: ...
    def visit_classdef(
...
class ImportAsCheck(BaseASTCheck):
    codes: tuple[
        Literal["N811"], Literal["N812"], Literal["N813"], Literal["N814"], Literal["N817"]
    ]
    N811: Final[str]
    N812: Final[str]
    N813: Final[str]
...
class VariablesCheck(BaseASTCheck):
    ...
    def visit_for(
        self, node: ast.For, parents: Sequence[ast.AST], ignored: NameSet
    ) -> Generator[tuple[int, int, str, Self]]: ...
    def visit_asyncfor(
    ...
    @staticmethod
    def function_variable_check(
        func: Callable[..., object], var_name: str
    ) -> Literal["N806"] | None: ...
