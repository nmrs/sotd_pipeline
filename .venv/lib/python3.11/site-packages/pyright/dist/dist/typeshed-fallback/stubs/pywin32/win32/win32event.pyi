...
def CreateMutex(
    MutexAttributes: _win32typing.PySECURITY_ATTRIBUTES, InitialOwner, Name: str, /
) -> int: ...
def CreateSemaphore(
    SemaphoreAttributes: _win32typing.PySECURITY_ATTRIBUTES,
    InitialCount,
    MaximumCount,
    SemaphoreName,
    /,
...
def CreateWaitableTimer(
    TimerAttributes: _win32typing.PySECURITY_ATTRIBUTES, ManualReset, TimerName, /
) -> int: ...
def CreateWaitableTimerEx(
    lpTimerAttributes: _win32typing.PySECURITY_ATTRIBUTES | None,
    lpTimerName: str | None,
    dwFlags: int,
    dwDesiredAccess: int,
    /,
) -> _win32typing.PyHANDLE: ...
def MsgWaitForMultipleObjects(
    handlelist: Iterable[int], bWaitAll: int, milliseconds: int, wakeMask: int, /
) -> int: ...
