...
class ExtensionRequest(message.Message, metaclass=MessageMeta):
    ...
    def __init__(
        self, containing_type: str | None = ..., extension_number: int | None = ...
    ) -> None: ...
    DESCRIPTOR: Descriptor
...
class ExtensionNumberResponse(message.Message, metaclass=MessageMeta):
    ...
    def __init__(
        self, base_type_name: str | None = ..., extension_number: Iterable[int] | None = ...
    ) -> None: ...
    DESCRIPTOR: Descriptor
...
class ListServiceResponse(message.Message, metaclass=MessageMeta):
    ...
    def __init__(
        self, service: Iterable[ServiceResponse | Mapping[Incomplete, Incomplete]] | None = ...
    ) -> None: ...
    DESCRIPTOR: Descriptor
