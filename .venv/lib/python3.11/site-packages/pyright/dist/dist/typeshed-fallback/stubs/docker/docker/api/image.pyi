...
class ImageApiMixin:
    ...
    def images(
        self, name: str | None = None, quiet: bool = False, all: bool = False, filters=None
    ): ...
    def import_image(
        self,
        src=None,
    ...
    def import_image_from_data(
        self, data, repository: str | None = None, tag: str | None = None, changes=None
    ): ...
    def import_image_from_file(
        self, filename: str, repository: str | None = None, tag: str | None = None, changes=None
    ): ...
    def import_image_from_stream(
        self, stream, repository: str | None = None, tag: str | None = None, changes=None
    ): ...
    def import_image_from_url(
        self, url, repository: str | None = None, tag: str | None = None, changes=None
    ): ...
    def import_image_from_image(
        self, image, repository: str | None = None, tag: str | None = None, changes=None
    ): ...
