...
class RequestQuery(google.protobuf.message.Message):
    ...
    def pathing(
        ...
        global___RequestQueryPathing
    ]: ...
    @property
    def abilities(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___RequestQueryAvailableAbilities
    ]: ...
    @property
    def placements(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___RequestQueryBuildingPlacement
    ]: ...
    def __init__(
        self,
        *,
    ...
    def HasField(
        self,
        field_name: typing.Literal["ignore_resource_requirements", b"ignore_resource_requirements"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ResponseQuery(google.protobuf.message.Message):
    ...
    def pathing(
        ...
        global___ResponseQueryPathing
    ]: ...
    @property
    def abilities(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___ResponseQueryAvailableAbilities
    ]: ...
    @property
    def placements(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___ResponseQueryBuildingPlacement
    ]: ...
    def __init__(
        self,
        *,
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "abilities", b"abilities", "pathing", b"pathing", "placements", b"placements"
        ],
    ) -> None: ...
...
class RequestQueryPathing(google.protobuf.message.Message):
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["start", b"start"]
    ) -> typing.Literal["start_pos", "unit_tag"] | None: ...
...
class ResponseQueryAvailableAbilities(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["unit_tag", b"unit_tag", "unit_type_id", b"unit_type_id"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "abilities", b"abilities", "unit_tag", b"unit_tag", "unit_type_id", b"unit_type_id"
        ],
    ) -> None: ...
...
class ResponseQueryBuildingPlacement(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, result: s2clientprotocol.error_pb2.ActionResult.ValueType | None = ...
    ) -> None: ...
