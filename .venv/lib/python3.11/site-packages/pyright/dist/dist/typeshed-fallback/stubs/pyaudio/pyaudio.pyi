...
if sys.platform == "darwin":
    class PaMacCoreStreamInfo:
        ...
        def __init__(
            self, flags: int | None = ..., channel_map: _ChannelMap | None = ...
        ) -> None: ...
...
_StreamCallback: TypeAlias = Callable[
    [bytes | None, int, Mapping[str, float], int], tuple[bytes | None, int]
]
...
class Stream:
    ...
    def write(
        self, frames: bytes, num_frames: int | None = ..., exception_on_underflow: bool = ...
    ) -> None: ...
...
class PyAudio:
    ...
    def get_device_info_by_host_api_device_index(
        self, host_api_index: int, host_api_device_index: int
    ) -> _PaDeviceInfo: ...
