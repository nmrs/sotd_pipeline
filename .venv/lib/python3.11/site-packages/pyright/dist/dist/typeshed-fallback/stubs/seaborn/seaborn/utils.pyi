...
def locator_to_legend_entries(
    locator: Locator, limits: Iterable[float], dtype
...
def relative_luminance(
    color: ColorType | Sequence[ColorType] | ArrayLike,
