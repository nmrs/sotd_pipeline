...
def EnumObjectItems(
    DataSource: str | None, machine: str | None, _object: str, detailLevel, flags=..., /
): ...
def EnumObjects(
    DataSource: str | None, machine: str | None, detailLevel: int, refresh: bool = ..., /
): ...
def OpenQuery(DataSource: Incomplete | None = ..., userData: int = ..., /): ...
def CloseQuery(handle, /) -> None: ...
def MakeCounterPath(
    elements: tuple[Incomplete, Incomplete, Incomplete, Incomplete, Incomplete, Incomplete],
    flags=...,
    /,
) -> None: ...
