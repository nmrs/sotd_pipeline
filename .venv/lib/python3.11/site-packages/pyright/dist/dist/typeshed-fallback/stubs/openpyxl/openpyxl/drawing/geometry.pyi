...
class SphereCoords(Serialisable):
    ...
    def __init__(
        self, lat: ConvertibleToInt, lon: ConvertibleToInt, rev: ConvertibleToInt
    ) -> None: ...
...
class LightRig(Serialisable):
    ...
    rot: Typed[SphereCoords, Literal[True]]
    def __init__(
        self, rig: _LightRigRig, dir: _LightRigDir, rot: SphereCoords | None = None
    ) -> None: ...
...
class Vector3D(Serialisable):
    ...
    def __init__(
        self, dx: ConvertibleToInt, dy: ConvertibleToInt, dz: ConvertibleToInt
    ) -> None: ...
...
class Backdrop(Serialisable):
    ...
    def __init__(
        self, anchor: Point3D, norm: Vector3D, up: Vector3D, extLst: ExtensionList | None = None
    ) -> None: ...
...
class Bevel(Serialisable):
    ...
    def __init__(
        ...
        w: ConvertibleToInt,
        h: ConvertibleToInt,
        prst: _BevelPrst | Literal["none"] | None = None,
    ) -> None: ...
