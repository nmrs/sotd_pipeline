...
class DAVObject:
    ...
    def get_properties(
        self, props=None, depth: int = 0, parse_response_xml: bool = True, parse_props: bool = True
    ): ...
...
class Principal(DAVObject):
    ...
    def calendar(
        self, name: str | None = None, cal_id: str | None = None, cal_url: str | None = None
    ) -> Calendar: ...
...
class Calendar(DAVObject):
    ...
    def todos(
        self,
        sort_keys: Iterable[str] = ("due", "priority"),
        include_completed: bool = False,
        sort_key: str | None = None,
    ) -> list[Todo]: ...
    def event_by_url(self, href, data=None) -> Event: ...
    def object_by_uid(
        self, uid: str, comp_filter: CompFilter | None = None, comp_class: _CompClass | None = None
    ) -> Event: ...
    ...
    def objects_by_sync_token(
        self, sync_token=None, load_objects: bool = False
...
class FreeBusy(CalendarObjectResource):
    def __init__(
        self, parent, data, url: str | ParseResult | SplitResult | URL | None = None, id=None
    ) -> None: ...
