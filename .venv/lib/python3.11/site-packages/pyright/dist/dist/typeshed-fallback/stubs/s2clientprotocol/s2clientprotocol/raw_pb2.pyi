...
class _DisplayTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DisplayType.ValueType],
    builtins.type,
):
...
class _AllianceEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Alliance.ValueType], builtins.type
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _CloakStateEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_CloakState.ValueType],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class ObservationRaw(google.protobuf.message.Message):
    ...
    def units(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Unit]: ...
    @property
    ...
    def effects(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Effect]: ...
    @property
    def radar(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "event", b"event", "map_state", b"map_state", "player", b"player"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class RadarRing(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["pos", b"pos", "radius", b"radius"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["pos", b"pos", "radius", b"radius"]
    ) -> None: ...
...
class PowerSource(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["pos", b"pos", "radius", b"radius", "tag", b"tag"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["pos", b"pos", "radius", b"radius", "tag", b"tag"]
    ) -> None: ...
...
class PlayerRaw(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "camera", b"camera", "power_sources", b"power_sources", "upgrade_ids", b"upgrade_ids"
        ],
    ) -> None: ...
...
class RallyTarget(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["point", b"point", "tag", b"tag"]
    ) -> builtins.bool: ...
...
class Unit(google.protobuf.message.Message):
    ...
    def orders(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___UnitOrder]:
    ...
    def passengers(
        ...
        global___PassengerUnit
    ]: ...
    @property
    def rally_targets(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___RallyTarget
    ]: ...
    def __init__(
        self,
        *,
...
class MapState(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["creep", b"creep", "visibility", b"visibility"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["creep", b"creep", "visibility", b"visibility"]
    ) -> None: ...
...
class Event(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, dead_units: collections.abc.Iterable[builtins.int] | None = ...
    ) -> None: ...
...
class ActionRawCameraMove(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, center_world_space: s2clientprotocol.common_pb2.Point | None = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["center_world_space", b"center_world_space"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["center_world_space", b"center_world_space"]
    ) -> None: ...
...
class ActionRawToggleAutocast(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["ability_id", b"ability_id"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["ability_id", b"ability_id", "unit_tags", b"unit_tags"]
    ) -> None: ...
