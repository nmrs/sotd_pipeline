...
class StateMachine(Generic[_Context]):
    ...
    def __init__(
        self,
        state_classes: Iterable[type[State[_Context]]],
        initial_state: str,
        debug: bool = False,
    ) -> None: ...
...
class State(Generic[_Context]):
    ...
    def no_match(
        ...
        context: _Context,
        transitions: tuple[
            list[str], dict[str, tuple[Pattern[str], _TransitionMethod[_Context], str]]
        ],
    ) -> _TransitionResult[_Context]: ...
...
class StringList(ViewList[str]):
    ...
    def get_2D_block(
        self, top: int, left: int, bottom: int, right: int, strip_indent: bool = True
    ) -> StringList: ...
