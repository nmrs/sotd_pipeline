...
class SFTPFile(BufferedFile[Any]):
    ...
    pipelined: bool
    def __init__(
        self, sftp: SFTPClient, handle: _LikeBytes, mode: str = "r", bufsize: int = -1
    ) -> None: ...
    ...
    def check(
        self, hash_algorithm: str, offset: int = 0, length: int = 0, block_size: int = 0
    ) -> bytes: ...
    def set_pipelined(self, pipelined: bool = True) -> None: ...
    def prefetch(
        self, file_size: int | None = None, max_concurrent_requests: int | None = None
    ) -> None: ...
    def readv(
