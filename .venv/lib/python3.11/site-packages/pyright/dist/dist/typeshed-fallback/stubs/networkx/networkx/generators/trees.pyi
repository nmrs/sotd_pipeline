...
@_dispatchable
def random_unlabeled_rooted_tree(
    n, *, number_of_trees=None, seed=None
) -> Incomplete | list[Incomplete]: ...
@_dispatchable
def random_labeled_rooted_forest(n, *, seed=None): ...
@_dispatchable
def random_unlabeled_rooted_forest(
    n, *, q=None, number_of_forests=None, seed=None
) -> Incomplete | list[Incomplete]: ...
@_dispatchable
def random_unlabeled_tree(
    n, *, number_of_trees=None, seed=None
) -> Incomplete | list[Incomplete]: ...
