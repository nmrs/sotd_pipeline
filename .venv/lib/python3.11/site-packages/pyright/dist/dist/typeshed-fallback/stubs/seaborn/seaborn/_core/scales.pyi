...
class Nominal(Scale):
    values: (
        tuple[Incomplete, ...] | str | list[Incomplete] | dict[Incomplete, Incomplete] | None
    ) = None
...
class Temporal(ContinuousBase):
    trans: ClassVar[
        Incomplete
    ]  # not sure it is a classvar but the runtime has no annotation so it is not a dataclass field
