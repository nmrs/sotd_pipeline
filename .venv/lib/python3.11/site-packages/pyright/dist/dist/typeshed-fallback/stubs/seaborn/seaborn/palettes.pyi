...
def color_palette(  # type: ignore[overload-overlap]
    palette: _SeabornPaletteName | None = None,
    ...
    *,
    ...
    str
]: ...  # this might be a bug in seaborn because we expect the return type to be a Colormap instance
@overload
def color_palette(
    palette: str | Sequence[ColorType],
    n_colors: int | None = None,
    desat: float | None = None,
    *,
    as_cmap: Literal[True],
...
@overload
def mpl_palette(
    name: str, n_colors: int = 6, *, as_cmap: Literal[True]
) -> LinearSegmentedColormap: ...
@overload
def mpl_palette(
    name: str, n_colors: int = 6, as_cmap: Literal[False] = False
) -> _RGBColorPalette: ...
@overload
def dark_palette(
    color: ColorType,
