...
class DAVResponse:
    ...
    def expand_simple_props(
        self,
        props: Iterable[Incomplete] = [],
        multi_value_props: Iterable[Incomplete] = [],
        xpath: str | None = None,
...
class DAVClient:
    ...
    def principal(
        self, *, url: str | ParseResult | SplitResult | URL | None = None
    ) -> Principal: ...
    def calendar(
        self,
        *,
    ...
    def request(
        self, url: str, method: str = "GET", body: str = "", headers: Mapping[str, str] = {}
    ) -> DAVResponse: ...
