...
def InitiateSystemShutdown(
    computerName: str, message: str, timeOut, bForceClose, bRebootAfterShutdown, /
) -> None: ...
...
def ChangeDisplaySettingsEx(
    DeviceName: str | None = ..., DevMode: _win32typing.PyDEVMODE | None = ..., Flags=...
) -> int: ...
...
def EnumDisplayDevices(
    Device: str | None = ..., DevNum: int = ..., Flags: int = ...
) -> _win32typing.PyDISPLAY_DEVICE: ...
...
def EnumDisplaySettings(
    DeviceName: str | None = ..., ModeNum: int = ...
) -> _win32typing.PyDEVMODEW: ...
def EnumDisplaySettingsEx(
    DeviceName: str | None = ..., ModeNum=..., Flags=...
) -> _win32typing.PyDEVMODEW: ...
...
def GetDateFormat(
    locale: int, flags: int, time: TimeType | None, _format: str | None = None, /
) -> str: ...
...
def SetSystemFileCacheSize(
    MinimumFileCacheSize: int, MaximumFileCacheSize: int, Flags: int = ...
) -> None: ...
...
def LoadResource(
    handle: int, _type: _win32typing.PyResourceId, name: _win32typing.PyResourceId, language, /
) -> str: ...
def LoadString(handle: int, stringId, numChars: int = ..., /) -> str: ...
def MessageBeep(type: int = 0, /): ...
def MessageBox(
    hwnd: int | None, message: str, title: str | None = ..., style=..., language=..., /
) -> int: ...
def MonitorFromPoint(pt: tuple[Incomplete, Incomplete], Flags: int = ...) -> int: ...
def MonitorFromRect(
    rc: _win32typing.PyRECT | tuple[int, int, int, int], Flags: int = ...
) -> int: ...
...
def PostMessage(
    hwnd: int, idMessage, wParam: Incomplete | None = ..., lParam: Incomplete | None = ..., /
) -> None: ...
def PostQuitMessage(exitCode: int = ..., /) -> None: ...
def PostThreadMessage(
    tid, idMessage, wParam: Incomplete | None = ..., lParam: Incomplete | None = ..., /
) -> None: ...
...
def RegDeleteKeyEx(
    Key: _win32typing.PyHKEY, SubKey: str, samDesired: int = ..., Transaction: int | None = ...
) -> None: ...
...
def RegGetKeySecurity(
    key: _win32typing.PyHKEY, security_info, /
...
def RegOpenKeyEx(
    key: _win32typing.PyHKEY, subKey: str, sam: int, reserved: bool = ..., /
) -> _win32typing.PyHKEY: ...
...
def RegQueryValueEx(
    key: _win32typing.PyHKEY | int, valueName: str | None, /
) -> tuple[str, int]: ...
...
def RegSaveKey(
    key: _win32typing.PyHKEY, filename: str, sa: _win32typing.PySECURITY_ATTRIBUTES | None = ..., /
) -> None: ...
def RegSaveKeyEx(
    Key: _win32typing.PyHKEY,
    File: str,
...
def RegSetKeySecurity(
    key: _win32typing.PyHKEY, security_info, sd: _win32typing.PySECURITY_DESCRIPTOR, /
) -> None: ...
...
def RegNotifyChangeKeyValue(
    key: _win32typing.PyHKEY, bWatchSubTree, dwNotifyFilter, hKey: int, fAsynchronous, /
) -> None: ...
def SearchPath(path: str, fileName: str, fileExt: str | None = ..., /): ...
def SendMessage(
    hwnd: int, idMessage, wParam: str | None = ..., lParam: str | None = ..., /
) -> None: ...
...
def ToAsciiEx(
    vk, scancode, keyboardstate, flags: int = ..., hlayout: Incomplete | None = ..., /
): ...
def UpdateResource(
    handle: int,
