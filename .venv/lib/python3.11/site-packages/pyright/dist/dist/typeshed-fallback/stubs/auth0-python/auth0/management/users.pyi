...
class Users:
    ...
    async def add_permissions_async(
        self, id: str, permissions: _list[str]
    ) -> dict[str, Incomplete]: ...
    ...
    def link_user_account(
        self, user_id: str, body: dict[str, Incomplete]
    ) -> _list[dict[str, Incomplete]]: ...
    async def link_user_account_async(
        self, user_id: str, body: dict[str, Incomplete]
    ) -> _list[dict[str, Incomplete]]: ...
    ...
    async def create_authentication_method_async(
        self, user_id: str, body: dict[str, Incomplete]
    ) -> dict[str, Incomplete]: ...
    def update_authentication_methods(
        self, user_id: str, body: dict[str, Incomplete]
    ) -> dict[str, Incomplete]: ...
    async def update_authentication_methods_async(
        self, user_id: str, body: dict[str, Incomplete]
    ) -> dict[str, Incomplete]: ...
    ...
    async def delete_authentication_method_by_id_async(
        self, user_id: str, authentication_method_id: str
    ): ...
    def list_tokensets(
        self, id: str, page: int = 0, per_page: int = 25, include_totals: bool = True
