...
class MenuEditor:
    ...
    filenames: list[str]
    def __init__(
        self, menu: Menu | None = None, filename: StrPath | None = None, root: bool = False
    ) -> None: ...
    def parse(
        self, menu: Menu | None = None, filename: StrPath | None = None, root: bool = False
    ) -> None: ...
    ...
    @overload
    def createSeparator(
        self, parent: Menu, after: _MenuItem | None = None, before: None = None
    ) -> Separator: ...
    @overload
    def createSeparator(
        self, parent: Menu, after: None = None, before: _MenuItem | None = None
    ) -> Separator: ...
    @overload
    def moveMenuEntry(
        self,
