...
class Client:
    ...
    def transport_query(
        self,
    ) -> tuple[TransportState, dict[str, Any]]: ...  # Anyof[int, float, _CDataBase]
    ...
    def set_port_connect_callback(
        self,
        callback: Callable[[Port, Port, bool], object] | None = None,
        only_available: bool = True,
    ) -> None: ...
    def set_port_rename_callback(
        self,
        callback: Callable[[Port, str, str], object] | None = None,
        only_available: bool = True,
    ) -> None: ...
    ...
    def set_sync_callback(
        self, callback: Callable[[int, _JackPositionT], object] | None
    ) -> None: ...
    def release_timebase(self) -> None: ...
    def set_timebase_callback(
        self,
        callback: Callable[[int, int, _JackPositionT, bool], object] | None = None,
    ...
    def set_property(
        self, subject: int | str, key: str, value: str | bytes, type: str = ""
    ) -> None: ...
...
class Ports:
    ...
    def register(
        self, shortname: str, is_terminal: bool = False, is_physical: bool = False
    ) -> Port: ...
    def clear(self) -> None: ...
