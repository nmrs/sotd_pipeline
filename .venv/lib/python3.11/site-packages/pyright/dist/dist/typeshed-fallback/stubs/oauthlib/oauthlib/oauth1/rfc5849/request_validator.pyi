...
class RequestValidator:
    ...
    def invalidate_request_token(
        self, client_key: str, request_token: str, request: Request
    ) -> None: ...
    ...
    def validate_requested_realms(
        self, client_key: str, realms: list[str], request: Request
    ) -> bool: ...
    def validate_realms(
        self,
        client_key: str,
    ...
    def validate_verifier(
        self, client_key: str, token: str, verifier: str, request: Request
    ) -> bool: ...
