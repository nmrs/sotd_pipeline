...
class _SupportsComparisons(
    SupportsDunderLT[_T_contra], SupportsDunderGT[_T_contra], Protocol[_T_contra]
): ...
...
class ResourceDB:
    ...
    def output(self) -> str: ...
    def getopt(
        self, name: str, argv: Sequence[str], opts: Mapping[str, Option]
    ) -> Sequence[str]: ...
