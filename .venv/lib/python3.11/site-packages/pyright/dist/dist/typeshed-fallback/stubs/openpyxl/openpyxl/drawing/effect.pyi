...
class HSLEffect(Serialisable):
    ...
    def __init__(
        self, hue: ConvertibleToInt, sat: ConvertibleToInt, lum: ConvertibleToInt
    ) -> None: ...
...
class ColorChangeEffect(Serialisable):
    ...
    @overload
    def __init__(
        self, useA: _ConvertibleToBool | None = None, *, clrFrom: Color, clrTo: Color
    ) -> None: ...
    @overload
...
class InnerShadowEffect(ColorChoice):
    ...
    __elements__: ClassVar[tuple[str, ...]]
    def __init__(
        self, blurRad: ConvertibleToFloat, dist: ConvertibleToFloat, dir: ConvertibleToInt, **kw
    ) -> None: ...
...
class PresetShadowEffect(ColorChoice):
    ...
    __elements__: ClassVar[tuple[str, ...]]
    def __init__(
        self, prst: _PresetShadowEffectPrst, dist: ConvertibleToFloat, dir: ConvertibleToInt, **kw
    ) -> None: ...
