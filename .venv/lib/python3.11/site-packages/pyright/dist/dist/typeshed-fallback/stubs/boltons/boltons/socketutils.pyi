...
class BufferedSocket:
    ...
    timeout: int
    def __init__(
        self, sock: socket.socket, timeout: int = ..., maxsize: int = 32768, recvsize: int = ...
    ) -> None: ...
    ...
    def recv_until(
        self,
        delimiter: ReadableBuffer,
        timeout: float = ...,
        maxsize: int = ...,
        with_delimiter: bool = False,
    ) -> bytes: ...
    ...
    def setsockopt(
        self, level: int, optname: int, value: int | ReadableBuffer | None
    ) -> bytes | int: ...
    @property
    def type(self) -> int: ...
    @property
