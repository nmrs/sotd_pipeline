...
class Library:
    ...
    def signature(
        self, recompute_hashes: bool = False, version_method: Callable[[str], str] | None = None
    ) -> str: ...
...
def register_inclusion_renderer(
    extension: str, renderer: _Renderer, order: int | None = None
) -> None: ...
...
class NeededResources:
    ...
    def need(
        self, resource: Resource | Group, slots: dict[Slot, Resource] | None = None
    ) -> None: ...
