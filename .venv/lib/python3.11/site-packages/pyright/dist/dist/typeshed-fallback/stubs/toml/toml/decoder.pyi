...
@overload
def loads(
    s: str, _dict: type[_MutableMappingT], decoder: TomlDecoder[_MutableMappingT] | None = None
) -> _MutableMappingT: ...
@overload
def loads(
    s: str, _dict: type[dict[str, Any]] = ..., decoder: TomlDecoder[dict[str, Any]] | None = None
) -> dict[str, Any]: ...
...
class TomlDecoder(Generic[_MutableMappingT]):
    ...
    def load_inline_object(
        self,
        line: str,
        currentlevel: _MutableMappingT,
        multikey: bool = False,
        multibackslash: bool = False,
    ) -> None: ...
    def load_line(
