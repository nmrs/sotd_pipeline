...
class Ref3D(tuple[int, int, int, int, int, int, int, int, int, int, int, int]):
    ...
    colxhi: int
    def __new__(
        cls, atuple: tuple[int, int, int, int, int, int, int, int, int, int, int, int]
    ) -> Self: ...
    def __init__(
        self, atuple: tuple[int, int, int, int, int, int, int, int, int, int, int, int]
    ) -> None: ...

def evaluate_name_formula(
    bk: Book, nobj: Name, namex: str, blah: int = 0, level: int = 0
) -> None: ...
...
def dump_formula(
    bk: Book, data: bytes, fmlalen: int, bv: int, reldelta: int, blah: int = 0, isname: int = 0
) -> None: ...
...
def rangename3drel(
    book: Book, ref3d: Ref3D, browx: int | None = None, bcolx: int | None = None, r1c1: int = 0
) -> str: ...
