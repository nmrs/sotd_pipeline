...
class _AttributeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Attribute.ValueType], builtins.type
):
...
class AbilityData(google.protobuf.message.Message):
    ...
    class _TargetEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[AbilityData._Target.ValueType],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class DamageBonus(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["attribute", b"attribute", "bonus", b"bonus"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["attribute", b"attribute", "bonus", b"bonus"]
    ) -> None: ...
...
class Weapon(google.protobuf.message.Message):
    ...
    class _TargetTypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Weapon._TargetType.ValueType],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class UnitTypeData(google.protobuf.message.Message):
    ...
    def weapons(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Weapon]: ...
    def __init__(
        self,
        *,
...
class BuffData(google.protobuf.message.Message):
    ...
    name: builtins.str
    def __init__(
        self, *, buff_id: builtins.int | None = ..., name: builtins.str | None = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["buff_id", b"buff_id", "name", b"name"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["buff_id", b"buff_id", "name", b"name"]
    ) -> None: ...
