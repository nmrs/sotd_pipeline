...
class PreFindModulePathAPI:
    ...
    def __init__(
        self, module_graph: PyiModuleGraph, module_name: str, search_dirs: Iterable[StrOrBytesPath]
    ) -> None: ...
    @property
    def module_graph(self) -> PyiModuleGraph: ...
    @property
...
class PostGraphAPI:
    ...
    module: Package
    def __init__(
        self, module_name: str, module_graph: PyiModuleGraph, analysis: Analysis
    ) -> None: ...
    @property
    ...
    def add_binaries(
        self, binaries: TOC | Iterable[tuple[StrOrBytesPath, StrOrBytesPath]]
    ) -> None: ...
