...
def query_int_attribute(
    self: Display | resource.Resource, target: Target, display_mask: int, attr: int
) -> int | None: ...
def set_int_attribute(
    self: Display | resource.Resource, target: Target, display_mask: int, attr: int, value: int
) -> bool: ...
def query_string_attribute(
    self: Display | resource.Resource, target: Target, display_mask: int, attr: int
) -> str | None: ...
def query_valid_attr_values(
    self: Display | resource.Resource, target: Target, display_mask: int, attr: int
) -> tuple[int, int] | None: ...
def query_binary_data(
    self: Display | resource.Resource, target: Target, display_mask: int, attr: int
) -> bytes | None: ...
def get_coolers_used_by_gpu(
    self: Display | resource.Resource, target: Target
) -> list[int] | None: ...
...
def get_total_dedicated_gpu_memory(
    self: Display | resource.Resource, target: Target
) -> int | None: ...
def get_used_dedicated_gpu_memory(
    self: Display | resource.Resource, target: Target
) -> int | None: ...
...
def get_curr_pcie_link_generation(
    self: Display | resource.Resource, target: Target
) -> int | None: ...
...
def get_current_performance_level(
    self: Display | resource.Resource, target: Target
) -> int | None: ...
def get_gpu_nvclock_offset(
    self: Display | resource.Resource, target: Target, perf_level: int
) -> int | None: ...
def set_gpu_nvclock_offset(
    self: Display | resource.Resource, target: Target, perf_level: int, offset: int
) -> bool: ...
def set_gpu_nvclock_offset_all_levels(
    self: Display | resource.Resource, target: Target, offset: int
) -> bool: ...
def get_gpu_nvclock_offset_range(
    self: Display | resource.Resource, target: Target, perf_level: int
) -> tuple[int, int] | None: ...
def get_mem_transfer_rate_offset(
    self: Display | resource.Resource, target: Target, perf_level: int
) -> int | None: ...
def set_mem_transfer_rate_offset(
    self: Display | resource.Resource, target: Target, perf_level: int, offset: int
) -> bool: ...
def set_mem_transfer_rate_offset_all_levels(
    self: Display | resource.Resource, target: Target, offset: int
) -> bool: ...
def get_mem_transfer_rate_offset_range(
    self: Display | resource.Resource, target: Target, perf_level: int
) -> tuple[int, int] | None: ...
def get_cooler_manual_control_enabled(
    self: Display | resource.Resource, target: Target
) -> int | None: ...
def set_cooler_manual_control_enabled(
    self: Display | resource.Resource, target: Target, enabled: bool
) -> bool: ...
