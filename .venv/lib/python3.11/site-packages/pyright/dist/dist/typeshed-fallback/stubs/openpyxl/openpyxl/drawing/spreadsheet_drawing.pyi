...
class AnchorClientData(Serialisable):
    ...
    def __init__(
        self,
        fLocksWithSheet: _ConvertibleToBool | None = None,
        fPrintsWithSheet: _ConvertibleToBool | None = None,
    ) -> None: ...
...
class AnchorMarker(Serialisable):
    ...
    def __init__(
        self,
        col: ConvertibleToInt = 0,
        colOff: ConvertibleToInt = 0,
        row: ConvertibleToInt = 0,
        rowOff: ConvertibleToInt = 0,
    ) -> None: ...
...
class AbsoluteAnchor(_AnchorBase):
    ...
    __elements__: ClassVar[tuple[str, ...]]
    def __init__(
        self, pos: XDRPoint2D | None = None, ext: XDRPositiveSize2D | None = None, **kw
    ) -> None: ...
...
class OneCellAnchor(_AnchorBase):
    ...
    __elements__: ClassVar[tuple[str, ...]]
    def __init__(
        self, _from: AnchorMarker | None = None, ext: XDRPositiveSize2D | None = None, **kw
    ) -> None: ...
