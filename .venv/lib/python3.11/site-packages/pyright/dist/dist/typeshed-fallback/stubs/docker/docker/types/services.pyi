...
class RestartPolicy(dict[str, Incomplete]):
    ...
    def __init__(
        self,
        condition: Literal["none", "on-failure", "any"] = "none",
        delay: int = 0,
        max_attempts: int = 0,
        window: int = 0,
    ) -> None: ...
...
class EndpointSpec(dict[str, Incomplete]):
    def __init__(
        self,
        mode: str | None = None,
        ports: Mapping[str, str | tuple[str | None, ...]] | list[dict[str, str]] | None = None,
    ) -> None: ...
...
def convert_service_ports(
    ports: Mapping[str, str | tuple[str | None, ...]],
) -> list[dict[str, str]]: ...
...
class NetworkAttachmentConfig(dict[str, Incomplete]):
    def __init__(
        ...
        options: dict[str, Incomplete] | None = None,
    ) -> None: ...
