...
class ChartContainer(Serialisable):
    ...
    def __init__(
        ...
        autoTitleDeleted: _HasTagAndGet[_ConvertibleToBool | None]
        | _ConvertibleToBool
        | None = None,
        pivotFmts=(),
        ...
        showDLblsOverMax: _HasTagAndGet[_ConvertibleToBool | None]
        | _ConvertibleToBool
        | None = None,
        extLst: Unused = None,
    ) -> None: ...
...
class ExternalData(Serialisable):
    ...
    def __init__(
        self,
        autoUpdate: _HasTagAndGet[_ConvertibleToBool | None] | _ConvertibleToBool | None = None,
        *,
        id: str,
    ) -> None: ...
    @overload
...
class ChartSpace(Serialisable):
    ...
    def to_tree(
        self, tagname: Unused = None, idx: Unused = None, namespace: Unused = None
    ) -> Element: ...
