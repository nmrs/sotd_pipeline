...
class Channel:
    ...
    def __init__(
        ...
        connection: Connection,
        channel_number: int,
        on_open_callback: Callable[[Self], object],
    ) -> None: ...
    ...
    def basic_cancel(
        self,
        consumer_tag: str = "",
        callback: Callable[[Method[Basic.CancelOk]], object] | None = None,
    ) -> None: ...
    def basic_consume(
        self,
        queue: str,
    ...
    def basic_get(
        self,
        queue: str,
        callback: Callable[[Channel, Basic.GetOk, BasicProperties, bytes], object],
        auto_ack: bool = False,
    ) -> None: ...
    def basic_nack(
    ...
    def basic_recover(
        self,
        requeue: bool = False,
        callback: Callable[[Method[Basic.RecoverOk]], object] | None = None,
    ) -> None: ...
    ...
    def queue_purge(
        self, queue: str, callback: Callable[[Method[Queue.PurgeOk]], object] | None = None
    ) -> None: ...
    def queue_unbind(
        self,
        queue: str,
    ...
    def tx_commit(
        self, callback: Callable[[Method[Tx.CommitOk]], object] | None = None
    ) -> None: ...
    def tx_rollback(
        self, callback: Callable[[Method[Tx.RollbackOk]], object] | None = None
    ) -> None: ...
    def tx_select(
        self, callback: Callable[[Method[Tx.SelectOk]], object] | None = None
    ) -> None: ...

class ContentFrameAssembler:
    def __init__(self) -> None: ...
    def process(
        self, frame_value: Method[Any] | Header | Body
    ) -> tuple[Incomplete, Incomplete, bytes] | None: ...
