...
class SmartTag(Serialisable):
    ...
    def __init__(
        self, namespaceUri: str | None = None, name: str | None = None, url: str | None = None
    ) -> None: ...
...
class SmartTagProperties(Serialisable):
    ...
    def __init__(
        self,
        embed: _ConvertibleToBool | None = None,
        show: _SmartTagPropertiesShow | Literal["none"] | None = None,
    ) -> None: ...
