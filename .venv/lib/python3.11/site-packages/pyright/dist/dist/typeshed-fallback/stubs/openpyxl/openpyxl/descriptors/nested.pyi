...
_NestedNoneSetParam: TypeAlias = (
    _HasTagAndGet[_T | Literal["none"] | None] | _T | Literal["none"] | None
)
...
class NestedText(NestedValue[_T, _N]):
    ...
    @overload
    def __set__(
        self: NestedText[int, Literal[True]],
        instance: Serialisable | Strict,
        value: ConvertibleToInt | None,
    ) -> None: ...
    @overload
    def __set__(
        self: NestedText[int, Literal[False]],
        instance: Serialisable | Strict,
...
class NestedFloat(NestedValue[float, _N], Float[_N]):  # type: ignore[misc]
    @overload
    def __init__(
        self: NestedFloat[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: NestedFloat[Literal[False]],
        name: str | None = None,
        *,
        allow_none: Literal[False] = False,
    ) -> None: ...
...
class NestedInteger(NestedValue[int, _N], Integer[_N]):  # type: ignore[misc]
    @overload
    def __init__(
        self: NestedInteger[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: NestedInteger[Literal[False]],
        name: str | None = None,
        *,
        allow_none: Literal[False] = False,
    ) -> None: ...
...
class NestedString(NestedValue[str, _N], String[_N]):  # type: ignore[misc]
    @overload
    def __init__(
        self: NestedString[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: NestedString[Literal[False]],
        name: str | None = None,
        *,
        allow_none: Literal[False] = False,
    ) -> None: ...
...
class NestedBool(NestedValue[bool, _N], Bool[_N]):  # type: ignore[misc]
    @overload
    def __init__(
        self: NestedBool[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: NestedBool[Literal[False]],
        name: str | None = None,
        *,
        allow_none: Literal[False] = False,
    ) -> None: ...
...
class NestedMinMax(Nested[_M], MinMax[_M, _N]):  # type: ignore[misc]
    ...
    @overload
    def __get__(
        self: NestedMinMax[_M, Literal[True]],
        instance: Serialisable | Strict,
        cls: type | None = None,
    ) -> _M | None: ...
    @overload
    def __get__(
        self: NestedMinMax[_M, Literal[False]],
        instance: Serialisable | Strict,
        cls: type | None = None,
    ) -> _M: ...
...
class EmptyTag(Nested[bool], Bool[_N]):  # type: ignore[misc]
    @overload
    def __init__(
        self: EmptyTag[Literal[True]], name: str | None = None, *, allow_none: Literal[True]
    ) -> None: ...
    @overload
    def __init__(
        self: EmptyTag[Literal[False]],
        name: str | None = None,
        *,
        allow_none: Literal[False] = False,
    ) -> None: ...
    @overload
    def __get__(
        self: EmptyTag[Literal[True]], instance: Serialisable | Strict, cls: type | None = None
    ) -> bool | None: ...
    @overload
    def __get__(
        self: EmptyTag[Literal[False]], instance: Serialisable | Strict, cls: type | None = None
    ) -> bool: ...
    def __set__(
        self,
        instance: Serialisable | Strict,
