...
def connect(
    ...
    user: str,
    password: str,
    options: dict[int, int | str] | None = ...,
    replace_quoted_literal: int = ...,
    /,
) -> IBM_DBConnection | None: ...
def createdb(
    connection: IBM_DBConnection, dbName: str, codeSet: str = ..., mode: str = ..., /
) -> bool: ...
def createdbNX(
    connection: IBM_DBConnection, dbName: str, codeSet: str = ..., mode: str = ..., /
) -> bool: ...
...
def fetch_both(
    stmt: IBM_DBStatement, row_number: int = ..., /
) -> dict[int | str, object] | bool: ...
...
def recreatedb(
    connection: IBM_DBConnection, dbName: str, codeSet: str | None = ..., mode: str | None = ..., /
) -> bool: ...
...
def set_option(
    resc: IBM_DBConnection | IBM_DBStatement, options: dict[int, int | str], type: int, /
) -> bool: ...
def special_columns(
    connection: IBM_DBConnection,
    qualifier: str | None,
