...
class NodeView(Mapping[_Node, dict[str, Any]], AbstractSet[_Node]):
    ...
    @overload
    def __call__(
        self, data: Literal[True] | str, default=None
...
class NodeDataView(AbstractSet[_Node]):
    def __init__(
        self, nodedict: Mapping[str, Incomplete], data: bool | str = False, default=None
    ) -> None: ...
    def __len__(self) -> int: ...
...
class DiDegreeView(Generic[_Node]):
    def __init__(
        self, G: Graph[_Node], nbunch: _NBunch[_Node] = None, weight: None | bool | str = None
    ) -> None: ...
    def __call__(
        self, nbunch: _NBunch[_Node] = None, weight: None | bool | str = None
    ) -> int | DiDegreeView[_Node]: ...
...
class OutEdgeDataView(EdgeViewABC, Generic[_Node, _D]):
    def __init__(
        self, viewer, nbunch: _NBunch[_Node] = None, data: bool = False, *, default=None
    ) -> None: ...
    def __len__(self) -> int: ...
...
class OutEdgeView(
    AbstractSet[Incomplete], Mapping[Incomplete, Incomplete], EdgeViewABC, Generic[_Node]
):
    ...
    @overload
    def __call__(
        self, nbunch: None = None, data: Literal[False] = False, *, default: Unused = None
