...
_ConvertibleToLinearRing: TypeAlias = (
    _ConvertibleToLineString  # same alias but with better name for doc purposes
)
...
class Polygon(BaseGeometry):
    ...
    def svg(
        self, scale_factor: float = 1.0, fill_color: str | None = None, opacity: float | None = None
