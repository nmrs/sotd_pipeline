...
from antlr4.atn.ATNDeserializationOptions import (
    ATNDeserializationOptions as ATNDeserializationOptions,
)
...
class Parser(Recognizer):
    ...
    def compileParseTreePattern(
        self, pattern: str, patternRuleIndex: int, lexer: Lexer | None = None
    ): ...
