...
def EnumServicesStatusEx(
    SCManager: _win32typing.PySC_HANDLE,
    ServiceType,
    ServiceState,
    InfoLevel,
    GroupName: Incomplete | None = ...,
    /,
) -> tuple[Incomplete, ...]: ...
def EnumDependentServices(
    hService: _win32typing.PySC_HANDLE, ServiceState, /
) -> tuple[Incomplete, ...]: ...
...
def OpenService(
    scHandle: _win32typing.PySC_HANDLE, name: str, desiredAccess, /
) -> _win32typing.PySC_HANDLE: ...
def OpenSCManager(
    machineName: str | None, dbName: str | None, desiredAccess: int, /
) -> _win32typing.PySC_HANDLE: ...
...
def SetServiceObjectSecurity(
    Handle: _win32typing.PySC_HANDLE,
    SecurityInformation,
...
def SetServiceStatus(
    scHandle,
    serviceStatus: _win32typing.SERVICE_STATUS | tuple[int, int, int, int, int, int, int],
    /,
) -> None: ...
...
def QueryServiceLockStatus(
    hSCManager: _win32typing.PySC_HANDLE, /
) -> tuple[Incomplete, str, Incomplete]: ...
