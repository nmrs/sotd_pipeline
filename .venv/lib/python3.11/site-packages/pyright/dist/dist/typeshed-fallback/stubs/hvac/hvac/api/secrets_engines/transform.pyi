...
class Transform(VaultApiBase):
    ...
    def create_or_update_template(
        self, name, template_type, pattern, alphabet, mount_point: str = "transform"
    ): ...
    ...
    def update_tokenization_key_config(
        self, transform_name, min_decryption_version, mount_point: str = "transform"
    ): ...
    def list_tokenization_key_configuration(self, mount_point: str = "transform"): ...
    def read_tokenization_key_configuration(
        self, transform_name, mount_point: str = "transform"
    ): ...
    def trim_tokenization_key_version(
        self, transform_name, min_available_version, mount_point: str = "transform"
    ): ...
