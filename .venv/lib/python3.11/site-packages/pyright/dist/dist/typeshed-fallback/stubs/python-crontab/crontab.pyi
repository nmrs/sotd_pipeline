...
class CronTab:
    ...
    def run_scheduler(
        self, timeout: int = -1, cadence: int = 60, warp: bool = False
    ) -> Iterator[str]: ...
    ...
    def remove_all(
        self,
        *,
        command: str | re.Pattern[str] = ...,
        comment: str | re.Pattern[str] = ...,
        time: Any = ...,
        **kwargs: object,
    ) -> int: ...
...
class CronItem:
    ...
    @classmethod
    def from_line(
        cls, line: str, user: str | None = ..., cron: Incomplete | None = ...
    ) -> Self: ...
    ...
    @overload
    def frequency_at_hour(
        self, year: None = None, month: None = None, day: None = None, hour: None = None
    ) -> int: ...
