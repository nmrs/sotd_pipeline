...
_AnyTimeType: TypeAlias = (
    datetime.datetime | datetime.date | datetime.timedelta | datetime.time | _PeriodTuple
)
...
class vBoolean(int):
    ...
    params: Parameters
    def __new__(
        cls, x: ConvertibleToInt = ..., /, *, params: SupportsKeysAndGetItem[str, str] = {}
    ) -> Self: ...
...
class vText(str):
    ...
    def __new__(
        ...
        value: ICAL_TYPE,
        encoding: str = "utf-8",
        params: SupportsKeysAndGetItem[str, str] = {},
    ) -> Self: ...
    def to_ical(self) -> bytes: ...
    @classmethod
...
class vCalAddress(str):
    params: Parameters
    def __new__(
        cls, value: ICAL_TYPE, encoding="utf-8", params: SupportsKeysAndGetItem[str, str] = {}
    ) -> Self: ...
    def to_ical(self) -> bytes: ...
    @classmethod
    def from_ical(cls, ical: ICAL_TYPE) -> Self: ...
...
class vFloat(float):
    params: Parameters
    def __new__(
        cls, x: ConvertibleToFloat = ..., /, *, params: SupportsKeysAndGetItem[str, str] = {}
    ) -> Self: ...
    def to_ical(self) -> bytes: ...
    @classmethod
    def from_ical(cls, ical: ICAL_TYPE) -> Self: ...
...
class vCategory:
    ...
    params: Parameters
    def __init__(
        self, c_list: Iterable[ICAL_TYPE] | ICAL_TYPE, params: SupportsKeysAndGetItem[str, str] = {}
    ) -> None: ...
...
class vDatetime(TimeBase):
    ...
    params: Parameters
    def __init__(
        self, dt: datetime.datetime, params: SupportsKeysAndGetItem[str, str] = {}
    ) -> None: ...
    def to_ical(self) -> bytes: ...
    @staticmethod
    def from_ical(
        ical: ICAL_TYPE, timezone: datetime.timezone | str | None = None
    ) -> datetime.datetime: ...
...
class vDuration(TimeBase):
    ...
    params: Parameters
    def __init__(
        self, td: datetime.timedelta, params: SupportsKeysAndGetItem[str, str] = {}
    ) -> None: ...
    def to_ical(self) -> bytes: ...
    @staticmethod
...
class vPeriod(TimeBase):
    ...
    @staticmethod
    def from_ical(
        ical: str, timezone: datetime.timezone | str | None = None
    ) -> tuple[Any, Any]: ...
    @property
...
class vMonth(int):
    params: Parameters
    def __new__(
        cls, month: vMonth | str | int, params: SupportsKeysAndGetItem[str, str] = {}
    ) -> Self: ...
    def to_ical(self) -> bytes: ...
    @classmethod
...
class vGeo:
    ...
    params: Parameters
    def __init__(
        self, geo: tuple[float | str, float | str], params: SupportsKeysAndGetItem[str, str] = {}
    ) -> None: ...
    def to_ical(self) -> str: ...
    @staticmethod
