...
def generate_parameter_deprecation_message(
    ...
    new_parameter_name: str | None = None,
...
def getattr_with_deprecated_properties(
    obj: object, item: str, deprecated_properties: dict[str, _DeprecateProperty]
) -> Any: ...
def deprecated_method(
    to_be_removed_in_version: str, new_method: Callable[..., Any] | None = None
) -> Callable[..., Any]: ...
def validate_list_of_strings_param(
    param_name: str, param_argument: Iterable[Any] | str
) -> None: ...
