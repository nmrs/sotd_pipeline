...
@overload
def difference(
    a: Geometry, b: Geometry, grid_size: float | None = None, **kwargs
) -> BaseGeometry: ...
@overload
...
@overload
def difference(
    a: OptGeoArrayLikeSeq, b: OptGeoArrayLike, grid_size: float | None = None, **kwargs
) -> GeoArray: ...
@overload
def difference(
    a: OptGeoArrayLike, b: OptGeoArrayLikeSeq, grid_size: float | None = None, **kwargs
) -> GeoArray: ...
@overload
def intersection(
    a: Geometry, b: Geometry, grid_size: float | None = None, **kwargs
...
def intersection_all(
    geometries: OptGeoArrayLikeSeq, axis: int, **kwargs
...
@overload
def symmetric_difference(
    a: None, b: Geometry | None, grid_size: float | None = None, **kwargs
) -> None: ...
@overload
def symmetric_difference(
    a: Geometry | None, b: None, grid_size: float | None = None, **kwargs
) -> None: ...
@overload
def symmetric_difference(
    a: OptGeoArrayLikeSeq, b: OptGeoArrayLike, grid_size: float | None = None, **kwargs
...
def symmetric_difference_all(
    geometries: OptGeoArrayLike, axis: None = None, **kwargs
) -> BaseGeometry: ...
@overload
def symmetric_difference_all(
    geometries: OptGeoArrayLikeSeq, axis: int, **kwargs
...
@overload
def union_all(
    geometries: OptGeoArrayLike, grid_size: float | None = None, axis: None = None, **kwargs
) -> BaseGeometry: ...
@overload
def union_all(
...
@overload
def union_all(
    geometries: OptGeoArrayLikeSeq, grid_size: float | None, axis: int, **kwargs
) -> BaseGeometry | GeoArray: ...
...
@overload
def coverage_union(
    a: OptGeoArrayLike, b: OptGeoArrayLike, *, axis: None = None, **kwargs
) -> BaseGeometry: ...
@overload
def coverage_union(
    a: OptGeoArrayLike, b: OptGeoArrayLike, *, axis: int, **kwargs
) -> BaseGeometry | GeoArray: ...
@overload
