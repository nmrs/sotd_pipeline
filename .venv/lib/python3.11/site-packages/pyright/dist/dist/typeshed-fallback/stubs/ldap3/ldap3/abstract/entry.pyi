...
class EntryBase:
    ...
    def entry_to_ldif(
        self, all_base64: bool = False, line_separator=None, sort_order=None, stream=None
    ): ...
...
class WritableEntry(EntryBase):
    ...
    def entry_commit_changes(
        self, refresh: bool = True, controls=None, clear_history: bool = True
    ): ...
