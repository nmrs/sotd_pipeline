...
@overload
def relabel_nodes(
    G: MultiDiGraph[_X], mapping: Mapping[_X, _Y], copy: bool = True
) -> MultiDiGraph[_X | _Y]: ...
@overload
def relabel_nodes(
    G: DiGraph[_X], mapping: Mapping[_X, _Y], copy: bool = True
) -> DiGraph[_X | _Y]: ...
@overload
def relabel_nodes(
    G: MultiGraph[_X], mapping: Mapping[_X, _Y], copy: bool = True
) -> MultiGraph[_X | _Y]: ...
@overload
