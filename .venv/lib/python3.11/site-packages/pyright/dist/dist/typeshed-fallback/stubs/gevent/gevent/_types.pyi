...
class _Loop(Protocol):  # noqa: Y046
    ...
    def io(
        self, fd: FileDescriptor, events: int, ref: bool = True, priority: int | None = None
    ) -> _IoWatcher: ...
    def closing_fd(self, fd: FileDescriptor) -> bool: ...
    def timer(
        self, after: float, repeat: float = 0.0, ref: bool = True, priority: int | None = None
    ) -> _TimerWatcher: ...
    ...
    def stat(
        self, path: str, interval: float = 0.0, ref: bool = True, priority: bool | None = ...
    ) -> _StatWatcher: ...
    def run_callback(self, func: Callable[[Unpack[_Ts]], Any], *args: Unpack[_Ts]) -> _Callback: ...
    def run_callback_threadsafe(
        self, func: Callable[[Unpack[_Ts]], Any], *args: Unpack[_Ts]
    ) -> _Callback: ...
...
class _TimerWatcher(_Watcher, Protocol):
    ...
    @overload
    def start(
        self, callback: Callable[[Unpack[_Ts]], Any], *args: Unpack[_Ts], update: bool
    ) -> None: ...
    @overload
    def start(self, callback: Callable[[Unpack[_Ts]], Any], *args: Unpack[_Ts]) -> None: ...
    @overload
...
class _IoWatcher(_Watcher, Protocol):
    ...
    def start(
        self,
        callback: Callable[[int, Unpack[_Ts]], Any],
        *args: Unpack[_Ts],
        pass_events: Literal[True],
    ) -> None: ...
    @overload
    def start(self, callback: Callable[[Unpack[_Ts]], Any], *args: Unpack[_Ts]) -> None: ...
...
_AddrinfoResult: TypeAlias = list[
    tuple[int, int, int, str, _SockAddr]
]  # family, type, protocol, cname, sockaddr
...
class _Resolver(Protocol):  # noqa: Y046
    ...
    def gethostbyname_ex(
        self, hostname: str, family: int = 2
