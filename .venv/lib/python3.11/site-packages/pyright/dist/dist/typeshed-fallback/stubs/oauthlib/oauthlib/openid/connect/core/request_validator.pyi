...
class RequestValidator(OAuth2RequestValidator):
    def get_authorization_code_scopes(
        self, client_id: str, code: str, redirect_uri: str, request
    ) -> list[str]: ...
    def get_authorization_code_nonce(
        self, client_id: str, code: str, redirect_uri: str, request
    ) -> str: ...
    def get_jwt_bearer_token(
        self, token: dict[str, Incomplete], token_handler, request: Request
    ) -> str: ...
    def get_id_token(
        self, token: dict[str, Incomplete], token_handler, request: Request
    ) -> str: ...
    def finalize_id_token(
        self,
        id_token: dict[str, Incomplete],
        token: dict[str, Incomplete],
        token_handler: Callable[..., str],
        request: Request,
    ) -> str: ...
    ...
    def validate_user_match(
        self, id_token_hint: str, scopes, claims: dict[str, Incomplete], request: Request
    ) -> bool: ...
