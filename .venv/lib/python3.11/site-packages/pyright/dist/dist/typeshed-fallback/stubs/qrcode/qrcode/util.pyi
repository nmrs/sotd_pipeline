...
class QRData:
    ...
    def __init__(
        self,
        data: bytes | str,
        mode: _SupportedMode | None = None,
        check_data: Literal[True] = True,
    ) -> None: ...
    @overload
    def __init__(
        self, data: bytes, mode: _SupportedMode | None = None, *, check_data: Literal[False]
    ) -> None: ...
    @overload
    def __init__(
        self, data: bytes, mode: _SupportedMode | None, check_data: Literal[False]
    ) -> None: ...
...
def create_data(
    version: int, error_correction: ErrorCorrect, data_list: list[QRData]
) -> list[int]: ...
