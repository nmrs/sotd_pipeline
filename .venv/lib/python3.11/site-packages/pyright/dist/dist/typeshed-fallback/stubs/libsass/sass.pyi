...
_CustomFunctions: TypeAlias = (
    Mapping[str, Callable[..., Any]]
    | Sequence[Callable[..., Any]]
    | AbstractSet[Callable[..., Any]]
)
...
_ImportCallback: TypeAlias = (
    Callable[[str], _ImportCallbackRet] | Callable[[str, str], _ImportCallbackRet]
)
...
class SassFunction(Generic[_P, _T]):
    ...
    def __init__(
        self, name: str, arguments: Sequence[str], callable_: Callable[_P, _T]
    ) -> None: ...
    @property
...
class SassColor(_SassColor):
    def __new__(
        cls,
        r: ConvertibleToFloat,
        g: ConvertibleToFloat,
        b: ConvertibleToFloat,
        a: ConvertibleToFloat,
    ) -> Self: ...
...
class SassList(_SassList[_T]):
    def __new__(
        cls, items: Iterable[_T], separator: _Separator, bracketed: bool = ...
    ) -> SassList[_T]: ...
