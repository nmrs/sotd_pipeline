...
class BleachHTMLParser(HTMLParser):
    ...
    consume_entities: bool
    def __init__(
        self, tags: Iterable[str] | None, strip: bool, consume_entities: bool, **kwargs: Any
    ) -> None: ...
...
class BleachHTMLSerializer(HTMLSerializer):
    ...
    def serialize(
        self, treewalker: TreeWalker, encoding: str | None = None
    ) -> Generator[str, None, None]: ...  # type: ignore[override]
