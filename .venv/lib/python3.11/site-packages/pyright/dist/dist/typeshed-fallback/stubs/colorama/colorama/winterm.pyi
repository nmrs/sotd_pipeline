...
if sys.platform == "win32":
    ...
    class WinTerm:
        ...
        def fore(
            self, fore: int | None = None, light: bool = False, on_stderr: bool = False
        ) -> None: ...
        def back(
            self, back: int | None = None, light: bool = False, on_stderr: bool = False
        ) -> None: ...
        ...
        def set_cursor_position(
            self, position: win32.COORD | None = None, on_stderr: bool = False
        ) -> None: ...
