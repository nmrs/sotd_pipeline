...
class Display:
    ...
    def extension_add_method(
        self, object: str, name: str, function: Callable[..., Any]
    ) -> None: ...
    def extension_add_event(self, code: int, evt: type, name: str | None = None) -> None: ...
    def extension_add_subevent(
        self, code: int, subcode: int | None, evt: type[rq.Event], name: str | None = None
    ) -> None: ...
    ...
    def allow_events(
        self, mode: int, time: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    ...
    def set_input_focus(
        self, focus: int, revert_to: int, time: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    ...
    def list_fonts_with_info(
        self, pattern: Pattern[str] | str, max_names: int
    ) -> request.ListFontsWithInfo: ...
    def set_font_path(
        self, path: Sequence[str], onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    ...
    def set_access_control(
        self, mode: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def set_close_down_mode(
        self, mode: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
    def force_screen_saver(
        self, mode: int, onerror: ErrorHandler[object] | None = None
    ) -> None: ...
