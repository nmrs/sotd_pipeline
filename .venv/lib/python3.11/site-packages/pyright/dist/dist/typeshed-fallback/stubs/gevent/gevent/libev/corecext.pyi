...
if sys.platform != "win32":
    ...
    class loop:
        ...
        def __init__(
            self,
            flags: Sequence[str] | str | int | None = None,
        ...
        def signal(
            self, signum: int, ref: bool = True, priority: int | None = None
        ) -> watcher.signal: ...
        ...
        def stat(
            self, path: str, interval: float = 0.0, ref: bool = True, priority: bool | None = None
        ) -> watcher.stat: ...
        ...
        def run_callback(
            self, func: Callable[_P, Any], *args: _P.args, **_: _P.kwargs
        ) -> _Callback: ...
