...
class Sheet(BaseObject):
    ...
    def put_cell_ragged(
        self, rowx: int, colx: int, ctype: int | None, value: str, xf_index: int | None
    ) -> None: ...
    def put_cell_unragged(
        self, rowx: int, colx: int, ctype: int | None, value: str, xf_index: int | None
    ) -> None: ...
    ...
    def fixed_BIFF2_xfindex(
        self, cell_attr: bytes, rowx: int, colx: int, true_xfx: int | None = None
    ) -> int: ...
