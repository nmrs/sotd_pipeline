...
class BaseImportExportMixin(Generic[_ModelT]):
    ...
    def check_resource_classes(
        self, resource_classes: SupportsGetItem[int, type[Resource[_ModelT]]]
    ) -> None: ...
...
class ExportViewMixin(BaseExportMixin[_ModelT]):
    ...
    def get_export_data(
        self, file_format: Format, queryset: QuerySet[_ModelT], **kwargs: Any
    ) -> str | bytes: ...
