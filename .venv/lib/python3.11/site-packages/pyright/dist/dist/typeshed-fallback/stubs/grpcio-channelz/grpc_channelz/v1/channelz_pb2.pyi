...
class Address(message.Message, metaclass=MessageMeta):
    ...
    class OtherAddress(message.Message, metaclass=MessageMeta):
        ...
        def __init__(
            self,
            name: str | None = ...,
            value: any_pb2.Any | Mapping[Incomplete, Incomplete] | None = ...,
        ) -> None: ...
...
class SocketOptionTimeout(message.Message, metaclass=MessageMeta):
    ...
    def __init__(
        self, duration: duration_pb2.Duration | Mapping[Incomplete, Incomplete] | None = ...
    ) -> None: ...
    DESCRIPTOR: Descriptor
...
class SocketOptionLinger(message.Message, metaclass=MessageMeta):
    ...
    def __init__(
        self,
        active: bool = ...,
        duration: duration_pb2.Duration | Mapping[Incomplete, Incomplete] | None = ...,
    ) -> None: ...
    DESCRIPTOR: Descriptor
...
class GetTopChannelsRequest(message.Message, metaclass=MessageMeta):
    ...
    max_results: int
    def __init__(
        self, start_channel_id: int | None = ..., max_results: int | None = ...
    ) -> None: ...
    DESCRIPTOR: Descriptor
...
class GetTopChannelsResponse(message.Message, metaclass=MessageMeta):
    ...
    def __init__(
        self,
        channel: Iterable[Channel | Mapping[Incomplete, Incomplete]] | None = ...,
        end: bool = ...,
    ) -> None: ...
    DESCRIPTOR: Descriptor
...
class GetServersRequest(message.Message, metaclass=MessageMeta):
    ...
    max_results: int
    def __init__(
        self, start_server_id: int | None = ..., max_results: int | None = ...
    ) -> None: ...
    DESCRIPTOR: Descriptor
...
class GetServersResponse(message.Message, metaclass=MessageMeta):
    ...
    def __init__(
        self,
        server: Iterable[Server | Mapping[Incomplete, Incomplete]] | None = ...,
        end: bool = ...,
    ) -> None: ...
    DESCRIPTOR: Descriptor
...
class GetSubchannelResponse(message.Message, metaclass=MessageMeta):
    ...
    def __init__(
        self, subchannel: Subchannel | Mapping[Incomplete, Incomplete] | None = ...
    ) -> None: ...
    DESCRIPTOR: Descriptor
