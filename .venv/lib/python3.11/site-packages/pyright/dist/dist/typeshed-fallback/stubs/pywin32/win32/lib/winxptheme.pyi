...
def DrawThemeBackground(
    hTheme: _win32typing.PyHTHEME, hdc, iPartId, iStateId, pRect, pClipRect, /
) -> None: ...
def DrawThemeText(
    hTheme: _win32typing.PyHTHEME,
    hdc,
    iPartId,
    iStateId,
    pszText: str,
...
def GetThemeBackgroundContentRect(
    hTheme: _win32typing.PyHTHEME, hdc, iPartId, iStateId, pBoundingRect, /
): ...
def GetThemeBackgroundExtent(
    hTheme: _win32typing.PyHTHEME, hdc, iPartId, iStateId, pContentRect, /
): ...
