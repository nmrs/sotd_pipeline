...
class MultiPanel(google.protobuf.message.Message):
    ...
    def units(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___UnitInfo]: ...
    def __init__(
        self, *, units: collections.abc.Iterable[global___UnitInfo] | None = ...
    ) -> None: ...
...
class CargoPanel(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["slots_available", b"slots_available", "unit", b"unit"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "passengers", b"passengers", "slots_available", b"slots_available", "unit", b"unit"
        ],
    ) -> None: ...
...
class BuildItem(google.protobuf.message.Message):
    ...
    """Range: [0.0, 1.0]"""
    def __init__(
        self, *, ability_id: builtins.int | None = ..., build_progress: builtins.float | None = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            "ability_id", b"ability_id", "build_progress", b"build_progress"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ProductionPanel(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "build_queue", b"build_queue", "production_queue", b"production_queue", "unit", b"unit"
        ],
    ) -> None: ...
...
class ActionControlGroup(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "action", b"action", "control_group_index", b"control_group_index"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ActionSelectArmy(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["selection_add", b"selection_add"]
    ) -> builtins.bool: ...
...
class ActionSelectIdleWorker(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            ActionSelectIdleWorker._Type.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def __init__(
        self, *, type: global___ActionSelectIdleWorker.Type.ValueType | None = ...
    ) -> None: ...
...
class ActionMultiPanel(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            ActionMultiPanel._Type.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def HasField(
        self, field_name: typing.Literal["type", b"type", "unit_index", b"unit_index"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["type", b"type", "unit_index", b"unit_index"]
    ) -> None: ...
...
class ActionCargoPanelUnload(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["unit_index", b"unit_index"]
    ) -> builtins.bool: ...
