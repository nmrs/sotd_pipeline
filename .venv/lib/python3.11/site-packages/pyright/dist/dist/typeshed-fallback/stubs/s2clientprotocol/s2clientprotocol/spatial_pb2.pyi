...
class ObservationFeatureLayer(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal["minimap_renders", b"minimap_renders", "renders", b"renders"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal["minimap_renders", b"minimap_renders", "renders", b"renders"],
...
class ObservationRender(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["map", b"map", "minimap", b"minimap"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["map", b"map", "minimap", b"minimap"]
    ) -> None: ...
...
class ActionSpatial(google.protobuf.message.Message):
    ...
    def WhichOneof(
        ...
        typing.Literal["unit_command", "camera_move", "unit_selection_point", "unit_selection_rect"]
        | None
    ): ...
...
class ActionSpatialCameraMove(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, center_minimap: s2clientprotocol.common_pb2.PointI | None = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["center_minimap", b"center_minimap"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["center_minimap", b"center_minimap"]
    ) -> None: ...
...
class ActionSpatialUnitSelectionPoint(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            ActionSpatialUnitSelectionPoint._Type.ValueType
        ],
        builtins.type,
    ):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "selection_screen_coord", b"selection_screen_coord", "type", b"type"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ActionSpatialUnitSelectionRect(google.protobuf.message.Message):
    ...
    def selection_screen_coord(
        ...
        s2clientprotocol.common_pb2.RectangleI
    ]:
    ...
    def __init__(
        self,
        *,
        selection_screen_coord: collections.abc.Iterable[s2clientprotocol.common_pb2.RectangleI]
        | None = ...,
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "selection_add", b"selection_add", "selection_screen_coord", b"selection_screen_coord"
        ],
    ) -> None: ...
