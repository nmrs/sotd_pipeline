...
def insecure_channel(
    target: str, options: _Options | None = None, compression: Compression | None = None
) -> Channel: ...
def secure_channel(
    target: str,
...
def intercept_channel(
    channel: Channel, *interceptors: _Interceptor[_TRequest, _TResponse]
) -> Channel: ...
...
class Channel(abc.ABC):
    ...
    @abc.abstractmethod
    def subscribe(
        self, callback: Callable[[ChannelConnectivity], None], try_to_connect: bool = False
    ) -> None: ...
    @abc.abstractmethod
    def unary_stream(
        self,
...
class ServerInterceptor(abc.ABC, Generic[_TRequest, _TResponse]):
    ...
    def intercept_service(
        ...
        continuation: Callable[
            [HandlerCallDetails], RpcMethodHandler[_TRequest, _TResponse] | None
        ],
