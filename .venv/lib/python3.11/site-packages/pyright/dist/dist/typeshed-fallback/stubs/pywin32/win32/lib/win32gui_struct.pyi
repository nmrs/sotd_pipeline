...
def EmptyMENUITEMINFO(
    mask: Incomplete | None = ..., text_buf_size: int = ...
) -> tuple[array[int], list[array[int]]]: ...
def PackMENUINFO(
...
def EmptyTVITEM(
    hitem, mask: Incomplete | None = ..., text_buf_size: int = ...
) -> tuple[array[int], list[Incomplete]]: ...
...
def UnpackLVHITTEST(
    buf: ReadableBuffer,
) -> tuple[tuple[Incomplete, Incomplete], Incomplete, Incomplete, Incomplete]: ...
def PackHDITEM(
    cxy: Incomplete | None = ...,
    text: Incomplete | None = ...,
    hbm: Incomplete | None = ...,
...
def PackDEV_BROADCAST_HANDLE(
    handle, hdevnotify: int = ..., guid=..., name_offset: int = ..., data=...
) -> bytes: ...
