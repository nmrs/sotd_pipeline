...
) -> contextlib._GeneratorContextManager[tuple[TextIO, TextIO]]: ...
...
def pipes(
    ...
    tuple[
        io.BytesIO | io.StringIO | _StreamOutT | _LogPipe,
        io.BytesIO | io.StringIO | _StreamErrT | _LogPipe | None,
    ]
]: ...
