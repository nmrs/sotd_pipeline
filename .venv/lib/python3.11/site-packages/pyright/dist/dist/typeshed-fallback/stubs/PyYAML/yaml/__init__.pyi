...
def add_constructor(
    tag: str,
    constructor: Callable[[Loader | FullLoader | UnsafeLoader, Node], Any],
    Loader: None = None,
) -> None: ...
@overload
def add_constructor(
    tag: str, constructor: Callable[[_Constructor, Node], Any], Loader: type[_Constructor]
) -> None: ...
@overload
def add_multi_constructor(
    tag_prefix: str,
    multi_constructor: Callable[[Loader | FullLoader | UnsafeLoader, str, Node], Any],
    Loader: None = None,
) -> None: ...
@overload
def add_multi_constructor(
    tag_prefix: str,
    multi_constructor: Callable[[_Constructor, str, Node], Any],
    Loader: type[_Constructor],
) -> None: ...
@overload
...
def add_multi_representer(
    data_type: type[_T],
    multi_representer: Callable[[_Representer, _T], Node],
    Dumper: type[_Representer],
) -> None: ...
