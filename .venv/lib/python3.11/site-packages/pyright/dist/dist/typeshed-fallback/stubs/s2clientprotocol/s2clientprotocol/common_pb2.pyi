...
class _RaceEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Race.ValueType], builtins.type
):
...
class AvailableAbility(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, ability_id: builtins.int | None = ..., requires_point: builtins.bool | None = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            "ability_id", b"ability_id", "requires_point", b"requires_point"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ImageData(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "bits_per_pixel", b"bits_per_pixel", "data", b"data", "size", b"size"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class RectangleI(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, p0: global___PointI | None = ..., p1: global___PointI | None = ...
    ) -> None: ...
...
class Point2D(google.protobuf.message.Message):
    ...
    y: builtins.float
    def __init__(
        self, *, x: builtins.float | None = ..., y: builtins.float | None = ...
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["x", b"x", "y", b"y"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["x", b"x", "y", b"y"]) -> None: ...
...
class Point(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["x", b"x", "y", b"y", "z", b"z"]
    ) -> builtins.bool: ...
