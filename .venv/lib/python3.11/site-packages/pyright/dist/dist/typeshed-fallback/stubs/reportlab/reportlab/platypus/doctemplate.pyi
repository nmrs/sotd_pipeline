...
class onDrawStr(str):
    ...
    def __getnewargs__(
        self,
    ) -> tuple[str, Callable[[Canvas, str | None, str], object], str, str | None]: ...  # type: ignore[override]
...
class BaseDocTemplate:
    ...
    def addPageTemplates(
        self, pageTemplates: list[PageTemplate] | tuple[PageTemplate, ...] | PageTemplate
    ) -> None: ...
