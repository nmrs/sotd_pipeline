...
def encode_params_utf8(
    params: Iterable[tuple[str | bytes, str | bytes]],
) -> list[tuple[bytes, bytes]]: ...
def decode_params_utf8(
    params: Iterable[tuple[str | bytes, str | bytes]],
) -> list[tuple[str, str]]: ...
...
def extract_params(
    raw: str | bytes | dict[str, str] | Iterable[tuple[str, str]],
...
def add_params_to_uri(
    uri: str, params: dict[str, str] | Iterable[tuple[str, str]], fragment: bool = False
) -> str: ...
...
@overload
def to_unicode(
    data: Mapping[str, _V] | Mapping[bytes, _V], encoding: str = "UTF-8"
) -> dict[str, _V]: ...
@overload
...
class Request:
    ...
    def __getattr__(
        self, name: str
    ) -> str | None: ...  # or raises AttributeError if attribute is not found
    @property
