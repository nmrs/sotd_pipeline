...
_DataLabelBaseDLblPos: TypeAlias = Literal[
...
class _DataLabelBase(Serialisable):
    ...
    def __init__(
        ...
        showLeaderLines: _HasTagAndGet[_ConvertibleToBool | None]
        | _ConvertibleToBool
        | None = None,
...
class DataLabel(_DataLabelBase):
    ...
    __elements__: ClassVar[tuple[str, ...]]
    def __init__(
        self, idx: _HasTagAndGet[ConvertibleToInt] | ConvertibleToInt = 0, **kw
    ) -> None: ...
