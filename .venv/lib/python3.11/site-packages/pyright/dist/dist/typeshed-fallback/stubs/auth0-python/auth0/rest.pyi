...
class RestClientOptions:
    ...
    retries: int
    def __init__(
        self, telemetry: bool = True, timeout: TimeoutType = 5.0, retries: int = 3
    ) -> None: ...
...
class RestClient:
    ...
    def post(
        self, url: str, data: RequestData | None = None, headers: dict[str, str] | None = None
    ): ...
    def file_post(
        self, url: str, data: RequestData | None = None, files: dict[str, Incomplete] | None = None
    ): ...
