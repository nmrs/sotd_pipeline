...
from .xldate import (
    XLDateError as XLDateError,
    xldate_as_datetime as xldate_as_datetime,
    xldate_as_tuple as xldate_as_tuple,
)
...
def dump(
    filename: str, outfile: SupportsWrite[str] = sys.stdout, unnumbered: bool = False
) -> None: ...
