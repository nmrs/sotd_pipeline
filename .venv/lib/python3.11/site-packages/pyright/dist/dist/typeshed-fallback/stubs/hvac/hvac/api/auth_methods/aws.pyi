...
class Aws(VaultApiBase):
    ...
    def create_certificate_configuration(
        self, cert_name, aws_public_cert, document_type=None, mount_point: str = "aws"
    ): ...
    ...
    def configure_identity_whitelist_tidy(
        self, safety_buffer=None, disable_periodic_tidy=None, mount_point: str = "aws"
    ): ...
    ...
    def ec2_login(
        self, pkcs7, nonce=None, role=None, use_token: bool = True, mount_point: str = "aws"
    ): ...
    ...
    def tidy_identity_whitelist_entries(
        self, safety_buffer: str = "72h", mount_point: str = "aws"
    ): ...
