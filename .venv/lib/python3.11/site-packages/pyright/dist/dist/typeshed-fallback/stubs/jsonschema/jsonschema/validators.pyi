...
_ValidatorCallback: TypeAlias = Callable[
    [Any, Any, _JsonValue, _JsonObject], Iterator[ValidationError]
]
...
class _Validator:
    ...
    def iter_errors(
        self, instance, _schema: Schema | None = ...
...
def validate(
    instance: object, schema: Schema, cls: type[_Validator] | None = None, *args: Any, **kwargs: Any
) -> None: ...
