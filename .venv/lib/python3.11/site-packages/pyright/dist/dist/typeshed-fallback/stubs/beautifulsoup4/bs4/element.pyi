...
class NamespacedAttribute(str):
    def __new__(
        cls, prefix: str, name: str | None = None, namespace: str | None = None
    ) -> Self: ...
...
_NormalizedStrainable: TypeAlias = (
    _SimpleNormalizedStrainable | Iterable[_SimpleNormalizedStrainable]
)
...
class Tag(PageElement):
    ...
    def __init__(
        ...
        interesting_string_types: type[NavigableString]
        | tuple[type[NavigableString], ...]
        | None = None,
