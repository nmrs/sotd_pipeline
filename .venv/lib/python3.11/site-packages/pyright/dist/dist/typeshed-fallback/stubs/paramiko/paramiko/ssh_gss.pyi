...
class _SSH_GSSAPI_OLD(_SSH_GSSAuth):
    ...
    def ssh_init_sec_context(
        self,
        target: str,
        desired_mech: str | None = None,
        username: str | None = None,
        recv_token: str | None = None,
    ) -> str | None: ...
    def ssh_get_mic(self, session_id: bytes, gss_kex: bool = False) -> Any: ...
    def ssh_accept_sec_context(
        self, hostname: str, recv_token: str, username: str | None = None
    ) -> str | None: ...
    def ssh_check_mic(
        self, mic_token: str, session_id: bytes, username: str | None = None
    ) -> None: ...
    @property
...
class _SSH_SSPI(_SSH_GSSAuth):
    ...
    def ssh_get_mic(self, session_id: bytes, gss_kex: bool = False) -> Any: ...
    def ssh_accept_sec_context(
        self, hostname: str, username: str, recv_token: str
    ) -> str | None: ...
    def ssh_check_mic(
        self, mic_token: str, session_id: bytes, username: str | None = None
    ) -> None: ...
