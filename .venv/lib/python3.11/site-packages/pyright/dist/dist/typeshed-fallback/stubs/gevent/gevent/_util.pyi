...
def update_wrapper(
    wrapper: _T, wrapped: object, assigned: Sequence[str] = ..., updated: Sequence[str] = ...
) -> _T: ...
def copy_globals(
    source: ModuleType,
...
class readproperty(Generic[_T]):
    ...
    def __init__(
        self: readproperty[_T],
        func: Callable[[Any], _T],  # pyright: ignore[reportInvalidTypeVarUse]  #11780
    ) -> None: ...
    @overload
    def __get__(self, inst: None, class_: type[object]) -> Self: ...
    @overload
