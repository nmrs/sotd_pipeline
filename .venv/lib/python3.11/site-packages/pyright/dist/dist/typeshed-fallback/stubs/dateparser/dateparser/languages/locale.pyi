...
class Locale:
    ...
    def is_applicable(
        self, date_string: str, strip_timezone: bool = False, settings: Settings | None = None
    ) -> bool: ...
    def count_applicability(
        self, text: str, strip_timezone: bool = False, settings: Settings | None = None
    ): ...
    @staticmethod
    def clean_dictionary(dictionary, threshold: int = 2): ...
    def translate(
        self, date_string: str, keep_formatting: bool = False, settings: Settings | None = None
    ) -> str: ...
