...
which reflects the win32 API and the new functions in this module."""
    ...
    def AddAccessAllowedAceEx(
        self, revision: int, aceflags: int, access: int, sid: PySID, /
    ) -> None: ...
...
which reflects the win32 API and the new functions in this module."""
    ...
    def AddAccessDeniedAceEx(
        self, revision: int, aceflags: int, access: int, sid: PySID, /
    ) -> None: ...
    def AddMandatoryAce(
        self, AceRevision, AceFlags, MandatoryPolicy, LabelSid: PySID, /
    ) -> None: ...
    def AddAuditAccessAce(
        self, dwAceRevision, dwAccessMask, sid: PySID, bAuditSuccess, bAuditFailure, /
    ) -> None: ...
    def AddAuditAccessAceEx(
        self, dwAceRevision, AceFlags, dwAccessMask, sid: PySID, bAuditSuccess, bAuditFailure, /
    ) -> None: ...
    ...
    def GetAuditedPermissionsFromAcl(
        self, trustee: PyTRUSTEE, /
    ) -> tuple[Incomplete, Incomplete]: ...
    def SetEntriesInAcl(
        self, obexpl_list: tuple[dict[str, int | dict[str, int | PySID]], ...], /
    ) -> PyACL: ...
    def GetExplicitEntriesFromAcl(
        self,
    ) -> tuple[dict[str, int | dict[str, int | PySID]]] | None: ...
...
param will be dropped at some point in the future."""
    ...
    def CertSaveStore(
        self, MsgAndCertEncodingType, SaveAs, SaveTo, SaveToPara: str | int, Flags=...
    ) -> None: ...
    def CertAddEncodedCertificateToStore(
        self, CertEncodingType, CertEncoded, AddDisposition
    ) -> PyCERT_CONTEXT: ...
    def CertAddCertificateContextToStore(
        self, CertContext: PyCERT_CONTEXT, AddDisposition
    ) -> PyCERT_CONTEXT: ...
    def CertAddCertificateLinkToStore(
        self, CertContext: PyCERT_CONTEXT, AddDisposition
    ) -> PyCERT_CONTEXT: ...
    def CertAddCTLContextToStore(
        self, CtlContext: PyCTL_CONTEXT, AddDisposition
    ) -> PyCTL_CONTEXT: ...
    def CertAddCTLLinkToStore(self, CtlContext: PyCTL_CONTEXT, AddDisposition) -> PyCTL_CONTEXT: ...
    def CertAddStoreToCollection(
        self, SiblingStore: PyCERTSTORE, UpdateFlag: int = ..., Priority: int = ...
    ) -> None: ...
...
class PyCRYPTHASH:
    ...
    def CryptVerifySignature(
        self, Signature: str, PubKey: PyCRYPTKEY, Flags: int = ...
    ) -> None: ...
...
class PyCRYPTPROV:
    ...
    def CryptCreateHash(
        self, Algid, Key: PyCRYPTKEY | None = ..., Flags: int = ...
    ) -> PyCRYPTHASH: ...
    def CryptImportKey(
        self, Data, PubKey: PyCRYPTKEY | None = ..., Flags: int = ...
    ) -> PyCRYPTKEY: ...
...
class PySECURITY_DESCRIPTOR:
    ...
    def SetSecurityDescriptorDacl(
        self, bSaclPresent: int | bool, SACL: PyACL, bSaclDefaulted: int | bool, /
    ) -> None: ...
...
class PyGFileOperationProgressSink:
    ...
    def PostRenameItem(
        self, Flags, Item: PyIShellItem, NewName, hrRename, NewlyCreated: PyIShellItem, /
    ) -> None: ...
    def PreMoveItem(
        self, Flags, Item: PyIShellItem, DestinationFolder: PyIShellItem, NewName, /
    ) -> None: ...
    def PostMoveItem(
        self,
        Flags,
    ...
    def PostDeleteItem(
        self, Flags, Item: PyIShellItem, hrDelete, NewlyCreated: PyIShellItem, /
    ) -> None: ...
...
class PyGSecurityInformation:
    ...
    def SetSecurity(
        self, SecurityInformation, SecurityDescriptor: PySECURITY_DESCRIPTOR, /
    ) -> None: ...
...
class PyIActiveScriptDebug:
    def GetScriptTextAttributes(
        self, pstrCode: str, pstrDelimiter: str, dwFlags, /
    ) -> tuple[Incomplete, ...]: ...
    def GetScriptletTextAttributes(self, pstrCode: str, pstrDelimiter: str, dwFlags, /) -> None: ...
    def EnumCodeContextsOfPosition(
        self, dwSourceContext, uCharacterOffset, uNumChars, /
    ) -> None: ...
...
class PyIActiveScriptSiteDebug:
    def GetDocumentContextFromPosition(
        self, dwSourceContext, uCharacterOffset, uNumChars, /
    ) -> None: ...
...
class PyIApplicationDebugger:
    ...
    def CreateInstanceAtDebugger(
        self, rclsid: PyIID, pUnkOuter: PyIUnknown, dwClsContext, riid: PyIID, /
    ) -> None: ...
...
class PyICatInformation:
    ...
    def EnumClassesOfCategories(
        self,
        listIIdImplemented: list[PyIID] | None = ...,
        listIIdRequired: Incomplete | None = ...,
        /,
    ) -> PyIEnumGUID: ...
...
class PyICopyHookA:
    def CopyCallback(
        self, hwnd: int, wFunc, wFlags, srcFile: str, srcAttribs, destFile: str, destAttribs, /
    ) -> None: ...
...
class PyIDebugApplication:
    ...
    def HandleRuntimeError(
        self, pErrorDebug: PyIActiveScriptErrorDebug, pScriptSite: PyIActiveScriptSite, /
    ) -> None: ...
    def FCanJitDebug(self) -> None: ...
    def FIsAutoJitDebugEnabled(self) -> None: ...
    def AddGlobalExpressionContextProvider(
        self, pdsfs: PyIProvideExpressionContexts, /
    ) -> None: ...
...
class PyIDirectSound:
    ...
    def CreateSoundBuffer(
        self, lpDSCBufferDesc: PyDSCBUFFERDESC, unk: Incomplete | None = ..., /
    ) -> None: ...
...
class PyIDocHostUIHandler:
    ...
    def ResizeBorder(
        self,
        prcBorder: tuple[Incomplete, Incomplete, Incomplete, Incomplete],
...
class PyIDropTarget:
    def DragEnter(
        self, pDataObj: PyIDataObject, grfKeyState, pt: tuple[Incomplete, Incomplete], pdwEffect, /
    ): ...
    def DragOver(self, grfKeyState, pt: tuple[Incomplete, Incomplete], pdwEffect, /): ...
    def DragLeave(self) -> None: ...
    def Drop(
        self, pDataObj: PyIDataObject, grfKeyState, pt: tuple[Incomplete, Incomplete], dwEffect, /
    ): ...

class PyIDropTargetHelper:
    def DragEnter(
        self, hwnd: int, pDataObj: PyIDataObject, pt: tuple[Incomplete, Incomplete], dwEffect, /
    ) -> None: ...
    def DragOver(self, hwnd: int, pt: tuple[Incomplete, Incomplete], pdwEffect, /) -> None: ...
    def DragLeave(self) -> None: ...
    def Drop(
        self, pDataObj: PyIDataObject, pt: tuple[Incomplete, Incomplete], dwEffect, /
    ) -> None: ...
...
class PyIExtractImage:
    def GetLocation(
        self, dwPriority, size: tuple[Incomplete, Incomplete], dwRecClrDepth, pdwFlags, /
    ) -> None: ...
...
class PyIFileOperation:
    ...
    def RenameItem(
        self, Item: PyIShellItem, NewName, Sink: PyGFileOperationProgressSink | None = ..., /
    ) -> None: ...
    ...
    def DeleteItem(
        self, Item: PyIShellItem, Sink: PyGFileOperationProgressSink | None = ..., /
    ) -> None: ...
...
class PyIInternetProtocol:
    ...
    @overload
    @deprecated(
        "Support for passing two ints to create a 64-bit value is deprecated; pass a single int instead"
    )
...
class PyIInternetProtocolInfo:
    ...
    def CombineUrl(
        self, pwzBaseUrl, pwzRelativeUrl, dwCombineFlags, cchResult, dwReserved, /
    ) -> None: ...
...
class PyIKnownFolderManager:
    ...
    def Redirect(
        self, _id: PyIID, hwnd: int, flags, TargetPath, Exclusion: tuple[PyIID, ...], /
    ) -> None: ...
...
class PyILockBytes:
    ...
    def LockRegion(
        self, libOffset: tuple[int, int], cb: tuple[int, int], dwLockType, /
    ) -> None: ...
    @overload
...
class PyIMAPIFolder:
    ...
    def CopyMessages(
        self, msgs: PySBinaryArray, iid: PyIID, folder: PyIMAPIFolder, ulUIParam, progress, flags, /
    ): ...
...
class PyIMAPIProp:
    def GetProps(
        self, proplist: PySPropTagArray, flags: int = ..., /
    ...
    def GetIDsFromNames(
        self, nameIds: PyMAPINAMEIDArray, flags: int = ..., /
    ) -> PySPropTagArray: ...
    def GetNamesFromIDs(
...
class PyIMoniker:
    def BindToObject(
        self, bindCtx: PyIBindCtx, moniker: PyIMoniker, iidResult, /
    ) -> PyIUnknown: ...
    def BindToStorage(
        self, bindCtx: PyIBindCtx, moniker: PyIMoniker, iidResult, /
    ) -> PyIUnknown: ...
...
class PyIMsgServiceAdmin:
    def GetLastError(self, hr, flags, /): ...
    def CreateMsgService(
        self, serviceName: str, displayName: str, flags, uiParam: int = ..., /
    ) -> None: ...
    def ConfigureMsgService(
        self, iid: PyIID, ulUIParam, ulFlags, arg: list[Incomplete], /
    ) -> None: ...
...
class PyIMsgStore:
    ...
    def GetReceiveFolder(
        self, messageClass: str | None = ..., flags: int = ..., /
    ) -> tuple[PyIID, str]: ...
...
class PyINameSpaceTreeControl:
    def Initialize(
        self, hwndParent, prc: tuple[Incomplete, Incomplete, Incomplete, Incomplete], nsctsFlags, /
    ) -> None: ...
    ...
    def InsertRoot(
        self, iIndex, psiRoot: PyIShellItem, grfEnumFlags, grfRootStyle, pif, /
    ) -> None: ...
...
class PyIOleControlSite:
    ...
    def TransformCoords(
        self,
        PtlHimetric: tuple[Incomplete, Incomplete],
...
class PyIOleInPlaceActiveObject:
    ...
    def ResizeBorder(
        self,
        rcBorder: tuple[Incomplete, Incomplete, Incomplete, Incomplete],
        pUIWindow: PyIOleInPlaceUIWindow,
        fFrameWindow,
        /,
    ) -> None: ...
...
class PyIOleInPlaceSiteWindowless:
    ...
    def GetDC(
        self, grfFlags, rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete], /
    ) -> None: ...
    def ReleaseDC(self, hDC: PyCDC, /) -> None: ...
    def InvalidateRect(
        self, rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete], fErase, /
    ) -> None: ...
...
class PyIOleInPlaceUIWindow:
    ...
    def RequestBorderSpace(
        self, borderwidths: tuple[Incomplete, Incomplete, Incomplete, Incomplete], /
    ) -> None: ...
    def SetBorderSpace(
        self, borderwidths: tuple[Incomplete, Incomplete, Incomplete, Incomplete], /
    ) -> None: ...
...
class PyIProfAdmin:
    def GetLastError(self, hr, flags, /): ...
    def CreateProfile(
        self, oldProfileName: str, Password: str, uiParam: int = ..., flags: int = ..., /
    ) -> None: ...
    ...
    def AdminServices(
        self, profileName: str, Password: str | None = ..., uiParam: int = ..., flags=..., /
    ) -> PyIProfAdmin: ...
...
class PyIPropertyDescription:
    ...
    def GetRelativeDescription(
        self, var1: PyPROPVARIANT, var2: PyPROPVARIANT, /
    ) -> tuple[Incomplete, Incomplete]: ...
...
class PyIPropertySystem:
    def GetPropertyDescription(
        self, Key: PyPROPERTYKEY, riid: PyIID, /
    ) -> PyIPropertyDescription: ...
    def GetPropertyDescriptionByName(
        self, CanonicalName, riid: PyIID, /
    ) -> PyIPropertyDescription: ...
    def GetPropertyDescriptionlistFromString(
        self, Proplist, riid: PyIID, /
    ) -> PyIPropertyDescriptionlist: ...
    def EnumeratePropertyDescriptions(
        self, Filter, riid: PyIID, /
    ) -> PyIPropertyDescriptionlist: ...
...
class PyIQueryAssociations:
    def Init(
        self, flags, assoc: str, hkeyProgId: PyHKEY | None = ..., hwnd: int | None = ..., /
    ) -> None: ...
...
class PyIRemoteDebugApplication:
    def ResumeFromBreakPoint(
        self, prptFocus: PyIRemoteDebugApplicationThread, bra, era, /
    ) -> None: ...
...
class PyIRemoteDebugApplicationEvents:
    ...
    def OnBreakFlagChange(
        self, abf, prdatSteppingThread: PyIRemoteDebugApplicationThread, /
    ) -> None: ...
...
class PyIRemoteDebugApplicationThread:
    ...
    def SetNextStatement(
        self, pStackFrame: PyIDebugStackFrame, pCodeContext: PyIDebugCodeContext, /
    ) -> None: ...
...
class PyIScheduledWorkItem:
    ...
    def GetRunTimes(
        self, Count, Begin: TimeType, End: TimeType, /
    ) -> tuple[TimeType, Incomplete, Incomplete, Incomplete]: ...
...
class PyIShellBrowser:
    def InsertMenusSB(
        self, hmenuShared: int, lpMenuWidths: PyOLEMENUGROUPWIDTHS, /
...
class PyIShellFolder:
    def ParseDisplayName(
        self, hwndOwner: int, pbc: PyIBindCtx, DisplayName, Attributes: int = ..., /
    ): ...
...
class PyIShellItem2:
    ...
    def GetPropertyStoreForKeys(
        self, Keys: tuple[Incomplete, ...], Flags, riid: PyIID, /
    ) -> PyIPropertyStore: ...
    def GetPropertyStoreWithCreateObject(
        self, Flags, CreateObject: PyIUnknown, riid: PyIID, /
    ) -> PyIPropertyStore: ...
    def GetPropertyDescriptionlist(
        self, Type: PyPROPERTYKEY, riid: PyIID, /
    ) -> PyIPropertyDescriptionlist: ...
...
class PyIShellItemResources:
    ...
    def SetTimes(
        self, pftCreation: TimeType, pftWrite: TimeType, pftAccess: TimeType, /
    ) -> None: ...
...
class PyIShellLibrary:
    ...
    def ResolveFolder(
        self, FolderToResolve: PyIShellItem, Timeout, riid: PyIID, /
    ) -> PyIShellItem: ...
...
class PyIStorage:
    def CreateStream(
        self, Name, Mode, reserved1: int = ..., reserved2: int = ..., /
    ) -> PyIStream: ...
    ...
    def OpenStorage(
        self, Name, Priority: PyIStorage, Mode, snbExclude, reserved=..., /
    ) -> PyIStorage: ...
    def CopyTo(
        self, rgiidExclude: tuple[Incomplete, Incomplete], snbExclude, stgDest: PyIStorage, /
    ) -> None: ...
    ...
    def SetElementTimes(
        self, name, ctime: TimeType, atime: TimeType, mtime: TimeType, /
    ) -> None: ...
    def SetClass(self, clsid: PyIID, /) -> None: ...
...
class PyITransferAdviseSink:
    def UpdateProgress(
        self, SizeCurrent, SizeTotal, FilesCurrent, FilesTotal, FoldersCurrent, FoldersTotal, /
    ) -> None: ...
    ...
    def FileFailure(
        self, Item: PyIShellItem, ItemName, Error, /
    ) -> tuple[Incomplete, Incomplete]: ...
...
class PyITransferSource:
    ...
    def SetProperties(self, proparray: PyIPropertyChangeArray, /) -> None: ...
    def OpenItem(
        self, Item: PyIShellItem, flags, riid: PyIID, /
    ) -> tuple[Incomplete, PyIShellItemResources]: ...
    def MoveItem(
        self, Item: PyIShellItem, ParentDst: PyIShellItem, NameDst, flags, /
    ) -> tuple[Incomplete, PyIShellItem]: ...
    def RecycleItem(
        self, Source: PyIShellItem, ParentDest: PyIShellItem, flags, /
    ) -> tuple[Incomplete, PyIShellItem]: ...
    def RemoveItem(self, Source: PyIShellItem, flags, /): ...
    def RenameItem(
        self, Source: PyIShellItem, NewName, flags, /
    ) -> tuple[Incomplete, PyIShellItem]: ...
    def LinkItem(
        self, Source: PyIShellItem, ParentDest: PyIShellItem, NewName, flags, /
    ) -> tuple[Incomplete, PyIShellItem]: ...
...
STATSTG: TypeAlias = tuple[
    str | None, int, int, TimeType, TimeType, TimeType, int, int, PyIID, int, int
]
...
class PyCDC:
    ...
    def DPtoLP(
        self, point: tuple[Incomplete, Incomplete], x, y, /
    ) -> tuple[Incomplete, Incomplete]: ...
    def Draw3dRect(
        self,
        rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete],
    ...
    def DrawFrameControl(
        self, rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete], typ, state, /
    ) -> None: ...
    ...
    def FillRect(
        self, rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete], brush: PyCBrush, /
    ) -> None: ...
    def FillSolidRect(
        self, rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete], color, /
    ) -> None: ...
    def FrameRect(
        self, rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete], brush: PyCBrush, /
    ) -> None: ...
    ...
    def OffsetWindowOrg(
        self, arg: tuple[Incomplete, Incomplete], /
    ) -> tuple[Incomplete, Incomplete]: ...
    def OffsetViewportOrg(
        self, arg: tuple[Incomplete, Incomplete], /
    ) -> tuple[Incomplete, Incomplete]: ...
    def PatBlt(
        self, destPos: tuple[Incomplete, Incomplete], size: tuple[Incomplete, Incomplete], rop, /
    ) -> None: ...
    ...
    def SetBrushOrg(
        self, point: tuple[Incomplete, Incomplete], /
    ) -> tuple[Incomplete, Incomplete]: ...
    ...
    def SetWindowExt(
        self, size: tuple[Incomplete, Incomplete], /
    ) -> tuple[Incomplete, Incomplete]: ...
    def SetWindowOrg(
        self, arg: tuple[Incomplete, Incomplete], /
    ) -> tuple[Incomplete, Incomplete]: ...
...
class PyCDocTemplate:
    ...
    def InitialUpdateFrame(
        self,
        frame: PyCFrameWnd | None = ...,
        doc: PyCDocument | None = ...,
        bMakeVisible: int = ...,
        /,
    ) -> None: ...
...
class PyCFrameWnd:
    ...
    def EnableDocking(self, style, /) -> None: ...
    def FloatControlBar(
        self, controlBar: PyCControlBar, arg: tuple[Incomplete, Incomplete], style, /
    ) -> None: ...
...
class PyClistCtrl:
    ...
    def CreateWindow(
        self, style, rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete], PyCWnd, _id, /
    ) -> None: ...
...
class PyCMenu:
    ...
    def InsertMenu(
        self, pos, flags, _id: PyCMenu | int = ..., value: str | None = ..., /
    ) -> None: ...
    def ModifyMenu(self, pos, flags, _id: int = ..., value: str | None = ..., /) -> None: ...
    def TrackPopupMenu(
        self, x_y: _TwoIntSequence, flags: int = ..., owner: PyCWnd = ..., /
    ) -> None: ...
...
class PyCSplitterWnd:  # aka PyCSplitter
    ...
    def CreateView(
        self, view: PyCView, row, col, arg: tuple[Incomplete, Incomplete], /
    ) -> None: ...
...
class PyCToolBar:
    ...
    def SetSizes(
        self,
        sizeButton: tuple[Incomplete, Incomplete],
        sizeButton1: tuple[Incomplete, Incomplete],
        /,
    ) -> None: ...
...
class PyCView:
    def CreateWindow(
        ...
        arg,
        arg1,
        arg2: tuple[Incomplete, Incomplete, Incomplete, Incomplete],
        /,
    ) -> None: ...
    def GetDocument(self) -> PyCDocument: ...
...
class PyCWnd:
    ...
    def InvalidateRect(
        self, arg: tuple[Incomplete, Incomplete, Incomplete, Incomplete], bErase: int = ..., /
    ) -> None: ...
    ...
    def MapWindowPoints(
        self, wnd: PyCWnd, points: list[tuple[Incomplete, Incomplete]], /
    ) -> None: ...
    ...
    def MoveWindow(
        self, rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete], bRepaint: int = ..., /
    ) -> None: ...
    def OnClose(self): ...
    ...
    def SendMessageToDescendants(
        self, idMessage, wParam: int = ..., lParam: int = ..., bDeep: int = ..., /
    ) -> None: ...
    ...
    def SetWindowPos(
        self,
        hWndInsertAfter,
        position: tuple[Incomplete, Incomplete, Incomplete, Incomplete],
        flags,
        /,
    ) -> None: ...
    @overload
    ...
    @overload
    def ScreenToClient(
        self, rect: _TwoIntSequence | _FourIntSequence, /
