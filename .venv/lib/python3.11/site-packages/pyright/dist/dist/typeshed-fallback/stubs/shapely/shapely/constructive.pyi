...
@overload
def clip_by_rect(
    geometry: Geometry, xmin: float, ymin: float, xmax: float, ymax: float, **kwargs
) -> BaseGeometry: ...
@overload
def clip_by_rect(
    geometry: None, xmin: float, ymin: float, xmax: float, ymax: float, **kwargs
) -> None: ...
@overload
def clip_by_rect(
...
@overload
def clip_by_rect(
    geometry: OptGeoArrayLikeSeq, xmin: float, ymin: float, xmax: float, ymax: float, **kwargs
) -> GeoArray: ...
@overload
def concave_hull(
    geometry: Geometry, ratio: float = 0.0, allow_holes: bool = False, **kwargs
) -> BaseGeometry: ...
@overload
def concave_hull(
    geometry: None, ratio: float = 0.0, allow_holes: bool = False, **kwargs
) -> None: ...
@overload
def concave_hull(
    geometry: Geometry | None, ratio: float = 0.0, allow_holes: bool = False, **kwargs
) -> BaseGeometry | None: ...
@overload
def concave_hull(
    geometry: OptGeoArrayLikeSeq, ratio: float = 0.0, allow_holes: bool = False, **kwargs
) -> GeoArray: ...
@overload
...
@overload
def delaunay_triangles(
    geometry: Geometry, tolerance: float, only_edges: Literal[True], **kwargs
) -> MultiLineString: ...
@overload
def delaunay_triangles(
    geometry: Geometry, tolerance: float = 0.0, *, only_edges: Literal[True], **kwargs
) -> MultiLineString: ...
@overload
def delaunay_triangles(
...
@overload
def delaunay_triangles(
    geometry: None, tolerance: float = 0.0, only_edges: bool = False, **kwargs
) -> None: ...
@overload
def delaunay_triangles(
...
@overload
def constrained_delaunay_triangles(
    geometry: OptGeoArrayLikeSeq | OptGeoArrayLike, **kwargs
) -> GeoArray: ...
@overload
...
@overload
def make_valid(
    geometry: Geometry, *, method: Literal["structure"], keep_collapsed: bool = True, **kwargs
) -> BaseGeometry: ...
@overload
def make_valid(
    geometry: None, *, method: Literal["structure"], keep_collapsed: bool = True, **kwargs
) -> None: ...
@overload
def make_valid(
    geometry: Geometry | None,
    *,
    method: Literal["structure"],
...
def minimum_clearance_line(
    geometry: LineString | Polygon | BaseMultipartGeometry, **kwargs
) -> Polygon: ...
@overload
...
def remove_repeated_points(
    geometry: OptGeoArrayLikeSeq, tolerance: float = 0.0, **kwargs
) -> GeoArray: ...
@overload
...
@overload
def segmentize(
    geometry: OptGeoArrayLike, max_segment_length: ArrayLikeSeq[float], **kwargs
) -> GeoArray: ...
@overload
def segmentize(
    geometry: OptGeoArrayLikeSeq, max_segment_length: ArrayLike[float], **kwargs
) -> GeoArray: ...
@overload
def simplify(
    geometry: OptGeoT, tolerance: float, preserve_topology: bool = True, **kwargs
) -> OptGeoT: ...
@overload
def simplify(
    geometry: OptGeoArrayLike,
...
@overload
def snap(
    geometry: OptGeoArrayLikeSeq, reference: OptGeoArrayLike, tolerance: ArrayLike[float], **kwargs
) -> GeoArray: ...
@overload
def snap(
    geometry: OptGeoArrayLike, reference: OptGeoArrayLikeSeq, tolerance: ArrayLike[float], **kwargs
) -> GeoArray: ...
@overload
def snap(
    geometry: OptGeoArrayLike, reference: OptGeoArrayLike, tolerance: ArrayLikeSeq[float], **kwargs
) -> GeoArray: ...
@overload
...
def maximum_inscribed_circle(
    geometry: Point, tolerance: float | None = None, **kwargs
) -> Point: ...
@overload
def maximum_inscribed_circle(
...
@overload
def maximum_inscribed_circle(
    geometry: Geometry, tolerance: float | None = None, **kwargs
) -> Polygon | Point: ...
@overload
def maximum_inscribed_circle(geometry: None, tolerance: float | None = None, **kwargs) -> None: ...
@overload
def maximum_inscribed_circle(
    geometry: Geometry | None, tolerance: float | None = None, **kwargs
) -> Polygon | Point | None: ...
@overload
def maximum_inscribed_circle(
    geometry: OptGeoArrayLikeSeq, tolerance: ArrayLike[float] | None = None, **kwargs
) -> GeoArray: ...
@overload
...
@overload
def orient_polygons(
    geometry: Geometry | None, *, exterior_cw: bool = False, **kwargs
) -> BaseGeometry | None: ...
@overload
def orient_polygons(
    geometry: OptGeoArrayLikeSeq, *, exterior_cw: bool = False, **kwargs
) -> GeoArray: ...
