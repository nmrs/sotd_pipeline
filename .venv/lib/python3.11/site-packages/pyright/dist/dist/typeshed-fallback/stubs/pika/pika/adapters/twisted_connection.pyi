...
class TwistedChannel:
    ...
    def basic_get(
        self, queue, auto_ack: bool = ...
    ) -> Deferred[Incomplete | Failure | BaseException | None]: ...
    def basic_nack(
        self, delivery_tag: Incomplete | None = ..., multiple: bool = ..., requeue: bool = ...
    ): ...
    def basic_publish(
        self,
        exchange,
...
class TwistedProtocolConnection(Protocol):  # pyright: ignore[reportUntypedBaseClass]
    ...
    def __init__(
        self, parameters: Incomplete | None = ..., custom_reactor: Incomplete | None = ...
    ) -> None: ...
    ...
    def is_closed(self): ...
    def close(
        self, reply_code: int = ..., reply_text: str = ...
