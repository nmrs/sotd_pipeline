...
class Pki(VaultApiBase):
    ...
    def set_crl_configuration(
        self, expiry=None, disable=None, extra_params=None, mount_point="pki"
    ): ...
    ...
    def generate_intermediate(
        self, type, common_name, extra_params=None, mount_point="pki", wrap_ttl=None
    ): ...
    def set_signed_intermediate(self, certificate, mount_point="pki"): ...
    def generate_certificate(
        self, name, common_name, extra_params=None, mount_point="pki", wrap_ttl=None
    ): ...
