...
class TracebackInfo(Generic[_CallpointT_co]):
    ...
    @classmethod
    def from_frame(
        cls, frame: FrameType | None = None, level: int = 1, limit: int | None = None
    ) -> Self: ...
    @classmethod
...
_TracebackInfoT_co = TypeVar(
    "_TracebackInfoT_co", bound=TracebackInfo, covariant=True, default=TracebackInfo
)
...
class ExceptionInfo(Generic[_TracebackInfoT_co]):
    ...
    @classmethod
    def from_exc_info(
        cls, exc_type: type[BaseException], exc_value: BaseException, traceback: TracebackType
    ) -> Self: ...
    @classmethod
...
class ParsedException:
    ...
    def __init__(
        self, exc_type_name: str, exc_msg: str, frames: Iterable[Mapping[str, Any]] | None = None
    ) -> None: ...
    @property
