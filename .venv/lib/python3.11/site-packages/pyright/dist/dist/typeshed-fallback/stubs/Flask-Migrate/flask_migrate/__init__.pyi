...
class Config:  # should inherit from alembic.config.Config which is not possible yet
    ...
    def __init__(
        ...
        config_args: SupportsKeysAndGetItem[str, _AlembicConfigValue]
        | Iterable[tuple[str, _AlembicConfigValue]] = ...,
        attributes: (
...
def heads(
    directory: str | None = None, verbose: bool = False, resolve_dependencies: bool = False
) -> None: ...
