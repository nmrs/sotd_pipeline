...
def SHGetPropertyStoreFromParsingName(
    Path: str,
    BindCtx: _win32typing.PyIBindCtx | None = ...,
    Flags: int = ...,
    riid: _win32typing.PyIID | str = ...,
    /,
) -> _win32typing.PyIPropertyStore: ...
...
def SHGetPropertyStoreForWindow(
    hwnd: int, riid: _win32typing.PyIID, /
) -> _win32typing.PyIPropertyStore: ...
def PSGetPropertyFromPropertyStorage(
    ps, key: _win32typing.PyPROPERTYKEY, /
) -> _win32typing.PyPROPVARIANT: ...
def PSGetNamedPropertyFromPropertyStorage(ps, name, /) -> _win32typing.PyPROPVARIANT: ...
def PSCreateSimplePropertyChange(
    flags,
    key: _win32typing.PyPROPERTYKEY,
    val: _win32typing.PyPROPVARIANT,
