...
class PSCanvas:
    ...
    def drawString(
        self, x, y, s, angle: int = 0, text_anchor: str = "left", textRenderMode: int = 0
    ) -> None: ...
    def drawCentredString(
        self, x, y, text, text_anchor: str = "middle", textRenderMode: int = 0
    ) -> None: ...
    def drawRightString(
        self, text, x, y, text_anchor: str = "end", textRenderMode: int = 0
    ) -> None: ...
    ...
    def drawArc(
        self, x1, y1, x2, y2, startAng: int = 0, extent: int = 360, fromcenter: int = 0
    ) -> None: ...
