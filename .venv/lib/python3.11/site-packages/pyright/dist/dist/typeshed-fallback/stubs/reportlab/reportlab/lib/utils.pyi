...
from reportlab.lib.rltempfile import (
    get_rl_tempdir as get_rl_tempdir,
    get_rl_tempfile as get_rl_tempfile,
)
...
def simpleSplit(
    text: str | bytes, fontName: str | None, fontSize: float, maxWidth: float | None
): ...
@overload
