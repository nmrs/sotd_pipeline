...
from ..xml._functions_overloads import (
    _HasAttrib,
    _HasGet,
    _HasTagAndGet,
    _HasText,
    _SupportsFindChartLines,
)
...
class _SerialisableTreeElement(
    _HasGet[object], _SupportsFindChartLines, _ChildSerialisableTreeElement, Protocol
): ...
