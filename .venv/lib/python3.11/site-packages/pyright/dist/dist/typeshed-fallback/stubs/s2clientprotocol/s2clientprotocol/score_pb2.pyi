...
class Score(google.protobuf.message.Message):
    ...
    class _ScoreTypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Score._ScoreType.ValueType],
        builtins.type,
    ):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "score", b"score", "score_details", b"score_details", "score_type", b"score_type"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class VitalScoreDetails(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal["energy", b"energy", "life", b"life", "shields", b"shields"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal["energy", b"energy", "life", b"life", "shields", b"shields"],
