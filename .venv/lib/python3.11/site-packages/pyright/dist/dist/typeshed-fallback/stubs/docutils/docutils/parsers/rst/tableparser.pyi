...
class GridTableParser(TableParser):
    ...
    def scan_cell(
        self, top: int, left: int
    ) -> tuple[int, int, dict[int, list[int]], dict[int, list[int]]]: ...
    def scan_right(
        self, top: int, left: int
    ) -> tuple[int, int, dict[int, list[int]], dict[int, list[int]]]: ...
    def scan_down(
        self, top: int, left: int, right: int
    ) -> tuple[int, dict[int, list[int]], dict[int, list[int]]]: ...
    def scan_left(
...
class SimpleTableParser(TableParser):
    ...
    def parse_row(
        self, lines: list[str], start: int, spanline: tuple[str, int] | None = None
    ) -> None: ...
    def check_columns(
        self, lines: list[str], first_line: int, columns: list[tuple[int, int]]
    ) -> None: ...
    def structure_from_cells(self) -> tuple[_Colspecs, list[_Row], list[_Row]]: ...
