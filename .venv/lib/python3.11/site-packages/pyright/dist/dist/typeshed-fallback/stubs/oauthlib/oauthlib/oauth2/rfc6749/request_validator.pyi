...
class RequestValidator:
    ...
    def invalidate_authorization_code(
        self, client_id: str, code: str, request: Request, *args, **kwargs
    ) -> None: ...
    def revoke_token(
        self, token: str, token_type_hint: str, request: Request, *args, **kwargs
    ) -> None: ...
    ...
    def save_authorization_code(
        self, client_id: str, code: _AuthorizationCode, request: Request, *args, **kwargs
    ) -> None: ...
    def save_token(
        self, token: Mapping[str, object], request: Request, *args, **kwargs
    ) -> object: ...
    def save_bearer_token(
        self, token: _BearerToken, request: Request, *args, **kwargs
    ) -> object: ...
    ...
    def validate_code(
        self, client_id: str, code: str, client: Client, request: Request, *args, **kwargs
    ) -> bool: ...
    def validate_grant_type(
        self, client_id: str, grant_type: str, client: Client, request: Request, *args, **kwargs
    ) -> bool: ...
    ...
    def validate_scopes(
        self, client_id: str, scopes: list[str], client: Client, request: Request, *args, **kwargs
    ) -> bool: ...
    def validate_user(
        self, username: str, password: str, client: Client, request: Request, *args, **kwargs
    ) -> bool: ...
