...
class LRI(dict[_KT, _VT]):
    ...
    def __init__(
        self, max_size: int = 128, values=None, on_miss: Callable[[_KT], _VT] | None = None
    ) -> None: ...
    ...
    def update(
        self, E: SupportsKeysAndGetItem[_KT, _VT] | Iterable[tuple[_KT, _VT]], **F: _VT
...
class ThresholdCounter(Generic[_T]):
    ...
    def update(
        self, iterable: Iterable[_T] | Mapping[_T, int], **kwargs: Iterable[_T] | Mapping[_T, int]
    ) -> None: ...
