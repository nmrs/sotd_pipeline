...
class Address:
    ...
    @classmethod
    def create(
        cls, *, name: str | None = None, line1: str, line2: str | None = None, country: str | None
    ) -> CombinedAddress: ...
    @overload
    @classmethod
    def create(
        cls, *, name: str | None = None, line1: str | None = None, line2: str, country: str | None
    ) -> CombinedAddress: ...
    @overload
    @classmethod
    def create(
...
class QRBill:
    ...
    def draw_swiss_cross(
        self, dwg: _SvgDrawing, grp: _SvgGroup, origin: tuple[float, float], size: float
    ) -> None: ...
    def draw_blank_rect(
        self, dwg: _SvgDrawing, grp: _SvgGroup, x: float, y: float, width: float, height: float
    ) -> None: ...
    def label(self, txt: str) -> str: ...
    def as_svg(
        self, file_out: str | Path | SupportsWrite[str], full_page: bool = False
    ) -> None: ...
