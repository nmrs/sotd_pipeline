...
class RemoteCallbacks(Payload):
    ...
    def __init__(
        self, credentials: _Credentials | None = None, certificate: _Certificate | None = None
    ) -> None: ...
...
def git_clone_options(
    payload: Payload, opts: _CDataBase | None = None
...
def get_credentials(
    fn: _CredentialsFn, url: _CDataBase, username: _CDataBase, allowed: CredentialType
) -> _CDataBase: ...
