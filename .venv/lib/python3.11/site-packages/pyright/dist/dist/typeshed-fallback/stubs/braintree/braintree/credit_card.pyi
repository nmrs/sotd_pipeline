...
class CreditCard(Resource):
    ...
    @staticmethod
    def update(
        credit_card_token: str, params: dict[str, Incomplete] | None = None
    ) -> SuccessfulResult | ErrorResult | None: ...
    @staticmethod
    ...
    @staticmethod
    def create_signature() -> list[
        str | dict[str, list[str]] | dict[str, list[str | dict[str, list[str]]]]
    ]: ...
    @staticmethod
    def update_signature() -> list[
        str | dict[str, list[str]] | dict[str, list[str | dict[str, list[str]]]]
    ]: ...
    @staticmethod
    def signature(
