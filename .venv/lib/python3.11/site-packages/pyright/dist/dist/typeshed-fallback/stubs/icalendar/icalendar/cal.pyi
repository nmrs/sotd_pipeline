...
class Component(CaselessDict[Incomplete]):
    ...
    def add(
        ...
        name: str,
        value: Any,
        parameters: SupportsItems[str, str | None] | None = None,
        encode: Literal[True] = True,
    ) -> None: ...
    ...
    def walk(
        self, name: str | None = None, select: Callable[[Component], bool] = ...
    ) -> list[Component]: ...
    def property_items(
    ...
    @classmethod
    def from_ical(
        cls, st: str, multiple: Literal[False] = False
    ) -> Component: ...  # or any of its subclasses
    @overload
    @classmethod
    def from_ical(
        cls, st: str, multiple: Literal[True]
    ) -> list[Component]: ...  # or any of its subclasses
...
class Timezone(Component):
    ...
    def get_transitions(
        ...
        list[datetime.datetime], list[tuple[datetime.timedelta, datetime.timedelta, str]]
    ]: ...
    @classmethod
    def from_tzinfo(
        cls,
...
class Calendar(Component):
    ...
    def add_missing_timezones(
        self, first_date: datetime.date = ..., last_date: datetime.date = ...
    ) -> None: ...
    @property
