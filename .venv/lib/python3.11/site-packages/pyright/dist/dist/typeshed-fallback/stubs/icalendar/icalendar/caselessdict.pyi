...
def canonsort_keys(
    keys: Iterable[str], canonical_order: Iterable[str] | None = None
) -> list[str]: ...
def canonsort_items(
    dict1: Mapping[str, _VT], canonical_order: Iterable[str] | None = None
) -> list[tuple[str, _VT]]: ...
...
class CaselessDict(OrderedDict[str, _VT]):
    ...
    @overload
    def setdefault(
        self: CaselessDict[_T | None], key: str | bytes, value: None = None
    ) -> _T | None: ...
    @overload
    ...
    def update(
        self, *args: SupportsItems[str, _VT] | Iterable[tuple[str, _VT]], **kwargs: _VT
