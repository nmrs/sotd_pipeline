...
_DefaultImage: TypeAlias = (
    PilImage | PyPNGImage
)  # PilImage if Pillow is installed, PyPNGImage otherwise
...
class QRCode(Generic[GenericImage]):
    ...
    def print_ascii(
        self, out: _TTYWriter | None = None, tty: bool = False, invert: bool = False
    ) -> None: ...
    ...
    @overload
    def make_image(
        self, image_factory: type[GenericImageLocal], **kwargs: Any
    ) -> GenericImageLocal: ...
