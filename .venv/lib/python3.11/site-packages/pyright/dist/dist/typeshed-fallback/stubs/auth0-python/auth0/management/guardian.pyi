...
class Guardian:
    ...
    async def update_factor_async(
        self, name: str, body: dict[str, Incomplete]
    ) -> dict[str, Incomplete]: ...
    def update_templates(self, body: dict[str, Incomplete]) -> dict[str, Incomplete]: ...
    async def update_templates_async(
    ...
    async def create_enrollment_ticket_async(
        self, body: dict[str, Incomplete]
    ) -> dict[str, Incomplete]: ...
    def get_factor_providers(self, factor_name: str, name: str) -> dict[str, Incomplete]: ...
    async def get_factor_providers_async(
        self, factor_name: str, name: str
    ) -> dict[str, Incomplete]: ...
