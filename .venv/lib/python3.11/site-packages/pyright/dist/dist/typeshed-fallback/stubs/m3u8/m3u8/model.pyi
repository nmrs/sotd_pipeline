...
_T = TypeVar("_T")
_CustomTagsParser: TypeAlias = Callable[
    [str, int, dict[str, Incomplete], dict[str, Incomplete]], object
]
...
class Segment(BasePathMixin):
    ...
    def dumps(
        self,
        last_segment: PartialSegment | None,
...
class Playlist(_PlaylistProtocol):
    ...
    def __init__(
        self,
        uri: str | None,
        stream_info: Mapping[str, Incomplete],
        media: MediaList,
        base_uri: str,
    ) -> None: ...
...
class IFramePlaylist(_PlaylistProtocol):
    ...
    def __init__(
        self, base_uri: str, uri: str | None, iframe_stream_info: Mapping[str, Incomplete]
    ) -> None: ...
...
class PlaylistList(
    TagList[_PlaylistAnyT], list[_PlaylistAnyT], GroupedBasePathMixin[_PlaylistAnyT]
): ...
...
class RenditionReport(BasePathMixin):
    ...
    last_part: int | None
    def __init__(
        self, base_uri: str | None, uri: str | None, last_msn: int, last_part: int | None = None
    ) -> None: ...
    def dumps(self) -> str: ...
...
class Skip:
    ...
    def __init__(
        self, skipped_segments: int, recently_removed_dateranges: str | None = None
    ) -> None: ...
    def dumps(self) -> str: ...
...
class ContentSteering(BasePathMixin):
    ...
    pathway_id: str | None
    def __init__(
        self, base_uri: str | None, server_uri: str | None, pathway_id: str | None = None
    ) -> None: ...
    def dumps(self) -> str: ...
...
class ImagePlaylist(_PlaylistProtocol):
    ...
    def __init__(
        self, base_uri: str | None, uri: str | None, image_stream_info: Mapping[str, Incomplete]
    ) -> None: ...
