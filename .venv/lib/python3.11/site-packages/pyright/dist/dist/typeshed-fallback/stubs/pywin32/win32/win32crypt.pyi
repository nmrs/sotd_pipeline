...
def CryptAcquireContext(
    Container: str, Provider: str, ProvType, Flags
) -> _win32typing.PyCRYPTPROV: ...
def CryptFindLocalizedName(CryptName: str) -> str: ...
def CertEnumSystemStore(
    Flags, SystemStoreLocationPara: Incomplete | None = ...
) -> list[Incomplete]: ...
...
def CertOpenStore(
    ...
    CryptProv: _win32typing.PyCRYPTPROV,
    Flags,
    Para: Incomplete | None,
) -> _win32typing.PyCERTSTORE: ...
def CertOpenSystemStore(
    SubsystemProtocol: str, Prov: _win32typing.PyCRYPTPROV | None = ...
) -> _win32typing.PyCERTSTORE: ...
...
def CryptGetKeyIdentifierProperty(
    KeyIdentifier: str, PropId=..., Flags: int = ..., ComputerName: str | None = ...
): ...
...
def CertAddSerializedElementToStore(
    CertStore: _win32typing.PyCERTSTORE,
    Element,
    AddDisposition,
    ContextTypeFlags=...,
    Flags: int = ...,
...
def CryptQueryObject(
    ObjectType, Object, ExpectedContentTypeFlags=..., ExpectedFormatTypeFlags=..., Flags: int = ...
): ...
...
def CryptEncodeObjectEx(
    ...
    Flags: int = ...,
    CertEncodingType=...,
    EncodePara: Incomplete | None = ...,
): ...
def CryptDecodeObjectEx(
    StructType, Encoded, Flags: int = ..., CertEncodingType=..., DecodePara: Incomplete | None = ...
): ...
