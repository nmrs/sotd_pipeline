...
class GeoDataFrame(GeoPandasBase, pd.DataFrame):  # type: ignore[misc]
    ...
    def from_postgis(
        ...
        parse_dates: Container[str | Mapping[str, Incomplete]]
        | Mapping[str, str | Mapping[str, Incomplete]]
        | None = None,
    ...
    @classmethod
    def from_arrow(
        cls, table, geometry: str | None = None
    ) -> GeoDataFrame: ...  # table: pyarrow.Table
    ...
    def to_parquet(  # type: ignore[override]
        ...
        *,
        engine: Literal[
            "auto", "pyarrow"
        ] = "auto",  # Only these engines are supported, unlike pandas
        **kwargs,
    ) -> None: ...
    def to_feather(
        self,
    ...
    @overload
    def to_crs(
        self, crs: _ConvertibleToCRS, epsg: int | None = None, inplace: Literal[False] = False
    ) -> Self: ...
    @overload
    def to_crs(
        self, crs: _ConvertibleToCRS | None = None, *, epsg: int, inplace: Literal[False] = False
    ) -> Self: ...
    @overload
    def to_crs(
        self, crs: _ConvertibleToCRS | None, epsg: int, inplace: Literal[False] = False
    ) -> Self: ...
    @overload
    def to_crs(
        self, crs: _ConvertibleToCRS, epsg: int | None = None, *, inplace: Literal[True]
    ) -> None: ...
    @overload
    def to_crs(self, crs: _ConvertibleToCRS, epsg: int | None, inplace: Literal[True]) -> None: ...
    @overload
    def to_crs(
        self, crs: _ConvertibleToCRS | None = None, *, epsg: int, inplace: Literal[True]
    ) -> None: ...
    @overload
    ...
    def astype(
        ...
        dtype: AstypeArg
        | Mapping[Any, Dtype]
        | pd.Series[Any],  # any because of mapping invariance and series typevar bounds
        copy: bool | None = None,
    ...
    def clip(
        self, mask: _ClipMask, keep_geom_type: bool = False, sort: bool = False
    ) -> GeoDataFrame: ...  # type: ignore[override]
    def overlay(
        self,
        right: GeoDataFrame,
