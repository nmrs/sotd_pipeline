...
class Canvas(_PDFColorSetter):
    ...
    def bookmarkPage(
        self, key, fit: str = "Fit", left=None, top=None, bottom=None, right=None, zoom=None
    ): ...
    ...
    def freeTextAnnotation(
        self, contents, DA, Rect=None, addtopage: int = 1, name=None, relative: int = 0, **kw
    ) -> None: ...
    def textAnnotation(
        self, contents, Rect=None, addtopage: int = 1, name=None, relative: int = 0, **kw
    ) -> None: ...
    ...
    def linearGradient(
        self, x0, y0, x1, y1, colors, positions=None, extend: bool = True
    ) -> None: ...
    ...
    def stringWidth(
        self, text: str, fontName: str | None = None, fontSize: float | None = None
    ) -> float: ...
    ...
    def setDash(
        self, array: list[float] | tuple[float, ...] | float = [], phase: float = 0
    ) -> None: ...
    def beginPath(self): ...
    ...
    def beginText(
        self, x: float = 0, y: float = 0, direction: Literal["LTR", "RTL"] | None = None
    ) -> PDFTextObject: ...
