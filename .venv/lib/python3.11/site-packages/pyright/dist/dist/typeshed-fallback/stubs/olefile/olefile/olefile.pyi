...
def isOleFile(
    filename: IO[bytes] | bytes | str | None = None, data: bytes | None = None
) -> bool: ...
...
class OleFileIO(Generic[AnyStr]):
    ...
    def _raise_defect(
        ...
        defect_level: int,
        message: str,
        exception_type: type[Exception] = OleFileError,  # noqa: Y011
    ) -> None: ...
    ...
    def _write_mini_stream(
        self, entry: OleDirectoryEntry[AnyStr], data_to_write: bytes
    ) -> None: ...
    ...
    def getproperties(
        self,
        filename: AnyStr | Sequence[AnyStr],
