...
_ConvertibleToCRS: TypeAlias = (
    str | int | tuple[str, str] | list[str] | dict[str, Incomplete] | _SupportsToWkt
)
_AffinityOrigin: TypeAlias = (
    Literal["center", "centroid"] | Point | tuple[float, float] | tuple[float, float, float]
)
_ClipMask: TypeAlias = (
    GeoDataFrame | GeoSeries | Polygon | MultiPolygon | tuple[float, float, float, float]
)  # noqa: Y047
# np.floating[Any] because precision is not important
_BboxLike: TypeAlias = (
    Sequence[float] | NDArray[np.floating[Any]] | Geometry | GeoDataFrame | GeoSeries
)  # noqa: Y047
...
_ConvertibleToGeoSeries: TypeAlias = (
    Geometry | Mapping[int, Geometry] | Mapping[str, Geometry] | _GeoListLike
)  # noqa: Y047

# Cannot use pd.Series[Geometry] because of pd.Series type variable bounds
_GeomSeq: TypeAlias = (
    Sequence[Geometry] | NDArray[np.object_] | pd.Series[Any] | GeometryArray | GeoSeries
)
...
class GeoPandasBase:
    ...
    def delaunay_triangles(
        self, tolerance: float | ArrayLike = 0.0, only_edges: bool | ArrayLike = False
    ) -> GeoSeries: ...
    def voronoi_polygons(
        self,
        tolerance: float | ArrayLike = 0.0,
    ...
    def set_precision(
        self,
        grid_size: float,
        mode: Literal["valid_output", "pointwise", "keep_collapsed"] = "valid_output",
    ) -> GeoSeries: ...
    ...
    def contains(
        self, other: GeoSeries | Geometry, align: bool | None = None
    ) -> pd.Series[bool]: ...
    def contains_properly(
        self, other: GeoSeries | Geometry, align: bool | None = None
    ) -> pd.Series[bool]: ...
    def dwithin(
        self, other: GeoSeries | Geometry, distance: float | ArrayLike, align: bool | None = None
    ) -> pd.Series[bool]: ...
    def geom_equals(
        self, other: GeoSeries | Geometry, align: bool | None = None
    ) -> pd.Series[bool]: ...
    ...
    def geom_almost_equals(
        self, other: GeoSeries | Geometry, decimal: int = 6, align: bool | None = None
    ) -> pd.Series[bool]: ...
    ...
    def hausdorff_distance(
        self,
        other: GeoSeries | Geometry,
        align: bool | None = None,
        densify: float | ArrayLike | None = None,
    ) -> pd.Series[float]: ...
    ...
    def simplify(
        self, tolerance: float | ArrayLike, preserve_topology: bool = True
    ) -> GeoSeries: ...
    def relate(self, other: GeoSeries | Geometry, align: bool | None = None) -> pd.Series[str]: ...
    def relate_pattern(
        self, other: GeoSeries | Geometry, pattern: str, align: bool | None = None
    ) -> pd.Series[bool]: ...
    def project(
        self, other: GeoSeries | Geometry, normalized: bool = False, align: bool | None = None
    ) -> pd.Series[float]: ...
    ...
    def rotate(
        self, angle: float, origin: _AffinityOrigin = "center", use_radians: bool = False
    ) -> GeoSeries: ...
    def scale(
        self,
        xfact: float = 1.0,
    ...
    def hilbert_distance(
        self,
        total_bounds: tuple[float, float, float, float] | Iterable[float] | None = None,
        level: int = 16,
    ) -> pd.Series[int]: ...
    @overload
    def sample_points(
    ...
    @overload
    def polygonize(
        self, node: bool = True, *, full: Literal[True]
    ) -> tuple[GeoSeries, GeoSeries, GeoSeries, GeoSeries]: ...
    @overload
    def polygonize(
        self, node: bool, full: Literal[True]
    ) -> tuple[GeoSeries, GeoSeries, GeoSeries, GeoSeries]: ...
