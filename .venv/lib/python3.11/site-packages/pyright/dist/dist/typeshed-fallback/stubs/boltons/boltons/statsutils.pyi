...
class Stats:
    ...
    def __init__(
        ...
        default: float = 0.0,
        *,
        use_copy: Literal[False],
        is_sorted: bool = False,
    ) -> None: ...
    @overload
    def __init__(
        self, data: list[float], default: float, use_copy: Literal[False], is_sorted: bool = False
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    def get_histogram_counts(
        self, bins: int | list[float] | None = None, **kw
