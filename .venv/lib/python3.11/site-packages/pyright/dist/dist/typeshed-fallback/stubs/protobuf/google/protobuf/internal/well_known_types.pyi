...
class Any:
    ...
    value: Incomplete
    def Pack(
        self, msg, type_url_prefix: str = "type.googleapis.com/", deterministic=None
    ) -> None: ...
...
class FieldMask:
    ...
    def MergeMessage(
        ...
        replace_repeated_field: bool = False,
    ) -> None: ...
...
_StructValueArg: TypeAlias = (
    _StructValue | Mapping[str, _StructValueArg] | Sequence[_StructValueArg]
)
