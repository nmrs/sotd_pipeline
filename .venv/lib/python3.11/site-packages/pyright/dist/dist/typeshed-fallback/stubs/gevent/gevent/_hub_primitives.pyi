...
class WaitOperationsGreenlet(SwitchOutGreenletWithLoop):
    ...
    def cancel_wait(
        self,
        watcher: _Watcher,
        error: type[BaseException] | BaseException,
        close_watcher: bool = False,
    ) -> None: ...

class _WaitIterator(Generic[_T]):
    def __init__(
        self, objects: Collection[_T], hub: Hub, timeout: float, count: None | int
    ) -> None: ...
...
def iwait_on_objects(
    objects: None, timeout: float | None = None, count: int | None = None
) -> list[bool]: ...
@overload
def iwait_on_objects(
...
@overload
def wait_on_objects(
    objects: None = None, timeout: float | None = None, count: int | None = None
) -> bool: ...
@overload
def wait_on_objects(
    objects: Collection[_WaitableT], timeout: float | None = None, count: int | None = None
...
def wait_on_socket(
    socket: socket,
    watcher: _Watcher,
    timeout_exc: type[BaseException] | BaseException | None = None,
) -> None: ...
def wait_on_watcher(
    watcher: _Watcher,
