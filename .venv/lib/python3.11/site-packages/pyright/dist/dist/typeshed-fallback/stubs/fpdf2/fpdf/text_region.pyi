...
class Bullet:
    ...
    rendered_flag: bool
    def __init__(
        self, bullet_fragments: Sequence[Fragment], text_line: TextLine, bullet_r_margin: float
    ) -> None: ...
...
class ImageParagraph:
    ...
    ) -> VectorImageInfo | RasterImageInfo: ...
...
class TextColumns(TextRegion, TextColumnarMixin):
    balance: Incomplete
    def __init__(
        self, pdf, *args, ncols: int = 1, gutter: float = 10, balance: bool = False, **kwargs
    ) -> None: ...
