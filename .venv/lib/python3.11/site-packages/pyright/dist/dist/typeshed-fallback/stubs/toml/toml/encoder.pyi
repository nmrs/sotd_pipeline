...
def dump(
    o: _MappingT, f: SupportsWrite[str], encoder: TomlEncoder[_MappingT] | None = None
) -> str: ...
...
class TomlEncoder(Generic[_MappingT]):
    ...
    @overload
    def __init__(
        self: TomlEncoder[dict[str, Any]], _dict: type[dict[str, Any]] = ..., preserve: bool = False
    ) -> None: ...
...
class TomlPreserveInlineDictEncoder(TomlEncoder[_MappingT]):
    ...
    @overload
    def __init__(
        self: TomlPreserveInlineDictEncoder[dict[str, Any]], _dict: type[dict[str, Any]] = ...
    ) -> None: ...
...
class TomlArraySeparatorEncoder(TomlEncoder[_MappingT]):
    ...
    @overload
    def __init__(
        self, _dict: type[_MappingT], preserve: bool = False, separator: str = ","
    ) -> None: ...
    @overload
    def __init__(
