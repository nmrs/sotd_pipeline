...
class _DebugGameStateEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DebugGameState.ValueType],
    builtins.type,
):
...
class DebugDraw(google.protobuf.message.Message):
    ...
    def boxes(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DebugBox]: ...
    @property
    def spheres(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___DebugSphere
    ]: ...
    def __init__(
        self,
        *,
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "boxes", b"boxes", "lines", b"lines", "spheres", b"spheres", "text", b"text"
        ],
    ) -> None: ...
...
class Color(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["b", b"b", "g", b"g", "r", b"r"]
    ) -> builtins.bool: ...
...
class DebugLine(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, color: global___Color | None = ..., line: global___Line | None = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["color", b"color", "line", b"line"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["color", b"color", "line", b"line"]
    ) -> None: ...
...
class DebugBox(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["color", b"color", "max", b"max", "min", b"min"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["color", b"color", "max", b"max", "min", b"min"]
    ) -> None: ...
...
class DebugSphere(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["color", b"color", "p", b"p", "r", b"r"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["color", b"color", "p", b"p", "r", b"r"]
    ) -> None: ...
...
class DebugCreateUnit(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "owner", b"owner", "pos", b"pos", "quantity", b"quantity", "unit_type", b"unit_type"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class DebugTestProcess(google.protobuf.message.Message):
    ...
    class _TestEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            DebugTestProcess._Test.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def HasField(
        self, field_name: typing.Literal["delay_ms", b"delay_ms", "test", b"test"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["delay_ms", b"delay_ms", "test", b"test"]
    ) -> None: ...
...
class DebugEndGame(google.protobuf.message.Message):
    ...
    class _EndResultEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            DebugEndGame._EndResult.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def __init__(
        self, *, end_result: global___DebugEndGame.EndResult.ValueType | None = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["end_result", b"end_result"]
    ) -> builtins.bool: ...
...
class DebugSetUnitValue(google.protobuf.message.Message):
    ...
    class _UnitValueEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            DebugSetUnitValue._UnitValue.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "unit_tag", b"unit_tag", "unit_value", b"unit_value", "value", b"value"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
