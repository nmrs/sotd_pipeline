...
class PDFFont(PDFObject):
    ...
    def __init__(
        self, subtype: str, base_font: str, encoding: str | None = None, d_w=None, w=None
    ) -> None: ...
...
class PDFCatalog(PDFObject):
    ...
    def __init__(
        self, lang: str | None = None, page_layout=None, page_mode=None, viewer_preferences=None
    ) -> None: ...
...
class PDFExtGState(PDFObject):
    ...
    def serialize(
        self, obj_dict: Unused = None, _security_handler: StandardSecurityHandler | None = None
    ) -> str: ...
...
class ResourceCatalog:
    ...
    def add(
        self, resource_type: PDFResourceType, resource, page_number: int
    ) -> Incomplete | None: ...
