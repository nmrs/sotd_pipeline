...
class _DendrogramPlotter:
    ...
    def __init__(
        self,
        data: DataFrame,
        linkage: NDArray[Incomplete] | None,
        metric: str,
        method: str,
        axis: int,
        label: bool,
...
class ClusterGrid(Grid):
    ...
    def dim_ratios(
        self, colors: Incomplete | None, dendrogram_ratio: float, colors_ratio: float
    ) -> list[float]: ...
    @staticmethod
    ...
    def plot_matrix(
        self,
        colorbar_kws: dict[str, Incomplete],
        xind: _ArrayLikeInt_co,
        yind: _ArrayLikeInt_co,
        **kws,
    ) -> None: ...
    def plot(
        self,
