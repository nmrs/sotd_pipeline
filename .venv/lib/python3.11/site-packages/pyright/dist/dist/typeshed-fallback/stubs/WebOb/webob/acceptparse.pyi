...
class AcceptValidHeader(Accept):
    ...
    @overload
    def best_match(
        self, offers: Iterable[str | tuple[str, float] | list[Any]], default_match: None = None
    ) -> str | None: ...
    @overload
    def best_match(
...
class _AcceptLanguageInvalidOrNoHeader(AcceptLanguage):
    ...
    @overload
    def lookup(
        self, language_tags: object, default_range: object, default_tag: str, default: object = None
    ) -> str: ...
    @overload
    def lookup(
        self,
