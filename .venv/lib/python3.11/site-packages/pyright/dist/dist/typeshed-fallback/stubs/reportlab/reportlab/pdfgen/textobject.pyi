...
_Color: TypeAlias = (
    Color | tuple[float, float, float, float] | tuple[float, float, float] | list[float] | str
)
...
def bidiFragWord(
    w: str, direction: str | None = None, bidiV: int = -1, bidiL: int = -1, clean: bool = True
): ...
def bidiWordList(
...
class _PDFColorSetter:
    def setFillColorCMYK(
        self, c: float, m: float, y: float, k: float, alpha: float | None = None
    ) -> None: ...
    def setStrokeColorCMYK(
        self, c: float, m: float, y: float, k: float, alpha: float | None = None
    ) -> None: ...
    def setFillColorRGB(self, r: float, g: float, b: float, alpha: float | None = None) -> None: ...
    def setStrokeColorRGB(
        self, r: float, g: float, b: float, alpha: float | None = None
    ) -> None: ...
