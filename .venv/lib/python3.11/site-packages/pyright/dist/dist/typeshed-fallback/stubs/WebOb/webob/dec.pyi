...
_RequestHandler: TypeAlias = (
    _RequestHandlerCallable[_RequestT, _P] | _RequestHandlerMethod[_RequestT, _P]
)
_Middleware: TypeAlias = (
    _MiddlewareCallable[_RequestT, _AppT, _P] | _MiddlewareMethod[_RequestT, _AppT, _P]
)
...
class _MiddlewareFactory(Generic[_P, _AppT_contra, _RequestT_contra]):
    ...
    @overload
    def __call__(
        self, app: _AppT_contra, *_: _P.args, **config: _P.kwargs
