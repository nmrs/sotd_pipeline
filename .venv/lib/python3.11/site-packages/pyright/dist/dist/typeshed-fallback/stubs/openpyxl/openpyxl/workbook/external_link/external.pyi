...
class ExternalSheetData(Serialisable):
    ...
    __elements__: ClassVar[tuple[str, ...]]
    def __init__(
        self, sheetId: ConvertibleToInt, refreshError: _ConvertibleToBool | None = None, row=()
    ) -> None: ...
...
class ExternalDefinedName(Serialisable):
    ...
    def __init__(
        self, name: str, refersTo: str | None = None, sheetId: ConvertibleToInt | None = None
    ) -> None: ...
...
class ExternalLink(Serialisable):
    ...
    def __init__(
        self,
        externalBook: ExternalBook | None = None,
        ddeLink: Unused = None,
        oleLink: Unused = None,
        extLst: Unused = None,
    ) -> None: ...
