...
class ForeignKeyWidget(Widget, Generic[_ModelT]):
    ...
    def get_queryset(
        self, value: Any, row: Mapping[str, Any], *args: Any, **kwargs: Any
    ) -> QuerySet[_ModelT]: ...
    def get_lookup_kwargs(
        self, value: Any, row: Mapping[str, Any] | None = None, **kwargs: Any
    ) -> dict[str, Any]: ...
...
class ManyToManyWidget(Widget, Generic[_ModelT]):
    ...
    field: str
    def __init__(
        self, model: _ModelT, separator: str | None = None, field: str | None = None, **kwargs: Any
    ) -> None: ...
