...
class LDAPBooleanEncoder(AbstractItemEncoder):
    ...
    def encodeValue(
        self, value: bool | int, asn1Spec: Unused, encodeFun: Unused, **options: Unused
    ): ...
...
@overload
def decode_sequence(
    message: _B, start: int, stop: int, context_decoders: Mapping[int, Callable[[_B, int, int], _R]]
) -> _R: ...
@overload
def decode_sequence(
...
def decode_intermediate_response(
    message, start: int, stop: int, context_decoders: Unused = None
): ...
