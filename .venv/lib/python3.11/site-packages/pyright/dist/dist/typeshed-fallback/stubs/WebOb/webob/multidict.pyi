...
class MultiDict(MutableMapping[_KT, _VT]):
    ...
    @overload
    def extend(
        self: MultiDict[str, _VT], other: _SupportsItemsWithIterableResult[str, _VT], **kwargs: _VT
    ) -> None: ...
    @overload
    ...
    @overload
    def extend(
        self: MultiDict[str, _VT], other: SupportsKeysAndGetItem[str, _VT], **kwargs: _VT
    ) -> None: ...
    @overload
