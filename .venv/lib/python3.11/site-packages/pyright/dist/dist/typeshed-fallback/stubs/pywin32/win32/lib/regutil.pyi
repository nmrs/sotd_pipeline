...
def GetAppPathsKey(): ...
def RegisterPythonExe(
    exeFullPath, exeAlias: Incomplete | None = ..., exeAppPath: Incomplete | None = ...
) -> None: ...
...
def RegisterHelpFile(
    helpFile, helpPath, helpDesc: Incomplete | None = ..., bCheckFile: int = ...
) -> None: ...
...
def RegisterShellCommand(
    shellCommand, exeCommand, shellUserCommand: Incomplete | None = ...
) -> None: ...
