...
class BitString(base.SimpleAsn1Type):
    ...
    @classmethod
    def fromHexString(
        cls, value, internalFormat: bool = False, prepend: ConvertibleToInt | None = None
    ): ...
    @classmethod
    ...
    def fromOctetString(
        ...
        prepend: ConvertibleToInt | None = None,
        padding: int = 0,
    ): ...
    def prettyIn(self, value): ...
...
class SequenceOfAndSetOfBase(base.ConstructedAsn1Type):
    ...
    def sort(
        self,
        key: Callable[[Incomplete], SupportsRichComparison] | None = None,
        reverse: bool = False,
    ) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self): ...
...
class Set(SequenceAndSetBase):
    ...
    def getComponentByType(
        self, tagSet, default=..., instantiate: bool = True, innerFlag: bool = False
    ): ...
