...
class ModelKey(Property):
    ...
    ) -> key_module.Key | list[key_module.Key] | None: ...
...
class User:
    def __init__(
        self, email: str | None = ..., _auth_domain: str | None = ..., _user_id: str | None = ...
    ) -> None: ...
...
class StructuredProperty(Property):
    ...
    ) -> query_module.DisjunctionNode | query_module.FalseNode: ...  # type: ignore[override]
