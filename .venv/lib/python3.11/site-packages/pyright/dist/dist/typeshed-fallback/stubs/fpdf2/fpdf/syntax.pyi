...
class PDFObject:
    ...
    def ref(self) -> str: ...
    def serialize(
        self, obj_dict=None, _security_handler: StandardSecurityHandler | None = None
    ) -> str: ...
...
class PDFDate:
    ...
    def __init__(
        self, date: datetime.datetime, with_tz: bool = False, encrypt: bool = False
    ) -> None: ...
    def serialize(self) -> str: ...
...
class DestinationXYZ(Destination):
    ...
    def __init__(
        self, page: int, top: float, left: float = 0, zoom: float | Literal["null"] = "null"
    ) -> None: ...
    def serialize(self) -> str: ...
    def replace(
        self,
