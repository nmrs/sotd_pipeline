...
def WNetOpenEnum(
    scope, _type, usage, resource: _win32typing.PyNETRESOURCE, /
) -> _win32typing.PyHANDLE: ...
def WNetCloseEnum(handle: _win32typing.PyHANDLE, /) -> None: ...
def WNetEnumResource(
    handle: _win32typing.PyHANDLE, maxExtries: int = ..., /
) -> list[_win32typing.PyNETRESOURCE]: ...
def WNetGetUser(connection: str | None = ..., /) -> str: ...
def WNetGetUniversalName(localPath: str, infoLevel, /) -> str: ...
def WNetGetResourceInformation(
    NetResource: _win32typing.PyNETRESOURCE, /
) -> tuple[_win32typing.PyNETRESOURCE, Incomplete]: ...
def WNetGetLastError() -> tuple[Incomplete, Incomplete, Incomplete]: ...
def WNetGetResourceParent(
    NetResource: _win32typing.PyNETRESOURCE, /
) -> _win32typing.PyNETRESOURCE: ...
