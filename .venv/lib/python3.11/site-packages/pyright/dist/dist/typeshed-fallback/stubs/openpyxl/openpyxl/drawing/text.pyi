...
_ParagraphPropertiesAlgn: TypeAlias = Literal[
...
class TabStop(Serialisable):
    ...
    def __init__(
        self, pos: Coordinate[bool] | None = None, algn: Set[_TabStopAlgn] | None = None
    ) -> None: ...
...
class PresetTextShape(Serialisable):
    ...
    def __init__(
        self, prst: Set[_PresetTextShapePrst], avLst: GeomGuideList | None = None
    ) -> None: ...
