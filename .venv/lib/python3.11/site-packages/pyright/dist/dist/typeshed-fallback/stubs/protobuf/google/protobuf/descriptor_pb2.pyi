...
class _EditionEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Edition.ValueType], builtins.type
):
...
class FileDescriptorSet(google.protobuf.message.Message):
    ...
    def file(
        ...
        global___FileDescriptorProto
    ]: ...
    def __init__(
        self, *, file: collections.abc.Iterable[global___FileDescriptorProto] | None = ...
    ) -> None: ...
...
class DescriptorProto(google.protobuf.message.Message):
    ...
    class ExtensionRange(google.protobuf.message.Message):
        ...
        def HasField(
            self,
            field_name: typing.Literal["end", b"end", "options", b"options", "start", b"start"],
        ) -> builtins.bool: ...
        def ClearField(
            self,
            field_name: typing.Literal["end", b"end", "options", b"options", "start", b"start"],
    ...
    class ReservedRange(google.protobuf.message.Message):
        ...
        """Exclusive."""
        def __init__(
            self, *, start: builtins.int | None = ..., end: builtins.int | None = ...
        ) -> None: ...
        def HasField(
    ...
    def extension_range(
        ...
        global___DescriptorProto.ExtensionRange
    ]: ...
    @property
    def oneof_decl(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___OneofDescriptorProto
    ]: ...
    @property
    ...
    def reserved_range(
        ...
        global___DescriptorProto.ReservedRange
    ]: ...
    @property
    def reserved_name(
        self,
    ...
    def __init__(
        ...
        *,
        ...
        enum_type: collections.abc.Iterable[global___EnumDescriptorProto] | None = ...,
        extension_range: collections.abc.Iterable[global___DescriptorProto.ExtensionRange]
        | None = ...,
        oneof_decl: collections.abc.Iterable[global___OneofDescriptorProto] | None = ...,
        options: global___MessageOptions | None = ...,
        reserved_range: collections.abc.Iterable[global___DescriptorProto.ReservedRange]
        | None = ...,
        reserved_name: collections.abc.Iterable[builtins.str] | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["name", b"name", "options", b"options"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class ExtensionRangeOptions(google.protobuf.message.Message):
    ...
    class _VerificationStateEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            ExtensionRangeOptions._VerificationState.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def declaration(
        ...
        global___ExtensionRangeOptions.Declaration
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        declaration: collections.abc.Iterable[global___ExtensionRangeOptions.Declaration]
        | None = ...,
        features: global___FeatureSet | None = ...,
        verification: global___ExtensionRangeOptions.VerificationState.ValueType | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["features", b"features", "verification", b"verification"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class FieldDescriptorProto(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            FieldDescriptorProto._Type.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _LabelEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            FieldDescriptorProto._Label.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class OneofDescriptorProto(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, name: builtins.str | None = ..., options: global___OneofOptions | None = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["name", b"name", "options", b"options"]
    ) -> builtins.bool: ...
...
class EnumDescriptorProto(google.protobuf.message.Message):
    ...
    def reserved_range(
        ...
        global___EnumDescriptorProto.EnumReservedRange
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        reserved_range: collections.abc.Iterable[global___EnumDescriptorProto.EnumReservedRange]
        | None = ...,
        reserved_name: collections.abc.Iterable[builtins.str] | None = ...,
    ) -> None: ...
    def HasField(
...
class EnumValueDescriptorProto(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal["name", b"name", "number", b"number", "options", b"options"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal["name", b"name", "number", b"number", "options", b"options"],
...
class ServiceDescriptorProto(google.protobuf.message.Message):
    ...
    def method(
        ...
        global___MethodDescriptorProto
    ]: ...
    @property
    ...
    def ClearField(
        self,
        field_name: typing.Literal["method", b"method", "name", b"name", "options", b"options"],
    ) -> None: ...
...
class FileOptions(google.protobuf.message.Message):
    ...
    * For options which will be published and used publicly by multiple
    ...
    class _OptimizeModeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            FileOptions._OptimizeMode.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class FieldOptions(google.protobuf.message.Message):
    ...
    class _CTypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[FieldOptions._CType.ValueType],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _JSTypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[FieldOptions._JSType.ValueType],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _OptionRetentionEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            FieldOptions._OptionRetention.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _OptionTargetTypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            FieldOptions._OptionTargetType.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class EditionDefault(google.protobuf.message.Message):
        ...
        def HasField(
            self, field_name: typing.Literal["edition", b"edition", "value", b"value"]
        ) -> builtins.bool: ...
        def ClearField(
            self, field_name: typing.Literal["edition", b"edition", "value", b"value"]
        ) -> None: ...
    ...
    def targets(
        ...
        global___FieldOptions.OptionTargetType.ValueType
    ]: ...
    @property
    def edition_defaults(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___FieldOptions.EditionDefault
    ]: ...
    @property
    def features(self) -> global___FeatureSet:
        """Any features defined in the specific edition.
    ...
    def __init__(
        ...
        *,
        ...
        targets: collections.abc.Iterable[global___FieldOptions.OptionTargetType.ValueType]
        | None = ...,
        edition_defaults: collections.abc.Iterable[global___FieldOptions.EditionDefault]
        | None = ...,
        features: global___FeatureSet | None = ...,
...
class ServiceOptions(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["deprecated", b"deprecated", "features", b"features"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class MethodOptions(google.protobuf.message.Message):
    ...
    class _IdempotencyLevelEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            MethodOptions._IdempotencyLevel.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class UninterpretedOption(google.protobuf.message.Message):
    ...
    class NamePart(google.protobuf.message.Message):
        ...
        def __init__(
            self, *, name_part: builtins.str | None = ..., is_extension: builtins.bool | None = ...
        ) -> None: ...
        def HasField(
            self,
            field_name: typing.Literal["is_extension", b"is_extension", "name_part", b"name_part"],
        ) -> builtins.bool: ...
        def ClearField(
            self,
            field_name: typing.Literal["is_extension", b"is_extension", "name_part", b"name_part"],
    ...
    def name(
        ...
        global___UninterpretedOption.NamePart
    ]: ...
    def __init__(
        self,
        *,
...
class FeatureSet(google.protobuf.message.Message):
    ...
    class _FieldPresenceEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            FeatureSet._FieldPresence.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _EnumTypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[FeatureSet._EnumType.ValueType],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _RepeatedFieldEncodingEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            FeatureSet._RepeatedFieldEncoding.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class RepeatedFieldEncoding(
        _RepeatedFieldEncoding, metaclass=_RepeatedFieldEncodingEnumTypeWrapper
    ): ...
    ...
    class _Utf8ValidationEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            FeatureSet._Utf8Validation.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _MessageEncodingEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            FeatureSet._MessageEncoding.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _JsonFormatEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            FeatureSet._JsonFormat.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _EnforceNamingStyleEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            FeatureSet._EnforceNamingStyle.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class FeatureSetDefaults(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        defaults: collections.abc.Iterable[global___FeatureSetDefaults.FeatureSetEditionDefault]
        | None = ...,
...
class SourceCodeInfo(google.protobuf.message.Message):
    ...
    def location(
        ...
        global___SourceCodeInfo.Location
    ]:
    ...
    def __init__(
        self, *, location: collections.abc.Iterable[global___SourceCodeInfo.Location] | None = ...
    ) -> None: ...
...
class GeneratedCodeInfo(google.protobuf.message.Message):
    ...
    class Annotation(google.protobuf.message.Message):
        ...
        class _SemanticEnumTypeWrapper(
            google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
                GeneratedCodeInfo.Annotation._Semantic.ValueType
            ],
            builtins.type,
        ):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def annotation(
        ...
        global___GeneratedCodeInfo.Annotation
    ]:
