...
from gevent._fileobjectcommon import (
    FileObjectBlock as FileObjectBlock,
    FileObjectThread as FileObjectThread,
)
...
if sys.platform != "win32":
    ...
    _FileObjectType: TypeAlias = type[
        FileObjectPosix[Any, Any] | FileObjectBlock[Any, Any] | FileObjectThread[Any, Any]
    ]
