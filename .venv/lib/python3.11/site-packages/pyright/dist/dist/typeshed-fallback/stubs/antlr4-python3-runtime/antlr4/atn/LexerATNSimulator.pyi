...
from antlr4.atn.ATNConfigSet import (
    ATNConfigSet as ATNConfigSet,
    OrderedATNConfigSet as OrderedATNConfigSet,
)
...
class LexerATNSimulator(ATNSimulator):
    ...
    def __init__(
        self, recog, atn: ATN, decisionToDFA: list[DFA], sharedContextCache: PredictionContextCache
    ) -> None: ...
    ...
    def addDFAEdge(
        self, from_: DFAState, tk: int, to: DFAState | None = None, cfgs: ATNConfigSet | None = None
    ) -> DFAState: ...
