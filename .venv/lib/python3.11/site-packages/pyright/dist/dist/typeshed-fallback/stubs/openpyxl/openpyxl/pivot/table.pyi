...
_PivotAreaType: TypeAlias = Literal[
...
class ChartFormat(Serialisable):
    ...
    def __init__(
        self,
        chart: ConvertibleToInt,
        format: ConvertibleToInt,
        series: _ConvertibleToBool = None,
        *,
        pivotArea: PivotArea,
    ) -> None: ...
    @overload
...
class RowColItem(Serialisable):
    ...
    __elements__: ClassVar[tuple[str, ...]]
    def __init__(
        self, t: _ItemType = "data", r: ConvertibleToInt = 0, i: ConvertibleToInt = 0, x=()
    ) -> None: ...
