...
class ParagraphAndImage(Flowable):
    ...
    ypad: float
    def __init__(
        self, P: Paragraph, I: Image, xpad: float = 3, ypad: float = 3, side: str = "right"
    ) -> None: ...
    def draw(self) -> None: ...
...
class PTOContainer(_Container, Flowable):
    def __init__(
        self,
        content: _FlowableSublist | None,
        trailer: _FlowableSublist | None = None,
        header: _FlowableSublist | None = None,
    ) -> None: ...
...
class BalancedColumns(_FindSplitterMixin, NullDraw):
    ...
    def __init__(
        ...
        boxMargin: tuple[int, int, int, int]
        | tuple[int, int, int]
        | tuple[int, int]
        | tuple[int]
        | None = None,
...
class DDIndenter(Flowable):
    def __init__(
        self, flowable: Flowable, leftIndent: float = 0, rightIndent: float = 0
    ) -> None: ...
...
class ListItem:
    ...
    def __init__(
        self, flowables: _FlowableSublist, style: PropertySet | None = None, **kwds
    ) -> None: ...
...
class ListFlowable(_Container, Flowable):
    ...
    def __init__(
        self,
        flowables: Iterable[_NestedFlowable],
        start=None,
...
class DocIf(DocPara):
    ...
    def __init__(
        self, cond: object, thenBlock: _FlowableSublist, elseBlock: _FlowableSublist = []
    ) -> None: ...
