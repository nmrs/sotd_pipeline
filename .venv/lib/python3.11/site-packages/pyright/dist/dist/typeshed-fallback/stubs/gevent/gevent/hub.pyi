...
def kill(
    greenlet: greenlet.greenlet, exception: type[BaseException] | BaseException = ...
) -> None: ...
...
class signal(Generic[_P]):
    ...
    kwargs: dict[str, Any]
    def __init__(
        self, signalnum: int, handler: Callable[_P, object], *args: _P.args, **kwargs: _P.kwargs
    ) -> None: ...
    @property
    def ref(self) -> bool: ...
    @ref.setter
