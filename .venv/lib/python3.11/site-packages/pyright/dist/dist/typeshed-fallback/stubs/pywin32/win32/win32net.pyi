...
def NetGroupSetUsers(
    server: str, group: str, level, members: tuple[Incomplete, Incomplete], /
) -> None: ...
...
def NetUserChangePassword(
    server: str, username: str, oldPassword: str, newPassword: str, /
) -> None: ...
def NetUserEnum(
...
def NetServerComputerNameAdd(
    ServerName: str, EmulatedDomainName: str, EmulatedServerName: str, /
) -> None: ...
def NetServerComputerNameDel(ServerName: str, EmulatedServerName: str, /) -> None: ...
def NetValidateName(
    Server: str, Name: str, NameType, Account: str | None = ..., Password: str | None = ..., /
) -> None: ...
