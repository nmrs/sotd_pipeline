...
class NumRef(Serialisable):
    ...
    __elements__: ClassVar[tuple[str, ...]]
    def __init__(
        self, f: object = None, numCache: NumData | None = None, extLst: Unused = None
    ) -> None: ...
...
class StrRef(Serialisable):
    ...
    __elements__: ClassVar[tuple[str, ...]]
    def __init__(
        self, f: object = None, strCache: StrData | None = None, extLst: Unused = None
    ) -> None: ...
...
class MultiLevelStrData(Serialisable):
    ...
    __elements__: ClassVar[tuple[str, ...]]
    def __init__(
        self, ptCount: ConvertibleToInt | None = None, lvl=(), extLst: Unused = None
    ) -> None: ...
...
class MultiLevelStrRef(Serialisable):
    ...
    def __init__(
        self,
        f: object = None,
        multiLvlStrCache: MultiLevelStrData | None = None,
        extLst: Unused = None,
    ) -> None: ...
