...
class Error:
    ...
    number: int | None
    def __init__(
        self, error: Exception, row: dict[str, Any] | None = None, number: int | None = None
    ) -> None: ...
    @cached_property
...
class InvalidRow:
    ...
    def __init__(
        self, number: int, validation_error: ValidationError, values: tuple[Any, ...]
    ) -> None: ...
    @property
...
class Result:
    ...
    def append_invalid_row(
        self, number: int, row: dict[str, Any], validation_error: ValidationError
    ) -> None: ...
