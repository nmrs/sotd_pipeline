...
def CreateDirectoryEx(
    templateName: str, newDirectory: str, sa: _win32typing.PySECURITY_ATTRIBUTES, /
) -> None: ...
def CreateFile(
    fileName: str,
    desiredAccess: int,
...
def CreateMailslot(
    Name, MaxMessageSize, ReadTimeout, SecurityAttributes: _win32typing.PySECURITY_ATTRIBUTES, /
) -> int: ...
...
def WriteFile(
    hFile: int,
    data: str | bytes | _win32typing.PyOVERLAPPEDReadBuffer,
    ol: _win32typing.PyOVERLAPPED | None = ...,
    /,
) -> tuple[int, int]: ...
def CloseHandle(handle: int, /) -> None: ...
def LockFileEx(
    hFile: int, _int, _int1, _int2, ol: _win32typing.PyOVERLAPPED | None = ..., /
) -> None: ...
def UnlockFileEx(
    hFile: int, _int, _int1, ol: _win32typing.PyOVERLAPPED | None = ..., /
) -> None: ...
def GetQueuedCompletionStatus(
    hPort: int, timeOut, /
) -> tuple[Incomplete, Incomplete, Incomplete, _win32typing.PyOVERLAPPED]: ...
...
def GetOverlappedResult(
    hFile: int, overlapped: _win32typing.PyOVERLAPPED, bWait: int | bool, /
) -> int: ...
def LockFile(
    hFile: int, offsetLow, offsetHigh, nNumberOfBytesToLockLow, nNumberOfBytesToLockHigh, /
) -> None: ...
...
def UnlockFile(
    hFile: int, offsetLow, offsetHigh, nNumberOfBytesToUnlockLow, nNumberOfBytesToUnlockHigh, /
) -> None: ...
def TransmitFile(
    Socket,
    File: int,
...
def WSASend(
    s, buffer: str, ol: _win32typing.PyOVERLAPPED, dwFlags, /
) -> tuple[Incomplete, Incomplete]: ...
def WSARecv(
    s, buffer, ol: _win32typing.PyOVERLAPPED, dwFlags, /
) -> tuple[Incomplete, Incomplete]: ...
...
def CreateSymbolicLink(
    SymlinkFileName: str, TargetFileName: str, Flags: int = ..., Transaction: int | None = ...
) -> None: ...
...
def QueryRecoveryAgentsOnEncryptedFile(
    FileName: str, /
) -> tuple[_win32typing.PySID, str, Incomplete]: ...
def RemoveUsersFromEncryptedFile(
    FileName: str, pHashes: tuple[tuple[_win32typing.PySID, str, Incomplete], ...], /
) -> None: ...
def AddUsersToEncryptedFile(
    FileName: str, pUsers: tuple[tuple[_win32typing.PySID, str, Incomplete], ...], /
) -> None: ...
...
def SetFileInformationByHandle(
    File: int, FileInformationClass, Information: tuple[int, int]
) -> None: ...
@overload
