...
def SHCreateDataObject(
    ...
    do_inner: _win32typing.PyIDataObject,
...
def SHCreateShellFolderView(
    sf: _win32typing.PyIShellFolder,
    viewOuter: _win32typing.PyIShellView | None = ...,
    callbacks: Incomplete | None = ...,
    /,
) -> _win32typing.PyIShellView: ...
def SHCreateShellItemArray(
    parent: _win32typing.PyIDL,
    sf: _win32typing.PyIShellFolder,
    children: list[_win32typing.PyIDL],
    /,
...
def SHGetFolderLocation(
    hwndOwner: int, nFolder, hToken: int | None = ..., reserved=..., /
) -> _win32typing.PyIDL: ...
...
def SHCreateItemFromParsingName(
    name, ctx: _win32typing.PyIBindCtx, riid: _win32typing.PyIID, /
) -> _win32typing.PyIShellItem: ...
def SHCreateItemFromRelativeName(
    Parent: _win32typing.PyIShellItem,
    Name,
    ctx: _win32typing.PyIBindCtx,
...
def SHCreateItemWithParent(
    Parent: _win32typing.PyIDL,
    sfParent: _win32typing.PyIShellFolder,
    child: _win32typing.PyIDL,
    riid: _win32typing.PyIID,
    /,
) -> _win32typing.PyIShellItem: ...
...
def SHCreateShellItem(
    pidlParent: _win32typing.PyIDL,
    sfParent: _win32typing.PyIShellFolder,
    Child: _win32typing.PyIDL,
    /,
) -> _win32typing.PyIShellItem: ...
def SHOpenFolderAndSelectItems(
    Folder: _win32typing.PyIDL, Items: tuple[_win32typing.PyIDL, ...], Flags=...
) -> None: ...
