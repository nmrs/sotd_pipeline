...
class NumberRange:
    ...
    def __init__(
        self,
        min: float | Decimal | None = None,
        max: float | Decimal | None = None,
...
class Regexp:
    ...
    message: str | None
    def __init__(
        self, regex: str | Pattern[str], flags: int = 0, message: str | None = None
    ) -> None: ...
    def __call__(
        self, form: BaseForm, field: StringField, message: str | None = None
    ) -> Match[str]: ...
...
class IPAddress:
    ...
    message: str | None
    def __init__(
        self, ipv4: bool = True, ipv6: bool = False, message: str | None = None
    ) -> None: ...
    def __call__(self, form: BaseForm, field: StringField) -> None: ...
    @classmethod
...
class URL(Regexp):
    ...
    def __init__(
        self, require_tld: bool = True, allow_ip: bool = True, message: str | None = None
    ) -> None: ...
    def __call__(self, form: BaseForm, field: StringField) -> None: ...  # type: ignore[override]
...
class AnyOf:
    ...
    @overload
    def __init__(
        self, values: Collection[Any], message: str | None = None, values_formatter: None = None
    ) -> None: ...
    @overload
    def __init__(
        self,
        values: _ValuesT_contra,
        message: str | None,
        values_formatter: Callable[[_ValuesT_contra], str],
    ) -> None: ...
    @overload
    def __init__(
        self,
