...
class Element(Node):
    ...
    def update_all_atts_convert(
        self, dict_: Mapping[str, Any] | Node, and_source: bool = False
    ) -> None: ...
    def clear(self) -> None: ...
    ...
    def first_child_matching_class(
        self,
        childclass: type[Node] | tuple[type[Node], ...],
        start: int = 0,
        end: int = sys.maxsize,
    ) -> int | None: ...
...
class TextElement(Element):
    def __init__(
        self, rawsource: str = "", text: str = "", *children: Node, **attributes
    ) -> None: ...
...
class document(Root, Structural, Element):
    ...
    document: Self
    def __init__(
        self, settings: Values, reporter: Reporter, *args: Node, **kwargs: Any
    ) -> None: ...
    ...
    def set_name_id_map(
        self, node: Element, id: str, msgnode: Element | None = None, explicit: bool | None = None
    ) -> None: ...
    def set_duplicate_name_id(
        self, node: Element, id: str, name: str, msgnode: Element, explicit: bool
    ) -> None: ...
    ...
    def note_substitution_def(
        self, subdef: substitution_definition, def_name: str, msgnode: Element | None = None
    ) -> None: ...
