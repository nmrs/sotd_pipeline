...
class Dialect:
    ...
    def update_tokens(
        self,
        old_tokens: Iterable[_Token],
        changes: SupportsKeysAndGetItem[str, str] | Iterable[tuple[str, str]],
    ) -> list[_Token]: ...
...
class IniData(MutableMapping[str, str]):
    def __init__(
        self, mapping: Mapping[str, str] | None = ..., dialect: Dialect | None = ...
    ) -> None: ...
    @property
...
class IniFile(IniData):
    def __init__(
        self, filename: StrPath, encoding: str | None = ..., dialect: Dialect | None = ...
    ) -> None: ...
    @property
