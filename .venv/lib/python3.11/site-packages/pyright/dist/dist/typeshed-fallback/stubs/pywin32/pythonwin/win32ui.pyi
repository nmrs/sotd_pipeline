...
def CreateCtrlView(
    doc: _win32typing.PyCDocument, className: str, style: int = ..., /
) -> _win32typing.PyCCtrlView: ...
def CreateDC() -> None: ...
...
def CreateFontDialog(
    ...
    dcPrinter: _win32typing.PyCDC | None = ...,
    parent: _win32typing.PyCWnd | None = ...,
    /,
...
def CreatePropertyPage(
    resource: _win32typing.PyResourceId, caption: int = ..., /
) -> _win32typing.PyCPropertyPage: ...
def CreatePropertyPageIndirect(
    resourcelist: _win32typing.PyDialogTemplate, caption=..., /
) -> _win32typing.PyCPropertyPage: ...
...
def CreateRichEditView(
    doc: _win32typing.PyCDocument | None = ..., /
) -> _win32typing.PyCRichEditView: ...
...
def CreateToolBar(
    parent: _win32typing.PyCWnd, style: int, windowId: int = ..., /
) -> _win32typing.PyCToolBar: ...
...
def FindWindowEx(
    parentWindow: _win32typing.PyCWnd,
