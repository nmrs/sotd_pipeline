...
class BlockingConnection:
    ...
    def __init__(
        self, parameters: Parameters | Sequence[Parameters] | None = None, _impl_class=None
    ) -> None: ...
...
class _ConsumerInfo:
    ...
    state: Incomplete
    def __init__(
        self, consumer_tag, auto_ack, on_message_callback=None, alternate_event_sink=None
    ) -> None: ...
    @property
    def setting_up(self): ...
    @property
...
class BlockingChannel:
    ...
    def exchange_unbind(
        self, destination=None, source=None, routing_key: str = "", arguments=None
    ): ...
    def queue_declare(
        self,
        queue,
