...
class attrdict(dict[str, _VT]):
    ...
    # calls dict.update()
    def __iadd__(
        self, rhs: SupportsKeysAndGetItem[str, _VT] | Iterable[tuple[str, _VT]]
    ) -> Self: ...
    def __add__(
        self, rhs: SupportsKeysAndGetItem[str, _VT] | Iterable[tuple[str, _VT]]
    ) -> attrdict[_VT]: ...
...
class State:
    ...
    def __call__(
        self, scope: Incomplete | None = ..., parentheses: Incomplete | None = ..., **kwargs
    ): ...
...
class Table(_HashableSource, BaseTable):  # type: ignore[misc]
    ...
    def select(self, *columns): ...
    def insert(
        self, insert: Incomplete | None = ..., columns: Incomplete | None = ..., **kwargs
    ): ...
    def replace(
        self, insert: Incomplete | None = ..., columns: Incomplete | None = ..., **kwargs
    ): ...
...
class Join(BaseTable):
    ...
    def __init__(
        self, lhs, rhs, join_type=..., on: Incomplete | None = ..., alias: Incomplete | None = ...
    ) -> None: ...
...
class ValuesList(_HashableSource, BaseTable):  # type: ignore[misc]
    def __init__(
        self, values, columns: Incomplete | None = ..., alias: Incomplete | None = ...
    ) -> None: ...
...
class Ordering(WrappedNode):
    ...
    nulls: Incomplete
    def __init__(
        self, node, direction, collation: Incomplete | None = ..., nulls: Incomplete | None = ...
    ) -> None: ...
...
class Function(ColumnBase):
    ...
    def __init__(
        self, name, arguments, coerce: bool = ..., python_value: Incomplete | None = ...
    ) -> None: ...
    def __getattr__(self, attr: str): ...
...
class ForUpdate(Node):
    def __init__(
        self, expr, of: Incomplete | None = ..., nowait: Incomplete | None = ...
    ) -> None: ...
    def __sql__(self, ctx): ...
...
class RawQuery(BaseQuery):
    def __init__(
        self, sql: Incomplete | None = ..., params: Incomplete | None = ..., **kwargs
    ) -> None: ...
    def __sql__(self, ctx): ...
...
class Select(SelectBase):
    ...
    def for_update(
        self, for_update: bool = ..., of: Incomplete | None = ..., nowait: Incomplete | None = ...
    ) -> Self: ...
...
class SqliteDatabase(Database):
    ...
    def init(
        self,
        database,
        pragmas: Incomplete | None = ...,
        timeout: int = ...,
        returning_clause: Incomplete | None = ...,
        **kwargs,
    ) -> None: ...
    ...
    def register_aggregate(
        self, klass, name: Incomplete | None = ..., num_params: int = ...
    ) -> None: ...
    ...
    def register_function(
        self, fn, name: str | None = None, num_params: int = -1, deterministic: bool | None = None
    ) -> None: ...
    def func(
        self, name: str | None = None, num_params: int = -1, deterministic: bool | None = None
    ) -> Callable[[_F], _F]: ...
...
class ManyToManyFieldAccessor(FieldAccessor):
    ...
    def __init__(self, model, field, name) -> None: ...
    def __get__(
        self, instance, instance_type: Incomplete | None = ..., force_query: bool = ...
    ): ...
    def __set__(self, instance, value) -> None: ...
...
class ModelSelect(BaseModelSelect, Select):  # type: ignore[misc]
    ...
    def join_from(
        self, src, dest, join_type=..., on: Incomplete | None = ..., attr: Incomplete | None = ...
    ): ...
