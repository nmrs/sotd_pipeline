...
class OrderedMultiDict(dict[_KT, _VT]):
    ...
    def update(
        self, E: SupportsKeysAndGetItem[_KT, _VT] | Iterable[tuple[_KT, _VT]], **F
...
class ManyToMany(dict[_KT, frozenset[_VT]]):
    ...
    def update(
        self, iterable: ManyToMany[_KT, _VT] | SupportsKeysAndGetItem[_KT, _VT] | tuple[_KT, _VT]
    ) -> None: ...  # type: ignore[override]

def subdict(
    d: dict[_KT, _VT], keep: Iterable[_KT] | None = None, drop: Iterable[_KT] | None = None
) -> dict[_KT, _VT]: ...
