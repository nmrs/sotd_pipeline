...
def OpenPrinter(
    printer: str, Defaults: Incomplete | None = ..., /
...
def StartDocPrinter(
    hprinter: _win32typing.PyPrinterHANDLE | int,
    level: Literal[1],
...
def WritePrinter(
    hprinter: int | _win32typing.PyPrinterHANDLE, buf: bytes | bytearray | memoryview, /
) -> int: ...
...
def EnumPrintProcessors(
    Server: str | None = ..., Environment: str | None = ..., /
) -> tuple[str, ...]: ...
def EnumPrintProcessorDatatypes(ServerName: str, PrintProcessorName: str, /) -> tuple[str, ...]: ...
def EnumPrinterDrivers(
    Server: str | None = ..., Environment: str | None = ..., Level=..., /
) -> tuple[Incomplete, ...]: ...
def EnumForms(
    hprinter: _win32typing.PyPrinterHANDLE, /
) -> tuple[_win32typing.FORM_INFO_1, ...]: ...
...
def DeviceCapabilities(
    Device: str, Port: str, Capability, DEVMODE: _win32typing.PyDEVMODE | None = ..., /
) -> None: ...
...
def DeletePrinterDriverEx(
    Server: str, Environment: str, DriverName: str, DeleteFlag, VersionFlag, /
) -> None: ...
