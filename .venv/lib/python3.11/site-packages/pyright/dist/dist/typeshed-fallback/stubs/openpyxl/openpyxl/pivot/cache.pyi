...
_RangePrGroupBy: TypeAlias = Literal[
...
class MeasureDimensionMap(Serialisable):
    ...
    def __init__(
        self,
        measureGroup: ConvertibleToInt | None = None,
        dimension: ConvertibleToInt | None = None,
    ) -> None: ...
...
class PivotDimension(Serialisable):
    ...
    @overload
    def __init__(
        self, measure: _ConvertibleToBool = None, *, name: str, uniqueName: str, caption: str
    ) -> None: ...
    @overload
    def __init__(
        self, measure: _ConvertibleToBool, name: str, uniqueName: str, caption: str
    ) -> None: ...
...
class PCDSDTCEntries(Serialisable):
    ...
    __elements__: ClassVar[tuple[str, ...]]
    def __init__(
        self, count: ConvertibleToInt, m: Missing, n: Number, e: Error, s: Text
    ) -> None: ...
...
class FieldGroup(Serialisable):
    ...
    def __init__(
        ...
        discretePr: list[NestedInteger[Literal[False]]]
        | tuple[NestedInteger[Literal[False]], ...] = (),
...
class WorksheetSource(Serialisable):
    ...
    sheet: String[Literal[True]]
    def __init__(
        self, ref: str | None = None, name: str | None = None, sheet: str | None = None
    ) -> None: ...
