...
def EnumThreadWindows(
    dwThreadId, callback: Callable[[int, _T], int | None], extra: _T, /
) -> None: ...
def EnumChildWindows(
    hwnd: _win32typing.PyHANDLE | int | None,
    callback: Callable[[int, _T], int | None],
    extra: _T,
    /,
) -> None: ...
def EnumDesktopWindows(
    hDesktop: _win32typing.PyHANDLE | int | None,
    callback: Callable[[int, _T], int | None],
    extra: _T,
    /,
) -> None: ...
...
def DialogBox(
    hInstance: int,
    TemplateName: _win32typing.PyResourceId,
    hWndParent: int,
    DialogFunc,
    InitParam: int = ...,
    /,
...
def DialogBoxIndirect(
    hInstance: int,
    controllist: _win32typing.PyDialogTemplate,
    hWndParent: int,
    DialogFunc,
    InitParam: int = ...,
    /,
...
def DrawIconEx(
    ...
    cyWidth,
    istepIfAniCur,
    hbrFlickerFreeDraw: _win32typing.PyGdiHANDLE,
    diFlags,
    /,
) -> None: ...
...
def LoadImage(
    hinst: int, name: str, type: int, cxDesired: int, cyDesired: int, fuLoad: int, /
...
def StretchBlt(
    hdcDest, x, y, width, height, hdcSrc, nXSrc, nYSrc, nWidthSrc, nHeightSrc, dwRop, /
) -> None: ...
...
def FindWindow(
    ClassName: _win32typing.PyResourceId | str | None, WindowName: str | None, /
) -> int: ...
def FindWindowEx(
    Parent: int | None,
    ChildAfter: int | None,
    ClassName: _win32typing.PyResourceId | str | None,
    WindowName: str | None,
    /,
) -> int: ...
...
def CreateCompatibleBitmap(
    hdc: int | _win32typing.PyHANDLE | None, width: int, height: int, /
) -> _win32typing.PyGdiHANDLE: ...
def CreateBitmap(
    width: int, height: int, cPlanes: int, cBitsPerPixel: int, bitmap_bits: None, /
) -> _win32typing.PyGdiHANDLE: ...
def SelectObject(
    hdc: int | _win32typing.PyHANDLE | None, object: int | _win32typing.PyHANDLE | None, /
) -> int: ...
...
def SetWindowPos(
    hWnd: int, InsertAfter: int | None, X: int, Y: int, cx: int, cy: int, Flags: int, /
) -> None: ...
def GetWindowPlacement(
    hwnd: int, /
) -> tuple[int, int, tuple[int, int], tuple[int, int], tuple[int, int, int, int]]: ...
...
def ClientToScreen(
    hWnd: int, Point: tuple[Incomplete, Incomplete], /
) -> tuple[Incomplete, Incomplete]: ...
def PaintDesktop(hdc: int, /) -> None: ...
def RedrawWindow(
    hWnd: int, rcUpdate: tuple[int, int, int, int], hrgnUpdate: _win32typing.PyGdiHANDLE, flags, /
) -> None: ...
...
def CombineTransform(
    xform1: _win32typing.PyXFORM, xform2: _win32typing.PyXFORM, /
) -> _win32typing.PyXFORM: ...
...
def SetMenuItemBitmaps(
    ...
    uPosition,
    uFlags,
    hBitmapUnchecked: _win32typing.PyGdiHANDLE,
    hBitmapChecked: _win32typing.PyGdiHANDLE,
    /,
) -> None: ...
...
def DrawText(
    hDC: int, String, nCount, Rect: _win32typing.PyRECT, Format, /
...
def Pie(
    hdc: int, LeftRect, TopRect, RightRect, BottomRect, XRadial1, YRadial1, XRadial2, YRadial2, /
) -> None: ...
def Arc(
    hdc: int, LeftRect, TopRect, RightRect, BottomRect, XRadial1, YRadial1, XRadial2, YRadial2, /
) -> None: ...
...
def CreatePolygonRgn(
    Points: list[tuple[Incomplete, Incomplete]], PolyFillMode, /
) -> _win32typing.PyGdiHANDLE: ...
def ExtTextOut(
    hdc: int,
    _int,
...
def DrawAnimatedRects(
    hwnd: int, idAni, minCoords: _win32typing.PyRECT, restCoords: _win32typing.PyRECT, /
) -> None: ...
...
def CreateRoundRectRgn(
    LeftRect, TopRect, RightRect, BottomRect, WidthEllipse, HeightEllipse, /
): ...
...
def SetCapture() -> None: ...
def ReleaseDC(
    hWnd: int | _win32typing.PyHANDLE | None, hDC: int | _win32typing.PyHANDLE | None, /
) -> Literal[0, 1]: ...
...
def ScrollWindowEx(
    ...
    dx,
    dy,
    rcScroll: _win32typing.PyRECT,
    rcClip: _win32typing.PyRECT,
    hrgnUpdate,
    flags,
    /,
) -> tuple[Incomplete, _win32typing.PyRECT]: ...
def SetScrollInfo(
    hwnd: int, nBar, scollInfo: _win32typing.PySCROLLINFO, bRedraw=..., /
) -> None: ...
...
def ExtCreatePen(
    PenStyle, Width, lb: _win32typing.PyLOGBRUSH, Style: tuple[Incomplete, ...] | None = ..., /
) -> int: ...
def DrawTextW(
    hDC: int, String: str, Count, Rect: _win32typing.PyRECT, Format
) -> tuple[Incomplete, _win32typing.PyRECT]: ...
...
def RegisterHotKey(
    hWnd: _win32typing.PyHANDLE | int | None, _id: int, Modifiers: int, vk: int, /
) -> None: ...
