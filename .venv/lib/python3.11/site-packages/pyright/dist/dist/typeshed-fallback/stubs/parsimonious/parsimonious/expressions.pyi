...
_CALLABLE_TYPE: TypeAlias = (
    ...
    | Callable[
        [str, int, Mapping[tuple[int, int], Node], ParseError, Grammar], _CALLABLE_RETURN_TYPE
    ]
)
...
class Expression(StrAndRepr):
    ...
    def match_core(
        self, text: str, pos: int, cache: Mapping[tuple[int, int], Node], error: ParseError
    ) -> Node: ...
...
class Quantifier(Compound):
    ...
    max: float
    def __init__(
        self, member: Expression, *, min: int = 0, max: float = ..., name: str = "", **kwargs: Any
    ) -> None: ...
