...
_ParsedText: TypeAlias = (
    tuple[str, dict[str, Any], list[_ParsedText], Any] | list[_ParsedText] | str
)

class _LineOpHandler(Protocol):
    def start_at(
        self, x: float, y: float, para: paragraphEngine, canvas: Canvas, textobject: PDFTextObject
    ) -> None: ...
    def end_at(
        self, x: float, y: float, para: paragraphEngine, canvas: Canvas, textobject: PDFTextObject
    ) -> None: ...
...
class paragraphEngine:
    ...
    def runOpCodes(
        self, program: list[_Op], canvas: Canvas, textobject: PDFTextObject
    ) -> dict[str, Any]: ...
...
class SimpleStyle:
    ...
    def __init__(
        self,
        name: str,
        parent: SimpleStyle | PropertySet | None = None,
        **kw: Unpack[_SimpleStyleKwargs],
    ) -> None: ...
...
class Para(Flowable):
    ...
    def draw(self) -> None: ...
    def compileProgram(
        self, parsedText: _ParsedText, program: list[_Op] | None = None
    ) -> list[_Op]: ...
    def linearize(
        self, program: list[_Op] | None = None, parsedText: _ParsedText | None = None
    ) -> None: ...
    ...
    def shiftfont(
        ...
        program: list[_Op],
        face: str | None = None,
        bold: _BoolInt | None = None,
        italic: _BoolInt | None = None,
    ): ...
    ...
    def compile_ul(
        self, attdict, content, extra, program: list[_Op], tagname: str = "ul"
    ) -> None: ...
    ...
    def compile_para(
        self, attdict, content, extra, program: list[_Op], stylename: str = "para.defaultStyle"
    ) -> None: ...
