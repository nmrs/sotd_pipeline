...
def textFieldAbsolute(
    canvas, title, x, y, width, height, value: str = "", maxlen: int = 1000000, multiline: int = 0
): ...
def textFieldRelative(
    canvas, title, xR, yR, width, height, value: str = "", maxlen: int = 1000000, multiline: int = 0
): ...
def buttonFieldAbsolute(
    canvas, title, value, x, y, width: float = 16.7704, height: float = 14.907
): ...
def buttonFieldRelative(
    canvas, title, value, xR, yR, width: float = 16.7704, height: float = 14.907
): ...
...
class AcroForm(PDFObject):
    ...
    def buttonField(
        self, canvas, title, value, xmin, ymin, width: float = 16.7704, height: float = 14.907
    ) -> None: ...
