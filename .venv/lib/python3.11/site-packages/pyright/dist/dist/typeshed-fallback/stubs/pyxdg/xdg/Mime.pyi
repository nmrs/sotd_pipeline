...
class MagicDB:
    ...
    def match_data(
        ...
        max_pri: int = 100,
        min_pri: int = 0,
        possible: Iterable[MIMEtype] | None = None,
    ) -> MIMEtype: ...
    def match(
        self,
        path: StrOrBytesPath,
...
class GlobDB:
    ...
    exts: defaultdict[
        str, list[MIMEtype | int]
    ]  # Actually list[MIMEtype, int], but that's not valid.
    cased_exts: defaultdict[
        str, list[MIMEtype | int]
    ]  # Actually list[MIMEtype, int], but that's not valid.
...
def get_type_by_contents(
    path: StrOrBytesPath, max_pri: int = 100, min_pri: int = 0
) -> MIMEtype: ...
