...
def get_page_format(
    format: _Format | tuple[float, float], k: float | None = None
) -> tuple[float, float]: ...
...
class FPDF(GraphicsStateMixin):
    ...
    def ellipse(
        self, x: float, y: float, w: float, h: float, style: RenderStyle | str | None = None
    ) -> None: ...
    def circle(
        self, x: float, y: float, radius: float, style: RenderStyle | str | None = None
    ) -> None: ...
    def regular_polygon(
        self,
        x: float,
    ...
    def set_font(
        self, family: str | None = None, style: _FontStyles | TextEmphasis = "", size: int = 0
    ) -> None: ...
    def set_font_size(self, size: float) -> None: ...
    def set_char_spacing(self, spacing: float) -> None: ...
    def set_stretching(self, stretching: float) -> None: ...
    def set_fallback_fonts(
        self, fallback_fonts: Iterable[str], exact_match: bool = True
    ) -> None: ...
    def add_link(
        self, y: float = 0, x: float = 0, page: int = -1, zoom: float | Literal["null"] = "null"
    ) -> int: ...
    def set_link(
        self,
        link,
    ...
    def x_by_align(
        self, x: _Align, w: int, h: int, img_info: ImageInfo, keep_aspect_ratio: bool
    ) -> int: ...
