...
_TableSectionCommand: TypeAlias = tuple[
    str, tuple[int | _SpecialRow, int], tuple[int, int], Unpack[tuple[Any, ...]]
]
...
class TableStyle:
    ...
    def __init__(
        self, cmds: Iterable[_TableCommand] | None = None, parent: TableStyle | None = None, **kw
    ) -> None: ...
    @overload
