...
def add_cron(
    signum: int, minute: int, hour: int, day: int, month: int, weekday: int, /
) -> Literal[True]: ...
...
def cache_dec(
    key: str | bytes, decrement: int = 1, expires: int = 0, cache_name: str = ..., /
) -> _TrueOrNone: ...
def cache_del(key: str | bytes, cache_name: str = ..., /) -> _TrueOrNone: ...
def cache_div(
    key: str | bytes, divisor: int = 2, expires: int = 0, cache_name: str = ..., /
) -> _TrueOrNone: ...
def cache_exists(key: str | bytes, cache_name: str = ..., /) -> _TrueOrNone: ...
def cache_get(key: str | bytes, cache_name: str = ..., /) -> bytes | None: ...
def cache_inc(
    key: str | bytes, increment: int = 1, expires: int = 0, cache_name: str = ..., /
) -> _TrueOrNone: ...
def cache_keys(cache_name: str = ..., /) -> list[bytes]: ...
def cache_mul(
    key: str | bytes, factor: int = 2, expires: int = 0, cache_name: str = ..., /
) -> _TrueOrNone: ...
def cache_num(key: str | bytes, cache_name: str = ..., /) -> int: ...
def cache_set(
    key: str | bytes,
    value: str | bytes | ReadOnlyBuffer,
    expires: int = 0,
    cache_name: str = ...,
    /,
) -> _TrueOrNone: ...
...
def micros() -> int: ...
def mule_get_msg(
    signals: bool = True, farms: bool = True, buffer_size: int = 65536, timeout: int = -1
) -> bytes: ...
def mule_id() -> int: ...
@overload
...
@overload
def register_rpc(
    name: str, func: Callable[[bytes], bytes | None], /, arg_count: Literal[1]
) -> Literal[True]: ...
@overload
def register_rpc(
    name: str, func: Callable[[bytes, bytes], bytes | None], /, arg_count: Literal[2]
) -> Literal[True]: ...
@overload
...
def sendfile(
    filename_or_fd: str | bytes | int | HasFileno,
    chunk: int = 0,
    pos: int = 0,
    /,
    filesize: int = 0,
...
def websocket_handshake(
    key: str | bytes = ..., origin: str | bytes = ..., proto: str | bytes = ..., /
) -> None: ...
