...
class KeyStore(AbstractKeystore):
    ...
    def new(
        cls,
        store_type: _JksType,
        store_entries: Iterable[TrustedCertEntry | PrivateKeyEntry | SecretKeyEntry],
    ) -> Self: ...
    @classmethod
    def loads(
        cls, data: bytes, store_password: str | None, try_decrypt_keys: bool = True
    ) -> Self: ...
    ...
    def __init__(
        self,
        store_type: _JksType,
        entries: SupportsKeysAndGetItem[str, TrustedCertEntry | PrivateKeyEntry | SecretKeyEntry],
    ) -> None: ...
    @property
