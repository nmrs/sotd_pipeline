...
class _TranslatorPolicy(Protocol):
    def __call__(
        self, translations: NullTranslations, tstring: str, domain: str | None, context: str | None
    ) -> str: ...
...
class TranslationString(str):
    ...
    def __reduce__(
        self,
    ) -> tuple[type[Self], tuple[str, str | None, str, dict[str, Any], str | None]]: ...

def TranslationStringFactory(factory_domain: str) -> _TranslationStringFactory: ...
def ChameleonTranslate(
    translator: Callable[[TranslationString], str] | None,
) -> _ChameleonTranslate: ...
def ugettext_policy(
    translations: NullTranslations, tstring: str, domain: str | None, context: str | None
) -> str: ...
def dugettext_policy(
    translations: NullTranslations, tstring: str, domain: str | None, context: str | None
) -> str: ...
def Translator(
    translations: NullTranslations | None = None, policy: _TranslatorPolicy | None = None
) -> _Translator: ...
...
def Pluralizer(
    translations: NullTranslations | None = None, policy: _PluralizerPolicy | None = None
) -> _Pluralizer: ...
