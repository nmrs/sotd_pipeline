...
def get_output_info(
    self: Display | resource.Resource, output: int, config_timestamp: int
) -> GetOutputInfo: ...

class ListOutputProperties(rq.ReplyRequest): ...

def list_output_properties(
    self: Display | resource.Resource, output: int
) -> ListOutputProperties: ...

class QueryOutputProperty(rq.ReplyRequest): ...

def query_output_property(
    self: Display | resource.Resource, output: int, property: int
) -> QueryOutputProperty: ...

class ConfigureOutputProperty(rq.Request): ...

def configure_output_property(
    self: Display | resource.Resource, output: int, property: int
...
def create_mode(
    self: drawable.Window, mode: _RandRModeInfo13IntSequence, name: str
) -> CreateMode: ...
...
def delete_output_mode(
    self: Display | resource.Resource, output: int, mode: int
) -> DeleteOutputMode: ...

class GetCrtcInfo(rq.ReplyRequest): ...

def get_crtc_info(
    self: Display | resource.Resource, crtc: int, config_timestamp: int
) -> GetCrtcInfo: ...
...
def set_crtc_transform(
    self: Display | resource.Resource, crtc: int, n_bytes_filter: Sequence[int]
) -> SetCrtcTransform: ...
...
def set_monitor(
    self: drawable.Window,
    monitor_info: tuple[int, bool, bool, Sequence[int], int, int, int, int, int],
) -> SetMonitor: ...
