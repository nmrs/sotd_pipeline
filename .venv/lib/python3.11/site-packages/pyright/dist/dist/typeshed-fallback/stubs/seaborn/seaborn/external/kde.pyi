...
class _GaussianKDELike(Protocol):
    ...
    def __init__(
        self, dataset: ArrayLike, bw_method: Any | None = ..., weights: ArrayLike | None = ...
    ) -> None: ...
...
_BwMethodType: TypeAlias = (
    Literal["scott", "silverman"] | Callable[[_GaussianKDELike], _Scalar] | _Scalar | None
)

class gaussian_kde:
    dataset: NDArray[np.float64]
    def __init__(
        self, dataset: ArrayLike, bw_method: _BwMethodType = None, weights: ArrayLike | None = None
    ) -> None: ...
