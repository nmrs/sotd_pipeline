...
_CodeModifier: TypeAlias = Callable[
    [dict[str, str], TokenBase | None, Request | None], dict[str, str]
]
_TokenModifier: TypeAlias = Callable[
    [dict[str, Incomplete], TokenBase | None, Request | None], dict[str, Incomplete]
]
...
class GrantTypeBase:
    ...
    def add_token(
        self, token: dict[str, _T], token_handler: TokenBase, request: Request
    ) -> dict[str, _T]: ...
