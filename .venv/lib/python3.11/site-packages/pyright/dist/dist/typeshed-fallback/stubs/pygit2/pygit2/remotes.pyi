...
class Remote:
    ...
    def connect(
        self, callbacks: RemoteCallbacks | None = None, direction: int = 0, proxy: _ProxySpec = None
    ) -> None: ...
    def fetch(
        self,
    ...
    def ls_remotes(
        self, callbacks: RemoteCallbacks | None = None, proxy: _ProxySpec = None
    ) -> list[_LsRemotesResultEntry]: ...
...
class RemoteCollection:
    ...
    def create(
        self, name: _RemoteName, url: bytes | str, fetch: bytes | str | None = None
    ) -> Remote: ...
