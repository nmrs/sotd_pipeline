...
class GenericHandler(MinimalHandler):
    ...
    @classmethod
    def needs_update(
        cls, hash: str | bytes, secret: str | bytes | None = None, **kwds: Any
    ) -> bool: ...
    @classmethod
    def parsehash(
        cls, hash: str | bytes, checksum: bool = True, sanitize: bool = False
    ) -> dict[str, Any]: ...
    @classmethod
...
class HasSalt(GenericHandler):
    ...
    def using(  # type: ignore[override]
        cls,
        default_salt_size: int | None = None,
...
class PrefixWrapper:
    ...
    __doc__: Any
    def __init__(
        self, name, wrapped, prefix="", orig_prefix="", lazy: bool = False, doc=None, ident=None
    ) -> None: ...
    @property
    def wrapped(self): ...
    @property
