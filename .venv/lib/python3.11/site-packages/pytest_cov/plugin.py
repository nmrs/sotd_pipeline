...
class CovPlugin:
    ...
    def __init__(
        self, options: argparse.Namespace, pluginmanager, start=True, no_cov_should_warn=False
    ):
        ...
        is_dist = (
            ...
            or getattr(options, "distload", False)
    ...
    def pytest_sessionstart(self, session):
        ...
        if self.options.cov_context == "test":
            session.config.pluginmanager.register(
                TestContextPlugin(self.cov_controller), "_cov_contexts"
            )
