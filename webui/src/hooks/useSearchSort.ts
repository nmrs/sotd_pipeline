...
interface UseSearchSortReturn {
    ...
    filteredAndSortedItems: Array<{ item: string; count: number; comment_ids?: string[]; examples?: string[];[key: string]: any }>;
...
export const useSearchSort = ({
    ...
    const filteredItems = useMemo(() => {
        ...
        return items.filter(item => {
            ...
            // Search in examples
            if (item.examples && item.examples.some(example =>
            ...
            if (item.comment_ids && item.comment_ids.some(id =>
