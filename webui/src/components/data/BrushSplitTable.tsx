                ...
                <Table>
                    ...
                    <TableBody>
                        {tableData.map((item) => {
                            ...
                            const handleDisplayValue = isEditing?.handle !== undefined ? isEditing.handle : item.handle;
                            const knotDisplayValue = isEditing?.knot !== undefined ? isEditing.knot : item.knot;
                            const shouldNotSplitValue = isEditing?.should_not_split !== undefined
                                ...
                                <TableRow key={item.index}>
                                    ...
                                    <TableCell>
                                        <Checkbox
                                            ...
                                            onCheckedChange={(checked) => handleFieldChange(item.index, 'should_not_split', checked)}
                                        />
                                    </TableCell>
                                </TableRow>
                            );
