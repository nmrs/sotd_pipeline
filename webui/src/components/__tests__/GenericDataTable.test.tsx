...
describe('GenericDataTable', () => {
  ...
  describe('Basic Rendering', () => {
    test('should render table with data', () => {
      render(<GenericDataTable data={mockData} columns={mockColumns} />);
    ...
    test('should render empty state when no data', () => {
      render(<GenericDataTable data={[]} columns={mockColumns} emptyMessage='No items found' />);

      expect(screen.getByText('No items found')).toBeInTheDocument();
    });

    test('should render loading state', () => {
      render(<GenericDataTable data={mockData} columns={mockColumns} loading={true} />);
  ...
  describe('Row Interactions', () => {
    test('should call onRowClick when row is clicked', () => {
      ...
      render(
        <GenericDataTable data={mockData} columns={mockColumns} onRowClick={mockOnRowClick} />
      );
    ...
    test('should call onSort when header is clicked', () => {
      ...
      render(<GenericDataTable data={mockData} columns={mockColumns} onSort={mockOnSort} />);
  ...
  describe('Custom Column Rendering', () => {
    test('should use custom render function for columns', () => {
      ...
      render(<GenericDataTable data={mockData} columns={customColumns} />);
  ...
  describe('Performance', () => {
    test('should render large datasets efficiently', () => {
      ...
      render(<GenericDataTable data={largeData} columns={mockColumns} />);
