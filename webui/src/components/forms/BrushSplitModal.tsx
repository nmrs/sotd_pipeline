                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className={validation?.errors.some(e => e.includes('Handle')) ? 'border-red-500' : ''}
                                    />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className={validation?.errors.some(e => e.includes('Knot')) ? 'border-red-500' : ''}
                                    />
                                </div>
                            </div>
                        )}
                        ...
                        {validation && (
                            <div className="space-y-3">
                                <div className="flex items-center gap-2">
                                    <Badge
                                        variant="outline"
                                        className={getConfidenceColor(validation.confidence)}
                                    >
