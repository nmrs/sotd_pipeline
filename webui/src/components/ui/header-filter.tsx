        ...
        <div className="flex items-center gap-1">
            ...
            <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
                <DropdownMenuTrigger asChild>
                    <div
                        className={`h-6 w-6 p-0.5 text-xs font-medium relative group cursor-pointer flex items-center justify-center rounded border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground transition-colors ${hasActiveFilter ? 'bg-blue-50 text-blue-700 border-blue-200' : ''
                            }`}
                        title={`Filter ${title}`}
                    >
