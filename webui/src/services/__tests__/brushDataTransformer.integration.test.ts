import { transformBrushData, transformBrushDataArray, BrushData, BrushMatcherOutput } from '../../utils/brushDataTransformer';
...
describe('BrushData Transformer Integration Tests', () => {
    ...
    describe('Real Data Integration', () => {
        test('should transform real brush matcher output correctly', () => {
            ...
            expect(brushData.main.examples).toEqual(['Elite handle w/ Declaration knot', 'Elite w/ Declaration']);
